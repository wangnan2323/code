...
{
    /// <summary>
    /// 数据访问类tbl_app_news_like 
    /// </summary>
    public class tbl_app_news_like : sara.dd.ldsw.idal.Itbl_app_news_like
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_app_news_like model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.fk_t_user_id != null)
            {
	            strSql1.Append("fk_t_user_id,");
	            strSql2.Append("'" + (model.fk_t_user_id) + "',");
	            strSql3.Append(":fk_t_user_id,");
	            parameter = new OracleParameter(":fk_t_user_id", OracleType.VarChar);
	            parameter.Value = model.fk_t_user_id;
	            parameterList.Add(parameter);
            }
            ...
            if (model.fk_tbl_app_news_discuss_sys_id != null)
            {
	            strSql1.Append("fk_tbl_app_news_discuss_sys_id,");
	            strSql2.Append("'" + (model.fk_tbl_app_news_discuss_sys_id) + "',");
	            strSql3.Append(":fk_tbl_app_news_discuss_sys_id,");
	            parameter = new OracleParameter(":fk_tbl_app_news_discuss_sys_id", OracleType.VarChar);
	            parameter.Value = model.fk_tbl_app_news_discuss_sys_id;
	            parameterList.Add(parameter);
            }
            
            if (model.f_username != null)
            {
	            strSql1.Append("f_username,");
	            strSql2.Append("'" + (model.f_username) + "',");
	            strSql3.Append(":f_username,");
	            parameter = new OracleParameter(":f_username", OracleType.VarChar);
	            parameter.Value = model.f_username;
	            parameterList.Add(parameter);
            }
            
            if (model.f_userimg != null)
            {
	            strSql1.Append("f_userimg,");
	            strSql2.Append("'" + (model.f_userimg) + "',");
	            strSql3.Append(":f_userimg,");
	            parameter = new OracleParameter(":f_userimg", OracleType.VarChar);
	            parameter.Value = model.f_userimg;
	            parameterList.Add(parameter);
            }
            
            if (model.f_liketype != null)
            {
	            strSql1.Append("f_liketype,");
	            strSql2.Append("'" + (model.f_liketype) + "',");
	            strSql3.Append(":f_liketype,");
	            parameter = new OracleParameter(":f_liketype", OracleType.VarChar);
	            parameter.Value = model.f_liketype;
	            parameterList.Add(parameter);
            }
            
            if (model.f_liketypeid != null)
            {
	            strSql1.Append("f_liketypeid,");
	            strSql2.Append("'" + (model.f_liketypeid) + "',");
	            strSql3.Append(":f_liketypeid,");
	            parameter = new OracleParameter(":f_liketypeid", OracleType.VarChar);
	            parameter.Value = model.f_liketypeid;
	            parameterList.Add(parameter);
            }
            
            strSql.Append("insert into tbl_app_news_like(");
            ...
            strSql_use.Append("insert into tbl_app_news_like(");
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_app_news_like> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_app_news_like model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_app_news_like model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_app_news_like set ");
            strSql_use.Append("update tbl_app_news_like set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_value10 != null&& columsList.Contains("f_value10"))
            {
	            ...
	            if (model.fk_t_user_id != null&& columsList.Contains("fk_t_user_id"))
            {
                strSql.Append("fk_t_user_id='" + (model.fk_t_user_id) + "',");
                strSql_use.Append("fk_t_user_id=:fk_t_user_id,");
                parameter = new OracleParameter(":fk_t_user_id", OracleType.VarChar);
                parameter.Value = model.fk_t_user_id;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.fk_tbl_app_news_sys_id != null&& columsList.Contains("fk_tbl_app_news_sys_id"))
            {
	            ...
	            if (model.fk_tbl_app_news_discuss_sys_id != null&& columsList.Contains("fk_tbl_app_news_discuss_sys_id"))
            {
                strSql.Append("fk_tbl_app_news_discuss_sys_id='" + (model.fk_tbl_app_news_discuss_sys_id) + "',");
                strSql_use.Append("fk_tbl_app_news_discuss_sys_id=:fk_tbl_app_news_discuss_sys_id,");
                parameter = new OracleParameter(":fk_tbl_app_news_discuss_sys_id", OracleType.VarChar);
                parameter.Value = model.fk_tbl_app_news_discuss_sys_id;
                parameterList.Add(parameter);
            }
            
	            if (model.f_username != null&& columsList.Contains("f_username"))
            {
                strSql.Append("f_username='" + (model.f_username) + "',");
                strSql_use.Append("f_username=:f_username,");
                parameter = new OracleParameter(":f_username", OracleType.VarChar);
                parameter.Value = model.f_username;
                parameterList.Add(parameter);
            }
            
	            if (model.f_userimg != null&& columsList.Contains("f_userimg"))
            {
                strSql.Append("f_userimg='" + (model.f_userimg) + "',");
                strSql_use.Append("f_userimg=:f_userimg,");
                parameter = new OracleParameter(":f_userimg", OracleType.VarChar);
                parameter.Value = model.f_userimg;
                parameterList.Add(parameter);
            }
            
	            if (model.f_liketype != null&& columsList.Contains("f_liketype"))
            {
                strSql.Append("f_liketype='" + (model.f_liketype) + "',");
                strSql_use.Append("f_liketype=:f_liketype,");
                parameter = new OracleParameter(":f_liketype", OracleType.VarChar);
                parameter.Value = model.f_liketype;
                parameterList.Add(parameter);
            }
            
	            if (model.f_liketypeid != null&& columsList.Contains("f_liketypeid"))
            {
                strSql.Append("f_liketypeid='" + (model.f_liketypeid) + "',");
                strSql_use.Append("f_liketypeid=:f_liketypeid,");
                parameter = new OracleParameter(":f_liketypeid", OracleType.VarChar);
                parameter.Value = model.f_liketypeid;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_app_news_like> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_app_news_like where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_app_news_like");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_app_news_like> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_app_news_like t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_app_news_like> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_app_news_like>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_app_news_like')";
            sqlString += " where f_tablename  = 'tbl_app_news_like'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_app_news_like'";
