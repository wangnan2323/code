...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_app_news 
    /// </summary>
    public class tbl_app_news : sara.dd.ldsw.idal.Itbl_app_news
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_app_news model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_content != null && model.f_content.Length > 0)
            {
	            strSql1.Append("f_content,");
	            strSql2.Append("'" + (model.f_content) + "',");
	            strSql3.Append(":f_content,");
	            parameter = new OracleParameter(":f_content", OracleType.Clob);
	            parameter.Value = model.f_content;
	            parameterList.Add(parameter);
            }
            
            if (model.f_contentresource != null)
            {
	            strSql1.Append("f_contentresource,");
	            strSql2.Append("'" + (model.f_contentresource) + "',");
	            strSql3.Append(":f_contentresource,");
	            parameter = new OracleParameter(":f_contentresource", OracleType.VarChar);
	            parameter.Value = model.f_contentresource;
	            parameterList.Add(parameter);
            }
            
            if (model.f_contenttype != null)
            {
	            strSql1.Append("f_contenttype,");
	            strSql2.Append("'" + (model.f_contenttype) + "',");
	            strSql3.Append(":f_contenttype,");
	            parameter = new OracleParameter(":f_contenttype", OracleType.VarChar);
	            parameter.Value = model.f_contenttype;
	            parameterList.Add(parameter);
            }
            
            if (model.f_contenttypeid != null)
            {
	            strSql1.Append("f_contenttypeid,");
	            strSql2.Append("'" + (model.f_contenttypeid) + "',");
	            strSql3.Append(":f_contenttypeid,");
	            parameter = new OracleParameter(":f_contenttypeid", OracleType.VarChar);
	            parameter.Value = model.f_contenttypeid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_viewrange != null)
            {
	            strSql1.Append("f_viewrange,");
	            strSql2.Append("'" + (model.f_viewrange) + "',");
	            strSql3.Append(":f_viewrange,");
	            parameter = new OracleParameter(":f_viewrange", OracleType.VarChar);
	            parameter.Value = model.f_viewrange;
	            parameterList.Add(parameter);
            }
            
            if (model.f_viewrangeid != null)
            {
	            strSql1.Append("f_viewrangeid,");
	            strSql2.Append("'" + (model.f_viewrangeid) + "',");
	            strSql3.Append(":f_viewrangeid,");
	            parameter = new OracleParameter(":f_viewrangeid", OracleType.VarChar);
	            parameter.Value = model.f_viewrangeid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_discussrange != null)
            {
	            strSql1.Append("f_discussrange,");
	            strSql2.Append("'" + (model.f_discussrange) + "',");
	            strSql3.Append(":f_discussrange,");
	            parameter = new OracleParameter(":f_discussrange", OracleType.VarChar);
	            parameter.Value = model.f_discussrange;
	            parameterList.Add(parameter);
            }
            
            if (model.f_discussrangeid != null)
            {
	            strSql1.Append("f_discussrangeid,");
	            strSql2.Append("'" + (model.f_discussrangeid) + "',");
	            strSql3.Append(":f_discussrangeid,");
	            parameter = new OracleParameter(":f_discussrangeid", OracleType.VarChar);
	            parameter.Value = model.f_discussrangeid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_isdiscuss != null)
            {
	            strSql1.Append("f_isdiscuss,");
	            strSql2.Append("'" + (model.f_isdiscuss) + "',");
	            strSql3.Append(":f_isdiscuss,");
	            parameter = new OracleParameter(":f_isdiscuss", OracleType.VarChar);
	            parameter.Value = model.f_isdiscuss;
	            parameterList.Add(parameter);
            }
            
            if (model.f_isviewdiscussrange != null)
            {
	            strSql1.Append("f_isviewdiscussrange,");
	            strSql2.Append("'" + (model.f_isviewdiscussrange) + "',");
	            strSql3.Append(":f_isviewdiscussrange,");
	            parameter = new OracleParameter(":f_isviewdiscussrange", OracleType.VarChar);
	            parameter.Value = model.f_isviewdiscussrange;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_newstype != null)
            {
	            strSql1.Append("f_newstype,");
	            strSql2.Append("'" + (model.f_newstype) + "',");
	            strSql3.Append(":f_newstype,");
	            parameter = new OracleParameter(":f_newstype", OracleType.VarChar);
	            parameter.Value = model.f_newstype;
	            parameterList.Add(parameter);
            }
            
            if (model.f_newstypeid != null)
            {
	            strSql1.Append("f_newstypeid,");
	            strSql2.Append("'" + (model.f_newstypeid) + "',");
	            strSql3.Append(":f_newstypeid,");
	            parameter = new OracleParameter(":f_newstypeid", OracleType.VarChar);
	            parameter.Value = model.f_newstypeid;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_app_news(");
            ...
            strSql_use.Append("insert into tbl_app_news(");
            ...
            else
            {
                ...
                OracleParameter p = null;
			            ...
			            if (model.f_content != null && model.f_content.Length > 0)
	            {
	                p = new OracleParameter(":f_content", OracleType.Clob);
	                p.Value = (model.f_content);
	                pList.Add(p);
	                paraStrList.Add(" f_content = :f_content ");
	            }
	            else
	            {
	                paraStrList.Add(" f_content = null ");
	            }
	            ...
	            {
	                string updateSqlString = " update tbl_app_news set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_app_news> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_app_news model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_app_news model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_app_news set ");
            strSql_use.Append("update tbl_app_news set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_title != null&& columsList.Contains("f_title"))
            {
	            ...
	            if (model.f_titleresource != null&& columsList.Contains("f_titleresource"))
            {
                strSql.Append("f_titleresource='" + (model.f_titleresource) + "',");
                strSql_use.Append("f_titleresource=:f_titleresource,");
                parameter = new OracleParameter(":f_titleresource", OracleType.VarChar);
                parameter.Value = model.f_titleresource;
                parameterList.Add(parameter);
            }
            
	            if (model.f_titletype != null&& columsList.Contains("f_titletype"))
            {
                strSql.Append("f_titletype='" + (model.f_titletype) + "',");
                strSql_use.Append("f_titletype=:f_titletype,");
                parameter = new OracleParameter(":f_titletype", OracleType.VarChar);
                parameter.Value = model.f_titletype;
                parameterList.Add(parameter);
            }
            
	            if (model.f_titletypeid != null&& columsList.Contains("f_titletypeid"))
            {
                strSql.Append("f_titletypeid='" + (model.f_titletypeid) + "',");
                strSql_use.Append("f_titletypeid=:f_titletypeid,");
                parameter = new OracleParameter(":f_titletypeid", OracleType.VarChar);
                parameter.Value = model.f_titletypeid;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_content != null&& columsList.Contains("f_content"))
            {
	            ...
	            if (model.f_contentresource != null&& columsList.Contains("f_contentresource"))
            {
                strSql.Append("f_contentresource='" + (model.f_contentresource) + "',");
                strSql_use.Append("f_contentresource=:f_contentresource,");
                parameter = new OracleParameter(":f_contentresource", OracleType.VarChar);
                parameter.Value = model.f_contentresource;
                parameterList.Add(parameter);
            }
            
	            if (model.f_contenttype != null&& columsList.Contains("f_contenttype"))
            {
                strSql.Append("f_contenttype='" + (model.f_contenttype) + "',");
                strSql_use.Append("f_contenttype=:f_contenttype,");
                parameter = new OracleParameter(":f_contenttype", OracleType.VarChar);
                parameter.Value = model.f_contenttype;
                parameterList.Add(parameter);
            }
            
	            if (model.f_contenttypeid != null&& columsList.Contains("f_contenttypeid"))
            {
                strSql.Append("f_contenttypeid='" + (model.f_contenttypeid) + "',");
                strSql_use.Append("f_contenttypeid=:f_contenttypeid,");
                parameter = new OracleParameter(":f_contenttypeid", OracleType.VarChar);
                parameter.Value = model.f_contenttypeid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_viewrange != null&& columsList.Contains("f_viewrange"))
            {
                strSql.Append("f_viewrange='" + (model.f_viewrange) + "',");
                strSql_use.Append("f_viewrange=:f_viewrange,");
                parameter = new OracleParameter(":f_viewrange", OracleType.VarChar);
                parameter.Value = model.f_viewrange;
                parameterList.Add(parameter);
            }
            
	            if (model.f_viewrangeid != null&& columsList.Contains("f_viewrangeid"))
            {
                strSql.Append("f_viewrangeid='" + (model.f_viewrangeid) + "',");
                strSql_use.Append("f_viewrangeid=:f_viewrangeid,");
                parameter = new OracleParameter(":f_viewrangeid", OracleType.VarChar);
                parameter.Value = model.f_viewrangeid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_discussrange != null&& columsList.Contains("f_discussrange"))
            {
                strSql.Append("f_discussrange='" + (model.f_discussrange) + "',");
                strSql_use.Append("f_discussrange=:f_discussrange,");
                parameter = new OracleParameter(":f_discussrange", OracleType.VarChar);
                parameter.Value = model.f_discussrange;
                parameterList.Add(parameter);
            }
            
	            if (model.f_discussrangeid != null&& columsList.Contains("f_discussrangeid"))
            {
                strSql.Append("f_discussrangeid='" + (model.f_discussrangeid) + "',");
                strSql_use.Append("f_discussrangeid=:f_discussrangeid,");
                parameter = new OracleParameter(":f_discussrangeid", OracleType.VarChar);
                parameter.Value = model.f_discussrangeid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_isdiscuss != null&& columsList.Contains("f_isdiscuss"))
            {
                strSql.Append("f_isdiscuss='" + (model.f_isdiscuss) + "',");
                strSql_use.Append("f_isdiscuss=:f_isdiscuss,");
                parameter = new OracleParameter(":f_isdiscuss", OracleType.VarChar);
                parameter.Value = model.f_isdiscuss;
                parameterList.Add(parameter);
            }
            
	            if (model.f_isviewdiscussrange != null&& columsList.Contains("f_isviewdiscussrange"))
            {
                strSql.Append("f_isviewdiscussrange='" + (model.f_isviewdiscussrange) + "',");
                strSql_use.Append("f_isviewdiscussrange=:f_isviewdiscussrange,");
                parameter = new OracleParameter(":f_isviewdiscussrange", OracleType.VarChar);
                parameter.Value = model.f_isviewdiscussrange;
                parameterList.Add(parameter);
            }
            
	            if (model.f_isrelease != null&& columsList.Contains("f_isrelease"))
            {
                strSql.Append("f_isrelease='" + (model.f_isrelease) + "',");
                strSql_use.Append("f_isrelease=:f_isrelease,");
                parameter = new OracleParameter(":f_isrelease", OracleType.VarChar);
                parameter.Value = model.f_isrelease;
                parameterList.Add(parameter);
            }
            
	            if (model.f_releasedate != null&& columsList.Contains("f_releasedate"))
            {
                strSql.Append("f_releasedate=to_date('" + model.f_releasedate.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_releasedate=:f_releasedate,");
                parameter = new OracleParameter(":f_releasedate", OracleType.DateTime);
                parameter.Value = model.f_releasedate;
                parameterList.Add(parameter);
            }
            
	            if (model.f_newstype != null&& columsList.Contains("f_newstype"))
            {
                strSql.Append("f_newstype='" + (model.f_newstype) + "',");
                strSql_use.Append("f_newstype=:f_newstype,");
                parameter = new OracleParameter(":f_newstype", OracleType.VarChar);
                parameter.Value = model.f_newstype;
                parameterList.Add(parameter);
            }
            
	            if (model.f_newstypeid != null&& columsList.Contains("f_newstypeid"))
            {
                strSql.Append("f_newstypeid='" + (model.f_newstypeid) + "',");
                strSql_use.Append("f_newstypeid=:f_newstypeid,");
                parameter = new OracleParameter(":f_newstypeid", OracleType.VarChar);
                parameter.Value = model.f_newstypeid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_tag != null&& columsList.Contains("f_tag"))
            {
                strSql.Append("f_tag='" + (model.f_tag) + "',");
                strSql_use.Append("f_tag=:f_tag,");
                parameter = new OracleParameter(":f_tag", OracleType.VarChar);
                parameter.Value = model.f_tag;
                parameterList.Add(parameter);
            }
            
	            if (model.f_resume != null&& columsList.Contains("f_resume"))
            {
                strSql.Append("f_resume='" + (model.f_resume) + "',");
                strSql_use.Append("f_resume=:f_resume,");
                parameter = new OracleParameter(":f_resume", OracleType.VarChar);
                parameter.Value = model.f_resume;
                parameterList.Add(parameter);
            }
            ...
            else
            {
                ...
                OracleParameter p = null;				
									...
									if (columsList.Contains("f_content"))
				{ 
				if (model.f_content != null && model.f_content.Length > 0)
				{
				    p = new OracleParameter(":f_content", OracleType.Clob);
				...
				if (paraStrList.Count > 0)
				{
					string updateSqlString = " update tbl_app_news set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + model.sys_id + "' ";
					if (pList.Count > 0)
					{
					   if (t == null)
					    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_app_news> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_app_news where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_app_news");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_app_news> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_app_news t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_app_news> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_app_news>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_app_news')";
            sqlString += " where f_tablename  = 'tbl_app_news'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_app_news'";
