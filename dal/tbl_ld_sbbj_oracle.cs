...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_ld_sbbj 
    /// </summary>
    public class tbl_ld_sbbj : sara.dd.ldsw.idal.Itbl_ld_sbbj
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_ld_sbbj model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_sbid != null)
            {
	            strSql1.Append("f_sbid,");
	            strSql2.Append("'" + (model.f_sbid) + "',");
	            strSql3.Append(":f_sbid,");
	            parameter = new OracleParameter(":f_sbid", OracleType.VarChar);
	            parameter.Value = model.f_sbid;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_bjsj != null)
            {
	            strSql1.Append("f_bjsj,");
	            strSql2.Append("to_date('" + model.f_bjsj.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
	            strSql3.Append(":f_bjsj,");
	            parameter = new OracleParameter(":f_bjsj", OracleType.DateTime);
	            parameter.Value = model.f_bjsj;
	            parameterList.Add(parameter);
            }
            
            if (model.f_bjzt != null)
            {
	            strSql1.Append("f_bjzt,");
	            strSql2.Append("'" + (model.f_bjzt) + "',");
	            strSql3.Append(":f_bjzt,");
	            parameter = new OracleParameter(":f_bjzt", OracleType.VarChar);
	            parameter.Value = model.f_bjzt;
	            parameterList.Add(parameter);
            }
            
            if (model.f_bjztid != null)
            {
	            strSql1.Append("f_bjztid,");
	            strSql2.Append("'" + (model.f_bjztid) + "',");
	            strSql3.Append(":f_bjztid,");
	            parameter = new OracleParameter(":f_bjztid", OracleType.VarChar);
	            parameter.Value = model.f_bjztid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_bjnr != null)
            {
	            strSql1.Append("f_bjnr,");
	            strSql2.Append("'" + (model.f_bjnr) + "',");
	            strSql3.Append(":f_bjnr,");
	            parameter = new OracleParameter(":f_bjnr", OracleType.VarChar);
	            parameter.Value = model.f_bjnr;
	            parameterList.Add(parameter);
            }
            
            strSql.Append("insert into tbl_ld_sbbj(");
            ...
            strSql_use.Append("insert into tbl_ld_sbbj(");
            ...
            else
            {
	            ...
	            {
	                string updateSqlString = " update tbl_ld_sbbj set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_ld_sbbj> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_ld_sbbj model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_ld_sbbj model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_ld_sbbj set ");
            strSql_use.Append("update tbl_ld_sbbj set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_value10 != null&& columsList.Contains("f_value10"))
            {
	            ...
	            if (model.f_sbid != null&& columsList.Contains("f_sbid"))
            {
                strSql.Append("f_sbid='" + (model.f_sbid) + "',");
                strSql_use.Append("f_sbid=:f_sbid,");
                parameter = new OracleParameter(":f_sbid", OracleType.VarChar);
                parameter.Value = model.f_sbid;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_sbbh != null&& columsList.Contains("f_sbbh"))
            {
	            ...
	            if (model.f_bjsj != null&& columsList.Contains("f_bjsj"))
            {
                strSql.Append("f_bjsj=to_date('" + model.f_bjsj.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_bjsj=:f_bjsj,");
                parameter = new OracleParameter(":f_bjsj", OracleType.DateTime);
                parameter.Value = model.f_bjsj;
                parameterList.Add(parameter);
            }
            
	            if (model.f_bjzt != null&& columsList.Contains("f_bjzt"))
            {
                strSql.Append("f_bjzt='" + (model.f_bjzt) + "',");
                strSql_use.Append("f_bjzt=:f_bjzt,");
                parameter = new OracleParameter(":f_bjzt", OracleType.VarChar);
                parameter.Value = model.f_bjzt;
                parameterList.Add(parameter);
            }
            
	            if (model.f_bjztid != null&& columsList.Contains("f_bjztid"))
            {
                strSql.Append("f_bjztid='" + (model.f_bjztid) + "',");
                strSql_use.Append("f_bjztid=:f_bjztid,");
                parameter = new OracleParameter(":f_bjztid", OracleType.VarChar);
                parameter.Value = model.f_bjztid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_bjnr != null&& columsList.Contains("f_bjnr"))
            {
                strSql.Append("f_bjnr='" + (model.f_bjnr) + "',");
                strSql_use.Append("f_bjnr=:f_bjnr,");
                parameter = new OracleParameter(":f_bjnr", OracleType.VarChar);
                parameter.Value = model.f_bjnr;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_ld_sbbj> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_ld_sbbj where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_ld_sbbj");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_ld_sbbj> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_ld_sbbj t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_ld_sbbj> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_ld_sbbj>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_ld_sbbj')";
            sqlString += " where f_tablename  = 'tbl_ld_sbbj'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_ld_sbbj'";
