...
{
    /// <summary>
    /// 数据访问类tbl_ld_cbreport 
    /// </summary>
    public class tbl_ld_cbreport : sara.dd.ldsw.idal.Itbl_ld_cbreport
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_ld_cbreport model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            strSql.Append("insert into tbl_ld_cbiao_qf(");
            ...
            strSql_use.Append("insert into tbl_ld_cbiao_qf(");
            ...
            else
            {
	            ...
	            {
	                string updateSqlString = " update tbl_ld_cbiao_qf set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_ld_cbreport> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_ld_cbreport model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_ld_cbreport model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_ld_cbiao_qf set ");
            strSql_use.Append("update tbl_ld_cbiao_qf set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_ld_cbreport> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_ld_cbiao_qf where  ");
        ...
        public string GetCount(string whereString, string cxzxsjString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (sara.dd.ldsw.commonclass.commonclass.isNeedHis("cBiao", cxzxsjString) == true)
            {
                ...
                strSql.Append(" ( ");
                strSql.Append(" select count(*) as c  from tbl_ld_cbiao_qf t ");
                if (whereString.Trim() != "")
                {
                    strSql.Append(" where " + whereString);
                }
                strSql.Append(" union  all ");
                strSql.Append(" select count(*) as c  from tbl_ld_cbiao_qf_his t ");
                if (whereString.Trim() != "")
                {
                    strSql.Append(" where " + whereString);
                }
            ...
            {
                strSql.Append("select count(*) from tbl_ld_cbiao_qf t");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
                }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_ld_cbreport> GetList(string whereString, string cxzxsjString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            if (sara.dd.ldsw.commonclass.commonclass.isNeedHis("cBiao", cxzxsjString) == true)
            {
                ...
                strSql.Append("  ( ");
                strSql.Append("  (select * from tbl_ld_cbiao_qf t where ");
                if (whereString.Trim() == "")
                {
                    strSql.Append(" 1=1 ");
                }
                ...
                strSql.Append("   )    ");                       
                strSql.Append("  union  all ");
                strSql.Append("  (select * from tbl_ld_cbiao_qf_his t where  ");
                if (whereString.Trim() == "")
                {
                    strSql.Append(" 1=1 ");
                }
            ...
            List<sara.dd.ldsw.model.tbl_ld_cbreport> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_ld_cbreport>(resultDataTable);
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            //sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_ld_cbiao_qf')";
            //sqlString += " where f_tablename  = 'tbl_ld_cbiao_qf'";
           ...
           // sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_ld_cbiao_qf'";
         ...
         //   {
          ...
          //  }
            ...
            string sqlString = "";
            sqlString = "select tbl_ld_cbiao_qf_SYS_ID_SEQU.NEXTVAL from dual";
            return _iAccessData.GetSingle(sqlString).ToString();
        }
