...
{
    /// <summary>
    /// 数据访问类tbl_app_version_color 
    /// </summary>
    public class tbl_app_version_color : sara.dd.ldsw.idal.Itbl_app_version_color
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_app_version_color model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_resourcename != null)
            {
	            strSql1.Append("f_resourcename,");
	            strSql2.Append("'" + (model.f_resourcename) + "',");
	            strSql3.Append(":f_resourcename,");
	            parameter = new OracleParameter(":f_resourcename", OracleType.VarChar);
	            parameter.Value = model.f_resourcename;
	            parameterList.Add(parameter);
            }
            
            if (model.f_resourcekey != null)
            {
	            strSql1.Append("f_resourcekey,");
	            strSql2.Append("'" + (model.f_resourcekey) + "',");
	            strSql3.Append(":f_resourcekey,");
	            parameter = new OracleParameter(":f_resourcekey", OracleType.VarChar);
	            parameter.Value = model.f_resourcekey;
	            parameterList.Add(parameter);
            }
            
            if (model.f_resourcevalue != null)
            {
	            strSql1.Append("f_resourcevalue,");
	            strSql2.Append("'" + (model.f_resourcevalue) + "',");
	            strSql3.Append(":f_resourcevalue,");
	            parameter = new OracleParameter(":f_resourcevalue", OracleType.VarChar);
	            parameter.Value = model.f_resourcevalue;
	            parameterList.Add(parameter);
            }
            
            strSql.Append("insert into tbl_app_version_color(");
            ...
            strSql_use.Append("insert into tbl_app_version_color(");
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_app_version_color> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_app_version_color model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_app_version_color model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_app_version_color set ");
            strSql_use.Append("update tbl_app_version_color set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_value10 != null&& columsList.Contains("f_value10"))
            {
	            ...
	            if (model.f_resourcename != null&& columsList.Contains("f_resourcename"))
            {
                strSql.Append("f_resourcename='" + (model.f_resourcename) + "',");
                strSql_use.Append("f_resourcename=:f_resourcename,");
                parameter = new OracleParameter(":f_resourcename", OracleType.VarChar);
                parameter.Value = model.f_resourcename;
                parameterList.Add(parameter);
            }
            
	            if (model.f_resourcekey != null&& columsList.Contains("f_resourcekey"))
            {
                strSql.Append("f_resourcekey='" + (model.f_resourcekey) + "',");
                strSql_use.Append("f_resourcekey=:f_resourcekey,");
                parameter = new OracleParameter(":f_resourcekey", OracleType.VarChar);
                parameter.Value = model.f_resourcekey;
                parameterList.Add(parameter);
            }
            
	            if (model.f_resourcevalue != null&& columsList.Contains("f_resourcevalue"))
            {
                strSql.Append("f_resourcevalue='" + (model.f_resourcevalue) + "',");
                strSql_use.Append("f_resourcevalue=:f_resourcevalue,");
                parameter = new OracleParameter(":f_resourcevalue", OracleType.VarChar);
                parameter.Value = model.f_resourcevalue;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_app_version_color> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_app_version_color where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_app_version_color");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_app_version_color> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_app_version_color t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_app_version_color> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_app_version_color>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_app_version_color')";
            sqlString += " where f_tablename  = 'tbl_app_version_color'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_app_version_color'";
