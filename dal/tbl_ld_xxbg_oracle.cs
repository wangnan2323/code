...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_ld_xxbg 
    /// </summary>
    public class tbl_ld_xxbg : sara.dd.ldsw.idal.Itbl_ld_xxbg
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_ld_xxbg model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_bgmc != null)
            {
	            strSql1.Append("f_bgmc,");
	            strSql2.Append("'" + (model.f_bgmc) + "',");
	            strSql3.Append(":f_bgmc,");
	            parameter = new OracleParameter(":f_bgmc", OracleType.VarChar);
	            parameter.Value = model.f_bgmc;
	            parameterList.Add(parameter);
            }
            
            if (model.f_bglx != null)
            {
	            strSql1.Append("f_bglx,");
	            strSql2.Append("'" + (model.f_bglx) + "',");
	            strSql3.Append(":f_bglx,");
	            parameter = new OracleParameter(":f_bglx", OracleType.VarChar);
	            parameter.Value = model.f_bglx;
	            parameterList.Add(parameter);
            }
            
            if (model.f_bglxid != null)
            {
	            strSql1.Append("f_bglxid,");
	            strSql2.Append("'" + (model.f_bglxid) + "',");
	            strSql3.Append(":f_bglxid,");
	            parameter = new OracleParameter(":f_bglxid", OracleType.VarChar);
	            parameter.Value = model.f_bglxid;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_bgyy != null)
            {
	            strSql1.Append("f_bgyy,");
	            strSql2.Append("'" + (model.f_bgyy) + "',");
	            strSql3.Append(":f_bgyy,");
	            parameter = new OracleParameter(":f_bgyy", OracleType.VarChar);
	            parameter.Value = model.f_bgyy;
	            parameterList.Add(parameter);
            }
            
            if (model.f_bgyj != null)
            {
	            strSql1.Append("f_bgyj,");
	            strSql2.Append("'" + (model.f_bgyj) + "',");
	            strSql3.Append(":f_bgyj,");
	            parameter = new OracleParameter(":f_bgyj", OracleType.VarChar);
	            parameter.Value = model.f_bgyj;
	            parameterList.Add(parameter);
            }
            
            if (model.f_fqr != null)
            {
	            strSql1.Append("f_fqr,");
	            strSql2.Append("'" + (model.f_fqr) + "',");
	            strSql3.Append(":f_fqr,");
	            parameter = new OracleParameter(":f_fqr", OracleType.VarChar);
	            parameter.Value = model.f_fqr;
	            parameterList.Add(parameter);
            }
            
            if (model.f_fqrid != null)
            {
	            strSql1.Append("f_fqrid,");
	            strSql2.Append("'" + (model.f_fqrid) + "',");
	            strSql3.Append(":f_fqrid,");
	            parameter = new OracleParameter(":f_fqrid", OracleType.VarChar);
	            parameter.Value = model.f_fqrid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_fqsj != null)
            {
	            strSql1.Append("f_fqsj,");
	            strSql2.Append("to_date('" + model.f_fqsj.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
	            strSql3.Append(":f_fqsj,");
	            parameter = new OracleParameter(":f_fqsj", OracleType.DateTime);
	            parameter.Value = model.f_fqsj;
	            parameterList.Add(parameter);
            }
            
            if (model.f_xgr != null)
            {
	            strSql1.Append("f_xgr,");
	            strSql2.Append("'" + (model.f_xgr) + "',");
	            strSql3.Append(":f_xgr,");
	            parameter = new OracleParameter(":f_xgr", OracleType.VarChar);
	            parameter.Value = model.f_xgr;
	            parameterList.Add(parameter);
            }
            
            if (model.f_xgrid != null)
            {
	            strSql1.Append("f_xgrid,");
	            strSql2.Append("'" + (model.f_xgrid) + "',");
	            strSql3.Append(":f_xgrid,");
	            parameter = new OracleParameter(":f_xgrid", OracleType.VarChar);
	            parameter.Value = model.f_xgrid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_xgsj != null)
            {
	            strSql1.Append("f_xgsj,");
	            strSql2.Append("to_date('" + model.f_xgsj.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
	            strSql3.Append(":f_xgsj,");
	            parameter = new OracleParameter(":f_xgsj", OracleType.DateTime);
	            parameter.Value = model.f_xgsj;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_khbh != null && model.f_khbh.Length > 0)
            {
                strSql1.Append("f_khbh,");
                strSql2.Append("'" + (model.f_khbh) + "',");
                strSql3.Append(":f_khbh,");
                parameter = new OracleParameter(":f_khbh", OracleType.Clob);
                parameter.Value = model.f_khbh;
                parameterList.Add(parameter);
            }
            if (model.f_khbhid != null && model.f_khbhid.Length > 0)
            {
                strSql1.Append("f_khbhid,");
                strSql2.Append("'" + (model.f_khbhid) + "',");
                strSql3.Append(":f_khbhid,");
                parameter = new OracleParameter(":f_khbhid", OracleType.Clob);
                parameter.Value = model.f_khbhid;
                parameterList.Add(parameter);
            }
            strSql.Append("insert into tbl_ld_xxbg(");
            ...
            strSql_use.Append("insert into tbl_ld_xxbg(");
            ...
            else
            {
	            ...
	            {
	                string updateSqlString = " update tbl_ld_xxbg set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_ld_xxbg> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_ld_xxbg model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_ld_xxbg model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_ld_xxbg set ");
            strSql_use.Append("update tbl_ld_xxbg set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_value10 != null&& columsList.Contains("f_value10"))
            {
	            ...
	            if (model.f_bgmc != null&& columsList.Contains("f_bgmc"))
            {
                strSql.Append("f_bgmc='" + (model.f_bgmc) + "',");
                strSql_use.Append("f_bgmc=:f_bgmc,");
                parameter = new OracleParameter(":f_bgmc", OracleType.VarChar);
                parameter.Value = model.f_bgmc;
                parameterList.Add(parameter);
            }
            
	            if (model.f_bglx != null&& columsList.Contains("f_bglx"))
            {
                strSql.Append("f_bglx='" + (model.f_bglx) + "',");
                strSql_use.Append("f_bglx=:f_bglx,");
                parameter = new OracleParameter(":f_bglx", OracleType.VarChar);
                parameter.Value = model.f_bglx;
                parameterList.Add(parameter);
            }
            
	            if (model.f_bglxid != null&& columsList.Contains("f_bglxid"))
            {
                strSql.Append("f_bglxid='" + (model.f_bglxid) + "',");
                strSql_use.Append("f_bglxid=:f_bglxid,");
                parameter = new OracleParameter(":f_bglxid", OracleType.VarChar);
                parameter.Value = model.f_bglxid;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.fk_tbl_maintable_sys_id != null&& columsList.Contains("fk_tbl_maintable_sys_id"))
            {
	            ...
	            if (model.f_bgyy != null&& columsList.Contains("f_bgyy"))
            {
                strSql.Append("f_bgyy='" + (model.f_bgyy) + "',");
                strSql_use.Append("f_bgyy=:f_bgyy,");
                parameter = new OracleParameter(":f_bgyy", OracleType.VarChar);
                parameter.Value = model.f_bgyy;
                parameterList.Add(parameter);
            }
            
	            if (model.f_bgyj != null&& columsList.Contains("f_bgyj"))
            {
                strSql.Append("f_bgyj='" + (model.f_bgyj) + "',");
                strSql_use.Append("f_bgyj=:f_bgyj,");
                parameter = new OracleParameter(":f_bgyj", OracleType.VarChar);
                parameter.Value = model.f_bgyj;
                parameterList.Add(parameter);
            }
            
	            if (model.f_fqr != null&& columsList.Contains("f_fqr"))
            {
                strSql.Append("f_fqr='" + (model.f_fqr) + "',");
                strSql_use.Append("f_fqr=:f_fqr,");
                parameter = new OracleParameter(":f_fqr", OracleType.VarChar);
                parameter.Value = model.f_fqr;
                parameterList.Add(parameter);
            }
            
	            if (model.f_fqrid != null&& columsList.Contains("f_fqrid"))
            {
                strSql.Append("f_fqrid='" + (model.f_fqrid) + "',");
                strSql_use.Append("f_fqrid=:f_fqrid,");
                parameter = new OracleParameter(":f_fqrid", OracleType.VarChar);
                parameter.Value = model.f_fqrid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_fqsj != null&& columsList.Contains("f_fqsj"))
            {
                strSql.Append("f_fqsj=to_date('" + model.f_fqsj.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_fqsj=:f_fqsj,");
                parameter = new OracleParameter(":f_fqsj", OracleType.DateTime);
                parameter.Value = model.f_fqsj;
                parameterList.Add(parameter);
            }
            
	            if (model.f_xgr != null&& columsList.Contains("f_xgr"))
            {
                strSql.Append("f_xgr='" + (model.f_xgr) + "',");
                strSql_use.Append("f_xgr=:f_xgr,");
                parameter = new OracleParameter(":f_xgr", OracleType.VarChar);
                parameter.Value = model.f_xgr;
                parameterList.Add(parameter);
            }
            
	            if (model.f_xgrid != null&& columsList.Contains("f_xgrid"))
            {
                strSql.Append("f_xgrid='" + (model.f_xgrid) + "',");
                strSql_use.Append("f_xgrid=:f_xgrid,");
                parameter = new OracleParameter(":f_xgrid", OracleType.VarChar);
                parameter.Value = model.f_xgrid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_xgsj != null&& columsList.Contains("f_xgsj"))
            {
                strSql.Append("f_xgsj=to_date('" + model.f_xgsj.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_xgsj=:f_xgsj,");
                parameter = new OracleParameter(":f_xgsj", OracleType.DateTime);
                parameter.Value = model.f_xgsj;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_ld_xxbg> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_ld_xxbg where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_ld_xxbg");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_ld_xxbg> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_ld_xxbg t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_ld_xxbg> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_ld_xxbg>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_ld_xxbg')";
            sqlString += " where f_tablename  = 'tbl_ld_xxbg'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_ld_xxbg'";
