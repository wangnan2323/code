...
{
    /// <summary>
    /// 数据访问类tbl_codefactory 
    /// </summary>
    public class tbl_codefactory : sara.dd.ldsw.idal.Itbl_codefactory
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_codefactory model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_text1 != null)
            {
	            strSql1.Append("f_text1,");
	            strSql2.Append("'" + (model.f_text1) + "',");
	            strSql3.Append(":f_text1,");
	            parameter = new OracleParameter(":f_text1", OracleType.VarChar);
	            parameter.Value = model.f_text1;
	            parameterList.Add(parameter);
            }
            
            if (model.f_text2 != null)
            {
	            strSql1.Append("f_text2,");
	            strSql2.Append("'" + (model.f_text2) + "',");
	            strSql3.Append(":f_text2,");
	            parameter = new OracleParameter(":f_text2", OracleType.VarChar);
	            parameter.Value = model.f_text2;
	            parameterList.Add(parameter);
            }
            
            if (model.f_text3 != null)
            {
	            strSql1.Append("f_text3,");
	            strSql2.Append("'" + (model.f_text3) + "',");
	            strSql3.Append(":f_text3,");
	            parameter = new OracleParameter(":f_text3", OracleType.VarChar);
	            parameter.Value = model.f_text3;
	            parameterList.Add(parameter);
            }
            
            if (model.f_singledropdownlist != null)
            {
	            strSql1.Append("f_singledropdownlist,");
	            strSql2.Append("'" + (model.f_singledropdownlist) + "',");
	            strSql3.Append(":f_singledropdownlist,");
	            parameter = new OracleParameter(":f_singledropdownlist", OracleType.VarChar);
	            parameter.Value = model.f_singledropdownlist;
	            parameterList.Add(parameter);
            }
            
            if (model.f_singledropdownlistid != null)
            {
	            strSql1.Append("f_singledropdownlistid,");
	            strSql2.Append("'" + (model.f_singledropdownlistid) + "',");
	            strSql3.Append(":f_singledropdownlistid,");
	            parameter = new OracleParameter(":f_singledropdownlistid", OracleType.VarChar);
	            parameter.Value = model.f_singledropdownlistid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_multidropdownlist != null)
            {
	            strSql1.Append("f_multidropdownlist,");
	            strSql2.Append("'" + (model.f_multidropdownlist) + "',");
	            strSql3.Append(":f_multidropdownlist,");
	            parameter = new OracleParameter(":f_multidropdownlist", OracleType.VarChar);
	            parameter.Value = model.f_multidropdownlist;
	            parameterList.Add(parameter);
            }
            
            if (model.f_multidropdownlistid != null)
            {
	            strSql1.Append("f_multidropdownlistid,");
	            strSql2.Append("'" + (model.f_multidropdownlistid) + "',");
	            strSql3.Append(":f_multidropdownlistid,");
	            parameter = new OracleParameter(":f_multidropdownlistid", OracleType.VarChar);
	            parameter.Value = model.f_multidropdownlistid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_itemlist != null)
            {
	            strSql1.Append("f_itemlist,");
	            strSql2.Append("'" + (model.f_itemlist) + "',");
	            strSql3.Append(":f_itemlist,");
	            parameter = new OracleParameter(":f_itemlist", OracleType.VarChar);
	            parameter.Value = model.f_itemlist;
	            parameterList.Add(parameter);
            }
            
            if (model.f_itemlistid != null)
            {
	            strSql1.Append("f_itemlistid,");
	            strSql2.Append("'" + (model.f_itemlistid) + "',");
	            strSql3.Append(":f_itemlistid,");
	            parameter = new OracleParameter(":f_itemlistid", OracleType.VarChar);
	            parameter.Value = model.f_itemlistid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_toggle != null)
            {
	            strSql1.Append("f_toggle,");
	            strSql2.Append("'" + (model.f_toggle) + "',");
	            strSql3.Append(":f_toggle,");
	            parameter = new OracleParameter(":f_toggle", OracleType.VarChar);
	            parameter.Value = model.f_toggle;
	            parameterList.Add(parameter);
            }
            
            if (model.f_checklist != null)
            {
	            strSql1.Append("f_checklist,");
	            strSql2.Append("'" + (model.f_checklist) + "',");
	            strSql3.Append(":f_checklist,");
	            parameter = new OracleParameter(":f_checklist", OracleType.VarChar);
	            parameter.Value = model.f_checklist;
	            parameterList.Add(parameter);
            }
            
            if (model.f_checklistid != null)
            {
	            strSql1.Append("f_checklistid,");
	            strSql2.Append("'" + (model.f_checklistid) + "',");
	            strSql3.Append(":f_checklistid,");
	            parameter = new OracleParameter(":f_checklistid", OracleType.VarChar);
	            parameter.Value = model.f_checklistid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_radiolist != null)
            {
	            strSql1.Append("f_radiolist,");
	            strSql2.Append("'" + (model.f_radiolist) + "',");
	            strSql3.Append(":f_radiolist,");
	            parameter = new OracleParameter(":f_radiolist", OracleType.VarChar);
	            parameter.Value = model.f_radiolist;
	            parameterList.Add(parameter);
            }
            
            if (model.f_radiolistid != null)
            {
	            strSql1.Append("f_radiolistid,");
	            strSql2.Append("'" + (model.f_radiolistid) + "',");
	            strSql3.Append(":f_radiolistid,");
	            parameter = new OracleParameter(":f_radiolistid", OracleType.VarChar);
	            parameter.Value = model.f_radiolistid;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_datetime != null)
            {
	            strSql1.Append("f_datetime,");
	            strSql2.Append("to_date('" + model.f_datetime.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
	            strSql3.Append(":f_datetime,");
	            parameter = new OracleParameter(":f_datetime", OracleType.DateTime);
	            parameter.Value = model.f_datetime;
	            parameterList.Add(parameter);
            }
            
            if (model.f_slider != null)
            {
	            strSql1.Append("f_slider,");
	            strSql2.Append("'" + (model.f_slider) + "',");
	            strSql3.Append(":f_slider,");
	            parameter = new OracleParameter(":f_slider", OracleType.VarChar);
	            parameter.Value = model.f_slider;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_richtext != null && model.f_richtext.Length > 0)
            {
	            strSql1.Append("f_richtext,");
	            strSql2.Append("'" + (model.f_richtext) + "',");
	            strSql3.Append(":f_richtext,");
	            parameter = new OracleParameter(":f_richtext", OracleType.Clob);
	            parameter.Value = model.f_richtext;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_codefactory(");
            ...
            strSql_use.Append("insert into tbl_codefactory(");
            ...
            else
            {
                ...
                OracleParameter p = null;
			            ...
			            if (model.f_richtext != null && model.f_richtext.Length > 0)
	            {
	                p = new OracleParameter(":f_richtext", OracleType.Clob);
	                p.Value = (model.f_richtext);
	                pList.Add(p);
	                paraStrList.Add(" f_richtext = :f_richtext ");
	            }
	            else
	            {
	                paraStrList.Add(" f_richtext = null ");
	            }
	            
			            
	            if (paraStrList.Count > 0)
	            {
	                string updateSqlString = " update tbl_codefactory set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_codefactory> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_codefactory model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_codefactory model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_codefactory set ");
            strSql_use.Append("update tbl_codefactory set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_value10 != null&& columsList.Contains("f_value10"))
            {
	            ...
	            if (model.f_text1 != null&& columsList.Contains("f_text1"))
            {
                strSql.Append("f_text1='" + (model.f_text1) + "',");
                strSql_use.Append("f_text1=:f_text1,");
                parameter = new OracleParameter(":f_text1", OracleType.VarChar);
                parameter.Value = model.f_text1;
                parameterList.Add(parameter);
            }
            
	            if (model.f_text2 != null&& columsList.Contains("f_text2"))
            {
                strSql.Append("f_text2='" + (model.f_text2) + "',");
                strSql_use.Append("f_text2=:f_text2,");
                parameter = new OracleParameter(":f_text2", OracleType.VarChar);
                parameter.Value = model.f_text2;
                parameterList.Add(parameter);
            }
            
	            if (model.f_text3 != null&& columsList.Contains("f_text3"))
            {
                strSql.Append("f_text3='" + (model.f_text3) + "',");
                strSql_use.Append("f_text3=:f_text3,");
                parameter = new OracleParameter(":f_text3", OracleType.VarChar);
                parameter.Value = model.f_text3;
                parameterList.Add(parameter);
            }
            
	            if (model.f_singledropdownlist != null&& columsList.Contains("f_singledropdownlist"))
            {
                strSql.Append("f_singledropdownlist='" + (model.f_singledropdownlist) + "',");
                strSql_use.Append("f_singledropdownlist=:f_singledropdownlist,");
                parameter = new OracleParameter(":f_singledropdownlist", OracleType.VarChar);
                parameter.Value = model.f_singledropdownlist;
                parameterList.Add(parameter);
            }
            
	            if (model.f_singledropdownlistid != null&& columsList.Contains("f_singledropdownlistid"))
            {
                strSql.Append("f_singledropdownlistid='" + (model.f_singledropdownlistid) + "',");
                strSql_use.Append("f_singledropdownlistid=:f_singledropdownlistid,");
                parameter = new OracleParameter(":f_singledropdownlistid", OracleType.VarChar);
                parameter.Value = model.f_singledropdownlistid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_multidropdownlist != null&& columsList.Contains("f_multidropdownlist"))
            {
                strSql.Append("f_multidropdownlist='" + (model.f_multidropdownlist) + "',");
                strSql_use.Append("f_multidropdownlist=:f_multidropdownlist,");
                parameter = new OracleParameter(":f_multidropdownlist", OracleType.VarChar);
                parameter.Value = model.f_multidropdownlist;
                parameterList.Add(parameter);
            }
            
	            if (model.f_multidropdownlistid != null&& columsList.Contains("f_multidropdownlistid"))
            {
                strSql.Append("f_multidropdownlistid='" + (model.f_multidropdownlistid) + "',");
                strSql_use.Append("f_multidropdownlistid=:f_multidropdownlistid,");
                parameter = new OracleParameter(":f_multidropdownlistid", OracleType.VarChar);
                parameter.Value = model.f_multidropdownlistid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_itemlist != null&& columsList.Contains("f_itemlist"))
            {
                strSql.Append("f_itemlist='" + (model.f_itemlist) + "',");
                strSql_use.Append("f_itemlist=:f_itemlist,");
                parameter = new OracleParameter(":f_itemlist", OracleType.VarChar);
                parameter.Value = model.f_itemlist;
                parameterList.Add(parameter);
            }
            
	            if (model.f_itemlistid != null&& columsList.Contains("f_itemlistid"))
            {
                strSql.Append("f_itemlistid='" + (model.f_itemlistid) + "',");
                strSql_use.Append("f_itemlistid=:f_itemlistid,");
                parameter = new OracleParameter(":f_itemlistid", OracleType.VarChar);
                parameter.Value = model.f_itemlistid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_toggle != null&& columsList.Contains("f_toggle"))
            {
                strSql.Append("f_toggle='" + (model.f_toggle) + "',");
                strSql_use.Append("f_toggle=:f_toggle,");
                parameter = new OracleParameter(":f_toggle", OracleType.VarChar);
                parameter.Value = model.f_toggle;
                parameterList.Add(parameter);
            }
            
	            if (model.f_checklist != null&& columsList.Contains("f_checklist"))
            {
                strSql.Append("f_checklist='" + (model.f_checklist) + "',");
                strSql_use.Append("f_checklist=:f_checklist,");
                parameter = new OracleParameter(":f_checklist", OracleType.VarChar);
                parameter.Value = model.f_checklist;
                parameterList.Add(parameter);
            }
            
	            if (model.f_checklistid != null&& columsList.Contains("f_checklistid"))
            {
                strSql.Append("f_checklistid='" + (model.f_checklistid) + "',");
                strSql_use.Append("f_checklistid=:f_checklistid,");
                parameter = new OracleParameter(":f_checklistid", OracleType.VarChar);
                parameter.Value = model.f_checklistid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_radiolist != null&& columsList.Contains("f_radiolist"))
            {
                strSql.Append("f_radiolist='" + (model.f_radiolist) + "',");
                strSql_use.Append("f_radiolist=:f_radiolist,");
                parameter = new OracleParameter(":f_radiolist", OracleType.VarChar);
                parameter.Value = model.f_radiolist;
                parameterList.Add(parameter);
            }
            
	            if (model.f_radiolistid != null&& columsList.Contains("f_radiolistid"))
            {
                strSql.Append("f_radiolistid='" + (model.f_radiolistid) + "',");
                strSql_use.Append("f_radiolistid=:f_radiolistid,");
                parameter = new OracleParameter(":f_radiolistid", OracleType.VarChar);
                parameter.Value = model.f_radiolistid;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_autocomplete != null&& columsList.Contains("f_autocomplete"))
            {
	            ...
	            if (model.f_datetime != null&& columsList.Contains("f_datetime"))
            {
                strSql.Append("f_datetime=to_date('" + model.f_datetime.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_datetime=:f_datetime,");
                parameter = new OracleParameter(":f_datetime", OracleType.DateTime);
                parameter.Value = model.f_datetime;
                parameterList.Add(parameter);
            }
            
	            if (model.f_slider != null&& columsList.Contains("f_slider"))
            {
                strSql.Append("f_slider='" + (model.f_slider) + "',");
                strSql_use.Append("f_slider=:f_slider,");
                parameter = new OracleParameter(":f_slider", OracleType.VarChar);
                parameter.Value = model.f_slider;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_textarea != null&& columsList.Contains("f_textarea"))
            {
	            ...
	            if (model.f_richtext != null&& columsList.Contains("f_richtext"))
            {
                strSql.Append("f_richtext='" + (model.f_richtext) + "',");
                strSql_use.Append("f_richtext=:f_richtext,");
                parameter = new OracleParameter(":f_richtext", OracleType.Clob);
                if (model.f_richtext == "")
                {
                    parameter.Value = " ";
            ...
            else
            {
                ...
                OracleParameter p = null;				
									...
									if (columsList.Contains("f_richtext"))
				{ 
				if (model.f_richtext != null && model.f_richtext.Length > 0)
				{
				    p = new OracleParameter(":f_richtext", OracleType.Clob);
				...
				if (paraStrList.Count > 0)
				{
					string updateSqlString = " update tbl_codefactory set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + model.sys_id + "' ";
					if (pList.Count > 0)
					{
					   if (t == null)
					    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_codefactory> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_codefactory where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_codefactory");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_codefactory> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_codefactory t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_codefactory> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_codefactory>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
...
public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_codefactory')";
            sqlString += " where f_tablename  = 'tbl_codefactory'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_codefactory'";
