...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_ld_log 
    /// </summary>
    public class tbl_ld_log : sara.dd.ldsw.idal.Itbl_ld_log
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_ld_log model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_businesstableprikeyvalue != null)
            {
	            strSql1.Append("f_businesstableprikeyvalue,");
	            strSql2.Append("'" + (model.f_businesstableprikeyvalue) + "',");
	            strSql3.Append(":f_businesstableprikeyvalue,");
	            parameter = new OracleParameter(":f_businesstableprikeyvalue", OracleType.VarChar);
	            parameter.Value = model.f_businesstableprikeyvalue;
	            parameterList.Add(parameter);
            }
            
            if (model.f_editusername != null)
            {
	            strSql1.Append("f_editusername,");
	            strSql2.Append("'" + (model.f_editusername) + "',");
	            strSql3.Append(":f_editusername,");
	            parameter = new OracleParameter(":f_editusername", OracleType.VarChar);
	            parameter.Value = model.f_editusername;
	            parameterList.Add(parameter);
            }
            
            if (model.f_edituserloginname != null)
            {
	            strSql1.Append("f_edituserloginname,");
	            strSql2.Append("'" + (model.f_edituserloginname) + "',");
	            strSql3.Append(":f_edituserloginname,");
	            parameter = new OracleParameter(":f_edituserloginname", OracleType.VarChar);
	            parameter.Value = model.f_edituserloginname;
	            parameterList.Add(parameter);
            }
            
            if (model.f_edituserid != null)
            {
	            strSql1.Append("f_edituserid,");
	            strSql2.Append("'" + (model.f_edituserid) + "',");
	            strSql3.Append(":f_edituserid,");
	            parameter = new OracleParameter(":f_edituserid", OracleType.VarChar);
	            parameter.Value = model.f_edituserid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_edituserip != null)
            {
	            strSql1.Append("f_edituserip,");
	            strSql2.Append("'" + (model.f_edituserip) + "',");
	            strSql3.Append(":f_edituserip,");
	            parameter = new OracleParameter(":f_edituserip", OracleType.VarChar);
	            parameter.Value = model.f_edituserip;
	            parameterList.Add(parameter);
            }
            
            if (model.f_editusermac != null)
            {
	            strSql1.Append("f_editusermac,");
	            strSql2.Append("'" + (model.f_editusermac) + "',");
	            strSql3.Append(":f_editusermac,");
	            parameter = new OracleParameter(":f_editusermac", OracleType.VarChar);
	            parameter.Value = model.f_editusermac;
	            parameterList.Add(parameter);
            }
            
            if (model.f_editdatetime != null)
            {
	            strSql1.Append("f_editdatetime,");
	            strSql2.Append("to_date('" + model.f_editdatetime.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
	            strSql3.Append(":f_editdatetime,");
	            parameter = new OracleParameter(":f_editdatetime", OracleType.DateTime);
	            parameter.Value = model.f_editdatetime;
	            parameterList.Add(parameter);
            }
            
            if (model.f_edittype != null)
            {
	            strSql1.Append("f_edittype,");
	            strSql2.Append("'" + (model.f_edittype) + "',");
	            strSql3.Append(":f_edittype,");
	            parameter = new OracleParameter(":f_edittype", OracleType.VarChar);
	            parameter.Value = model.f_edittype;
	            parameterList.Add(parameter);
            }
            
            if (model.f_editsource != null)
            {
	            strSql1.Append("f_editsource,");
	            strSql2.Append("'" + (model.f_editsource) + "',");
	            strSql3.Append(":f_editsource,");
	            parameter = new OracleParameter(":f_editsource", OracleType.VarChar);
	            parameter.Value = model.f_editsource;
	            parameterList.Add(parameter);
            }
            
            if (model.f_editcontent != null && model.f_editcontent.Length > 0)
            {
	            strSql1.Append("f_editcontent,");
	            strSql2.Append("'" + (model.f_editcontent) + "',");
	            strSql3.Append(":f_editcontent,");
	            parameter = new OracleParameter(":f_editcontent", OracleType.Clob);
	            parameter.Value = model.f_editcontent;
	            parameterList.Add(parameter);
            }
            
            if (model.f_editcontentid != null)
            {
	            strSql1.Append("f_editcontentid,");
	            strSql2.Append("'" + (model.f_editcontentid) + "',");
	            strSql3.Append(":f_editcontentid,");
	            parameter = new OracleParameter(":f_editcontentid", OracleType.VarChar);
	            parameter.Value = model.f_editcontentid;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_ld_log(");
            ...
            strSql_use.Append("insert into tbl_ld_log(");
            ...
            else
            {
                ...
                OracleParameter p = null;
			            ...
			            if (model.f_editcontent != null && model.f_editcontent.Length > 0)
	            {
	                p = new OracleParameter(":f_editcontent", OracleType.Clob);
	                p.Value = (model.f_editcontent);
	                pList.Add(p);
	                paraStrList.Add(" f_editcontent = :f_editcontent ");
	            }
	            else
	            {
	                paraStrList.Add(" f_editcontent = null ");
	            }
	            ...
	            {
	                string updateSqlString = " update tbl_ld_log set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_ld_log> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_ld_log model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_ld_log model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_ld_log set ");
            strSql_use.Append("update tbl_ld_log set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_businesstablename != null&& columsList.Contains("f_businesstablename"))
            {
	            ...
	            if (model.f_businesstableprikeyvalue != null&& columsList.Contains("f_businesstableprikeyvalue"))
            {
                strSql.Append("f_businesstableprikeyvalue='" + (model.f_businesstableprikeyvalue) + "',");
                strSql_use.Append("f_businesstableprikeyvalue=:f_businesstableprikeyvalue,");
                parameter = new OracleParameter(":f_businesstableprikeyvalue", OracleType.VarChar);
                parameter.Value = model.f_businesstableprikeyvalue;
                parameterList.Add(parameter);
            }
            
	            if (model.f_editusername != null&& columsList.Contains("f_editusername"))
            {
                strSql.Append("f_editusername='" + (model.f_editusername) + "',");
                strSql_use.Append("f_editusername=:f_editusername,");
                parameter = new OracleParameter(":f_editusername", OracleType.VarChar);
                parameter.Value = model.f_editusername;
                parameterList.Add(parameter);
            }
            
	            if (model.f_edituserloginname != null&& columsList.Contains("f_edituserloginname"))
            {
                strSql.Append("f_edituserloginname='" + (model.f_edituserloginname) + "',");
                strSql_use.Append("f_edituserloginname=:f_edituserloginname,");
                parameter = new OracleParameter(":f_edituserloginname", OracleType.VarChar);
                parameter.Value = model.f_edituserloginname;
                parameterList.Add(parameter);
            }
            
	            if (model.f_edituserid != null&& columsList.Contains("f_edituserid"))
            {
                strSql.Append("f_edituserid='" + (model.f_edituserid) + "',");
                strSql_use.Append("f_edituserid=:f_edituserid,");
                parameter = new OracleParameter(":f_edituserid", OracleType.VarChar);
                parameter.Value = model.f_edituserid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_edituserip != null&& columsList.Contains("f_edituserip"))
            {
                strSql.Append("f_edituserip='" + (model.f_edituserip) + "',");
                strSql_use.Append("f_edituserip=:f_edituserip,");
                parameter = new OracleParameter(":f_edituserip", OracleType.VarChar);
                parameter.Value = model.f_edituserip;
                parameterList.Add(parameter);
            }
            
	            if (model.f_editusermac != null&& columsList.Contains("f_editusermac"))
            {
                strSql.Append("f_editusermac='" + (model.f_editusermac) + "',");
                strSql_use.Append("f_editusermac=:f_editusermac,");
                parameter = new OracleParameter(":f_editusermac", OracleType.VarChar);
                parameter.Value = model.f_editusermac;
                parameterList.Add(parameter);
            }
            
	            if (model.f_editdatetime != null&& columsList.Contains("f_editdatetime"))
            {
                strSql.Append("f_editdatetime=to_date('" + model.f_editdatetime.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_editdatetime=:f_editdatetime,");
                parameter = new OracleParameter(":f_editdatetime", OracleType.DateTime);
                parameter.Value = model.f_editdatetime;
                parameterList.Add(parameter);
            }
            
	            if (model.f_edittype != null&& columsList.Contains("f_edittype"))
            {
                strSql.Append("f_edittype='" + (model.f_edittype) + "',");
                strSql_use.Append("f_edittype=:f_edittype,");
                parameter = new OracleParameter(":f_edittype", OracleType.VarChar);
                parameter.Value = model.f_edittype;
                parameterList.Add(parameter);
            }
            
	            if (model.f_editsource != null&& columsList.Contains("f_editsource"))
            {
                strSql.Append("f_editsource='" + (model.f_editsource) + "',");
                strSql_use.Append("f_editsource=:f_editsource,");
                parameter = new OracleParameter(":f_editsource", OracleType.VarChar);
                parameter.Value = model.f_editsource;
                parameterList.Add(parameter);
            }
            
	            if (model.f_editcontent != null&& columsList.Contains("f_editcontent"))
            {
                strSql.Append("f_editcontent='" + (model.f_editcontent) + "',");
                strSql_use.Append("f_editcontent=:f_editcontent,");
                parameter = new OracleParameter(":f_editcontent", OracleType.Clob);
                if (model.f_editcontent == "")
                {
                    parameter.Value = " ";
                }
                else
	            ...
	            if (model.f_editcontentid != null&& columsList.Contains("f_editcontentid"))
            {
                strSql.Append("f_editcontentid='" + (model.f_editcontentid) + "',");
                strSql_use.Append("f_editcontentid=:f_editcontentid,");
                parameter = new OracleParameter(":f_editcontentid", OracleType.VarChar);
                parameter.Value = model.f_editcontentid;
                parameterList.Add(parameter);
            }
            ...
            else
            {
                ...
                OracleParameter p = null;				
									...
									if (columsList.Contains("f_editcontent"))
				{ 
				if (model.f_editcontent != null && model.f_editcontent.Length > 0)
				{
				    p = new OracleParameter(":f_editcontent", OracleType.Clob);
				...
				if (paraStrList.Count > 0)
				{
					string updateSqlString = " update tbl_ld_log set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + model.sys_id + "' ";
					if (pList.Count > 0)
					{
					   if (t == null)
					    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_ld_log> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_ld_log where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_ld_log");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_ld_log> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_ld_log t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_ld_log> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_ld_log>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_ld_log')";
            sqlString += " where f_tablename  = 'tbl_ld_log'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_ld_log'";
