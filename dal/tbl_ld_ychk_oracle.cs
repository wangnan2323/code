...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_ld_ychk 
    /// </summary>
    public class tbl_ld_ychk : sara.dd.ldsw.idal.Itbl_ld_ychk
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_ld_ychk model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_ychkpc != null)
            {
	            strSql1.Append("f_ychkpc,");
	            strSql2.Append("'" + (model.f_ychkpc) + "',");
	            strSql3.Append(":f_ychkpc,");
	            parameter = new OracleParameter(":f_ychkpc", OracleType.VarChar);
	            parameter.Value = model.f_ychkpc;
	            parameterList.Add(parameter);
            }
            
            if (model.f_cbxz != null)
            {
	            strSql1.Append("f_cbxz,");
	            strSql2.Append("'" + (model.f_cbxz) + "',");
	            strSql3.Append(":f_cbxz,");
	            parameter = new OracleParameter(":f_cbxz", OracleType.VarChar);
	            parameter.Value = model.f_cbxz;
	            parameterList.Add(parameter);
            }
            
            if (model.f_cbxzid != null)
            {
	            strSql1.Append("f_cbxzid,");
	            strSql2.Append("'" + (model.f_cbxzid) + "',");
	            strSql3.Append(":f_cbxzid,");
	            parameter = new OracleParameter(":f_cbxzid", OracleType.VarChar);
	            parameter.Value = model.f_cbxzid;
	            parameterList.Add(parameter);
            }

            if (model.f_jfly != null)
            {
                strSql1.Append("f_jfly,");
                strSql2.Append("'" + (model.f_jfly) + "',");
                strSql3.Append(":f_jfly,");
                parameter = new OracleParameter(":f_jfly", OracleType.VarChar);
                parameter.Value = model.f_jfly;
                parameterList.Add(parameter);
            }

            if (model.f_jflyid != null)
            {
                strSql1.Append("f_jflyid,");
                strSql2.Append("'" + (model.f_jflyid) + "',");
                strSql3.Append(":f_jflyid,");
                parameter = new OracleParameter(":f_jflyid", OracleType.VarChar);
                parameter.Value = model.f_jflyid;
                parameterList.Add(parameter);
            }
            ...
            if (model.f_tsjgdr != null)
            {
	            strSql1.Append("f_tsjgdr,");
	            strSql2.Append("'" + (model.f_tsjgdr) + "',");
	            strSql3.Append(":f_tsjgdr,");
	            parameter = new OracleParameter(":f_tsjgdr", OracleType.VarChar);
	            parameter.Value = model.f_tsjgdr;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_dcrid != null)
            {
	            strSql1.Append("f_dcrid,");
	            strSql2.Append("'" + (model.f_dcrid) + "',");
	            strSql3.Append(":f_dcrid,");
	            parameter = new OracleParameter(":f_dcrid", OracleType.VarChar);
	            parameter.Value = model.f_dcrid;
	            parameterList.Add(parameter);
            }
            
            if (model.f_drrid != null)
            {
	            strSql1.Append("f_drrid,");
	            strSql2.Append("'" + (model.f_drrid) + "',");
	            strSql3.Append(":f_drrid,");
	            parameter = new OracleParameter(":f_drrid", OracleType.VarChar);
	            parameter.Value = model.f_drrid;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_ld_ychk(");
            ...
            strSql_use.Append("insert into tbl_ld_ychk(");
            ...
            else
            {
	            ...
	            {
	                string updateSqlString = " update tbl_ld_ychk set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_ld_ychk> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_ld_ychk model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_ld_ychk model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_ld_ychk set ");
            strSql_use.Append("update tbl_ld_ychk set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_value10 != null&& columsList.Contains("f_value10"))
            {
	            ...
	            if (model.f_ychkpc != null&& columsList.Contains("f_ychkpc"))
            {
                strSql.Append("f_ychkpc='" + (model.f_ychkpc) + "',");
                strSql_use.Append("f_ychkpc=:f_ychkpc,");
                parameter = new OracleParameter(":f_ychkpc", OracleType.VarChar);
                parameter.Value = model.f_ychkpc;
                parameterList.Add(parameter);
            }
            
	            if (model.f_cbxz != null&& columsList.Contains("f_cbxz"))
            {
                strSql.Append("f_cbxz='" + (model.f_cbxz) + "',");
                strSql_use.Append("f_cbxz=:f_cbxz,");
                parameter = new OracleParameter(":f_cbxz", OracleType.VarChar);
                parameter.Value = model.f_cbxz;
                parameterList.Add(parameter);
            }
            
	            if (model.f_cbxzid != null&& columsList.Contains("f_cbxzid"))
            {
                strSql.Append("f_cbxzid='" + (model.f_cbxzid) + "',");
                strSql_use.Append("f_cbxzid=:f_cbxzid,");
                parameter = new OracleParameter(":f_cbxzid", OracleType.VarChar);
                parameter.Value = model.f_cbxzid;
                parameterList.Add(parameter);
            }

            if (model.f_jfly != null && columsList.Contains("f_jfly"))
            {
                strSql.Append("f_jfly='" + (model.f_jfly) + "',");
                strSql_use.Append("f_jfly=:f_jfly,");
                parameter = new OracleParameter(":f_jfly", OracleType.VarChar);
                parameter.Value = model.f_jfly;
                parameterList.Add(parameter);
            }

            if (model.f_jflyid != null && columsList.Contains("f_jflyid"))
            {
                strSql.Append("f_jflyid='" + (model.f_jflyid) + "',");
                strSql_use.Append("f_jflyid=:f_jflyid,");
                parameter = new OracleParameter(":f_jflyid", OracleType.VarChar);
                parameter.Value = model.f_jflyid;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_drsj != null&& columsList.Contains("f_drsj"))
            {
	            ...
	            if (model.f_tsjgdr != null&& columsList.Contains("f_tsjgdr"))
            {
                strSql.Append("f_tsjgdr='" + (model.f_tsjgdr) + "',");
                strSql_use.Append("f_tsjgdr=:f_tsjgdr,");
                parameter = new OracleParameter(":f_tsjgdr", OracleType.VarChar);
                parameter.Value = model.f_tsjgdr;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_ztid != null&& columsList.Contains("f_ztid"))
            {
	            ...
	            if (model.f_dcrid != null&& columsList.Contains("f_dcrid"))
            {
                strSql.Append("f_dcrid='" + (model.f_dcrid) + "',");
                strSql_use.Append("f_dcrid=:f_dcrid,");
                parameter = new OracleParameter(":f_dcrid", OracleType.VarChar);
                parameter.Value = model.f_dcrid;
                parameterList.Add(parameter);
            }
            
	            if (model.f_drrid != null&& columsList.Contains("f_drrid"))
            {
                strSql.Append("f_drrid='" + (model.f_drrid) + "',");
                strSql_use.Append("f_drrid=:f_drrid,");
                parameter = new OracleParameter(":f_drrid", OracleType.VarChar);
                parameter.Value = model.f_drrid;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_ld_ychk> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_ld_ychk where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_ld_ychk");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_ld_ychk> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_ld_ychk t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_ld_ychk> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_ld_ychk>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_ld_ychk')";
            sqlString += " where f_tablename  = 'tbl_ld_ychk'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_ld_ychk'";
