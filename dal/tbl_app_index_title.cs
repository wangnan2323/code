...
{
    /// <summary>
    /// 数据访问类tbl_app_index_title 
    /// </summary>
    public class tbl_app_index_title : sara.dd.ldsw.idal.Itbl_app_index_title
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_app_index_title model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.fk_tbl_app_index_sys_id != null)
            {
	            strSql1.Append("fk_tbl_app_index_sys_id,");
	            strSql2.Append("'" + (model.fk_tbl_app_index_sys_id) + "',");
	            strSql3.Append(":fk_tbl_app_index_sys_id,");
	            parameter = new OracleParameter(":fk_tbl_app_index_sys_id", OracleType.VarChar);
	            parameter.Value = model.fk_tbl_app_index_sys_id;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_app_index_title(");
            ...
            strSql_use.Append("insert into tbl_app_index_title(");
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_app_index_title> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_app_index_title model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_app_index_title model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_app_index_title set ");
            strSql_use.Append("update tbl_app_index_title set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_value10 != null&& columsList.Contains("f_value10"))
            {
	            ...
	            if (model.fk_tbl_app_index_sys_id != null&& columsList.Contains("fk_tbl_app_index_sys_id"))
            {
                strSql.Append("fk_tbl_app_index_sys_id='" + (model.fk_tbl_app_index_sys_id) + "',");
                strSql_use.Append("fk_tbl_app_index_sys_id=:fk_tbl_app_index_sys_id,");
                parameter = new OracleParameter(":fk_tbl_app_index_sys_id", OracleType.VarChar);
                parameter.Value = model.fk_tbl_app_index_sys_id;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_app_index_title> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_app_index_title where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_app_index_title");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_app_index_title> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_app_index_title t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_app_index_title> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_app_index_title>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
...
public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_app_index_title')";
            sqlString += " where f_tablename  = 'tbl_app_index_title'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_app_index_title'";
