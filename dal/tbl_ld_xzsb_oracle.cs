...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_ld_xzsb 
    /// </summary>
    public class tbl_ld_xzsb : sara.dd.ldsw.idal.Itbl_ld_xzsb
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_ld_xzsb model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_xzsbbh != null)
            {
	            strSql1.Append("f_xzsbbh,");
	            strSql2.Append("'" + (model.f_xzsbbh) + "',");
	            strSql3.Append(":f_xzsbbh,");
	            parameter = new OracleParameter(":f_xzsbbh", OracleType.VarChar);
	            parameter.Value = model.f_xzsbbh;
	            parameterList.Add(parameter);
            }
            
            if (model.f_xzsbmc != null)
            {
	            strSql1.Append("f_xzsbmc,");
	            strSql2.Append("'" + (model.f_xzsbmc) + "',");
	            strSql3.Append(":f_xzsbmc,");
	            parameter = new OracleParameter(":f_xzsbmc", OracleType.VarChar);
	            parameter.Value = model.f_xzsbmc;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_khjbxx != null)
            {
	            strSql1.Append("f_khjbxx,");
	            strSql2.Append("'" + (model.f_khjbxx) + "',");
	            strSql3.Append(":f_khjbxx,");
	            parameter = new OracleParameter(":f_khjbxx", OracleType.VarChar);
	            parameter.Value = model.f_khjbxx;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_ld_xzsb(");
            ...
            strSql_use.Append("insert into tbl_ld_xzsb(");
            ...
            else
            {
	            ...
	            {
	                string updateSqlString = " update tbl_ld_xzsb set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_ld_xzsb> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_ld_xzsb model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_ld_xzsb model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_ld_xzsb set ");
            strSql_use.Append("update tbl_ld_xzsb set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_value10 != null&& columsList.Contains("f_value10"))
            {
	            ...
	            if (model.f_xzsbbh != null&& columsList.Contains("f_xzsbbh"))
            {
                strSql.Append("f_xzsbbh='" + (model.f_xzsbbh) + "',");
                strSql_use.Append("f_xzsbbh=:f_xzsbbh,");
                parameter = new OracleParameter(":f_xzsbbh", OracleType.VarChar);
                parameter.Value = model.f_xzsbbh;
                parameterList.Add(parameter);
            }
            
	            if (model.f_xzsbmc != null&& columsList.Contains("f_xzsbmc"))
            {
                strSql.Append("f_xzsbmc='" + (model.f_xzsbmc) + "',");
                strSql_use.Append("f_xzsbmc=:f_xzsbmc,");
                parameter = new OracleParameter(":f_xzsbmc", OracleType.VarChar);
                parameter.Value = model.f_xzsbmc;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_khbhid != null&& columsList.Contains("f_khbhid"))
            {
	            ...
	            if (model.f_khjbxx != null&& columsList.Contains("f_khjbxx"))
            {
                strSql.Append("f_khjbxx='" + (model.f_khjbxx) + "',");
                strSql_use.Append("f_khjbxx=:f_khjbxx,");
                parameter = new OracleParameter(":f_khjbxx", OracleType.VarChar);
                parameter.Value = model.f_khjbxx;
                parameterList.Add(parameter);
            }
            ...
            else
            {
				...
				if (paraStrList.Count > 0)
				{
					string updateSqlString = " update tbl_ld_xzsb set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + model.sys_id + "' ";
					if (pList.Count > 0)
					{
					   if (t == null)
					    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_ld_xzsb> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_ld_xzsb where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_ld_xzsb");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_ld_xzsb> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_ld_xzsb t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_ld_xzsb> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_ld_xzsb>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
