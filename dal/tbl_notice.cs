...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_notice 
    /// </summary>
    public class tbl_notice : sara.dd.ldsw.idal.Itbl_notice
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_notice model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_startdate != null)
            {
	            strSql1.Append("f_startdate,");
	            strSql2.Append("to_date('" + model.f_startdate.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
	            strSql3.Append(":f_startdate,");
	            parameter = new OracleParameter(":f_startdate", OracleType.DateTime);
	            parameter.Value = model.f_startdate;
	            parameterList.Add(parameter);
            }
            
            if (model.f_edndate != null)
            {
	            strSql1.Append("f_edndate,");
	            strSql2.Append("to_date('" + model.f_edndate.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
	            strSql3.Append(":f_edndate,");
	            parameter = new OracleParameter(":f_edndate", OracleType.DateTime);
	            parameter.Value = model.f_edndate;
	            parameterList.Add(parameter);
            }
            
            if (model.f_group != null)
            {
	            strSql1.Append("f_group,");
	            strSql2.Append("'" + (model.f_group) + "',");
	            strSql3.Append(":f_group,");
	            parameter = new OracleParameter(":f_group", OracleType.VarChar);
	            parameter.Value = model.f_group;
	            parameterList.Add(parameter);
            }
            
            if (model.f_groupid != null)
            {
	            strSql1.Append("f_groupid,");
	            strSql2.Append("'" + (model.f_groupid) + "',");
	            strSql3.Append(":f_groupid,");
	            parameter = new OracleParameter(":f_groupid", OracleType.VarChar);
	            parameter.Value = model.f_groupid;
	            parameterList.Add(parameter);
            }
            ...
            strSql_use.Append("insert into tbl_notice(");
            ...
            else
            {
	            ...
	            {
	                string updateSqlString = " update tbl_notice set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_notice> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_notice model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_notice model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            strSql_use.Append("update tbl_notice set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_file != null&& columsList.Contains("f_file"))
            {
	            ...
	            if (model.f_startdate != null&& columsList.Contains("f_startdate"))
            {
                strSql.Append("f_startdate=to_date('" + model.f_startdate.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_startdate=:f_startdate,");
                parameter = new OracleParameter(":f_startdate", OracleType.DateTime);
                parameter.Value = model.f_startdate;
                parameterList.Add(parameter);
            }
            
	            if (model.f_edndate != null&& columsList.Contains("f_edndate"))
            {
                strSql.Append("f_edndate=to_date('" + model.f_edndate.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_edndate=:f_edndate,");
                parameter = new OracleParameter(":f_edndate", OracleType.DateTime);
                parameter.Value = model.f_edndate;
                parameterList.Add(parameter);
            }
            
	            if (model.f_group != null&& columsList.Contains("f_group"))
            {
                strSql.Append("f_group='" + (model.f_group) + "',");
                strSql_use.Append("f_group=:f_group,");
                parameter = new OracleParameter(":f_group", OracleType.VarChar);
                parameter.Value = model.f_group;
                parameterList.Add(parameter);
            }
            
	            if (model.f_groupid != null&& columsList.Contains("f_groupid"))
            {
                strSql.Append("f_groupid='" + (model.f_groupid) + "',");
                strSql_use.Append("f_groupid=:f_groupid,");
                parameter = new OracleParameter(":f_groupid", OracleType.VarChar);
                parameter.Value = model.f_groupid;
                parameterList.Add(parameter);
            }
            ...
            else
            {
				...
				if (paraStrList.Count > 0)
				{
					string updateSqlString = " update tbl_notice set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + model.sys_id + "' ";
					if (pList.Count > 0)
					{
					   if (t == null)
					    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_notice> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_notice where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_notice");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_notice> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_notice t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_notice> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_notice>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_notice')";
            sqlString += " where f_tablename  = 'tbl_notice'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_notice'";
