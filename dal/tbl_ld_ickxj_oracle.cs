...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_ld_ickxj 
    /// </summary>
    public class tbl_ld_ickxj : sara.dd.ldsw.idal.Itbl_ld_ickxj
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_ld_ickxj model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_khrq != null)
            {
	            ...
	            strSql2.Append("'" + (model.f_khrq) + "',");
	            strSql3.Append(":f_khrq,");
	            parameter = new OracleParameter(":f_khrq", OracleType.VarChar);
            ...
            if (model.f_ickxjbh != null)
            {
	            strSql1.Append("f_ickxjbh,");
	            strSql2.Append("'" + (model.f_ickxjbh) + "',");
	            strSql3.Append(":f_ickxjbh,");
	            parameter = new OracleParameter(":f_ickxjbh", OracleType.VarChar);
	            parameter.Value = model.f_ickxjbh;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_czlx != null)
            {
	            strSql1.Append("f_czlx,");
	            strSql2.Append("'" + (model.f_czlx) + "',");
	            strSql3.Append(":f_czlx,");
	            parameter = new OracleParameter(":f_czlx", OracleType.VarChar);
	            parameter.Value = model.f_czlx;
	            parameterList.Add(parameter);
            }
            
            if (model.f_czlxid != null)
            {
	            strSql1.Append("f_czlxid,");
	            strSql2.Append("'" + (model.f_czlxid) + "',");
	            strSql3.Append(":f_czlxid,");
	            parameter = new OracleParameter(":f_czlxid", OracleType.VarChar);
	            parameter.Value = model.f_czlxid;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_xkjz != null)
            {
	            strSql1.Append("f_xkjz,");
	            strSql2.Append("'" + (model.f_xkjz) + "',");
	            strSql3.Append(":f_xkjz,");
	            parameter = new OracleParameter(":f_xkjz", OracleType.VarChar);
	            parameter.Value = model.f_xkjz;
	            parameterList.Add(parameter);
            }
            ...
            if (model.f_zkr != null)
            {
	            strSql1.Append("f_zkr,");
	            strSql2.Append("'" + (model.f_zkr) + "',");
	            strSql3.Append(":f_zkr,");
	            parameter = new OracleParameter(":f_zkr", OracleType.VarChar);
	            parameter.Value = model.f_zkr;
	            parameterList.Add(parameter);
            }

            if (model.f_zkrid != null)
            {
                strSql1.Append("f_zkrid,");
                strSql2.Append("'" + (model.f_zkrid) + "',");
                strSql3.Append(":f_zkrid,");
                parameter = new OracleParameter(":f_zkrid", OracleType.VarChar);
                parameter.Value = model.f_zkrid;
                parameterList.Add(parameter);
            }

            if (model.f_zkrq != null)
            {
	            strSql1.Append("f_zkrq,");
	            strSql2.Append("to_date('" + model.f_zkrq.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
	            strSql3.Append(":f_zkrq,");
	            parameter = new OracleParameter(":f_zkrq", OracleType.DateTime);
	            parameter.Value = model.f_zkrq;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_ld_ickxj(");
            ...
            strSql_use.Append("insert into tbl_ld_ickxj(");
            ...
            else
            {
	            ...
	            {
	                string updateSqlString = " update tbl_ld_ickxj set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_ld_ickxj> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_ld_ickxj model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_ld_ickxj model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_ld_ickxj set ");
            strSql_use.Append("update tbl_ld_ickxj set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            ...
            {
                strSql.Append("f_khrq='" + (model.f_khrq) + "',");
	            ...
	            if (model.f_rs != null&& columsList.Contains("f_rs"))
            {
	            ...
	            if (model.f_ickxjbh != null&& columsList.Contains("f_ickxjbh"))
            {
                strSql.Append("f_ickxjbh='" + (model.f_ickxjbh) + "',");
                strSql_use.Append("f_ickxjbh=:f_ickxjbh,");
                parameter = new OracleParameter(":f_ickxjbh", OracleType.VarChar);
                parameter.Value = model.f_ickxjbh;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_lxtkhh != null&& columsList.Contains("f_lxtkhh"))
            {
	            ...
	            if (model.f_czlx != null&& columsList.Contains("f_czlx"))
            {
                strSql.Append("f_czlx='" + (model.f_czlx) + "',");
                strSql_use.Append("f_czlx=:f_czlx,");
                parameter = new OracleParameter(":f_czlx", OracleType.VarChar);
                parameter.Value = model.f_czlx;
                parameterList.Add(parameter);
            }
            
	            if (model.f_czlxid != null&& columsList.Contains("f_czlxid"))
            {
                strSql.Append("f_czlxid='" + (model.f_czlxid) + "',");
                strSql_use.Append("f_czlxid=:f_czlxid,");
                parameter = new OracleParameter(":f_czlxid", OracleType.VarChar);
                parameter.Value = model.f_czlxid;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_xkljgl != null&& columsList.Contains("f_xkljgl"))
            {
	            ...
	            if (model.f_xkjz != null&& columsList.Contains("f_xkjz"))
            {
                strSql.Append("f_xkjz='" + (model.f_xkjz) + "',");
                strSql_use.Append("f_xkjz=:f_xkjz,");
                parameter = new OracleParameter(":f_xkjz", OracleType.VarChar);
                parameter.Value = model.f_xkjz;
                parameterList.Add(parameter);
            }
	            ...
	            if (model.f_ztid != null&& columsList.Contains("f_ztid"))
            {
	            ...
	            if (model.f_zkr != null&& columsList.Contains("f_zkr"))
            {
                strSql.Append("f_zkr='" + (model.f_zkr) + "',");
                strSql_use.Append("f_zkr=:f_zkr,");
                parameter = new OracleParameter(":f_zkr", OracleType.VarChar);
                parameter.Value = model.f_zkr;
                parameterList.Add(parameter);
            }

            if (model.f_zkrid != null && columsList.Contains("f_zkrid"))
            {
                strSql.Append("f_zkrid='" + (model.f_zkrid) + "',");
                strSql_use.Append("f_zkrid=:f_zkrid,");
                parameter = new OracleParameter(":f_zkrid", OracleType.VarChar);
                parameter.Value = model.f_zkrid;
                parameterList.Add(parameter);
            }

            if (model.f_zkrq != null&& columsList.Contains("f_zkrq"))
            {
                strSql.Append("f_zkrq=to_date('" + model.f_zkrq.ToString("yyyy-MM-dd HH:mm:ss") + "','yyyy-MM-dd hh24:mi:ss'),");
                strSql_use.Append("f_zkrq=:f_zkrq,");
                parameter = new OracleParameter(":f_zkrq", OracleType.DateTime);
                parameter.Value = model.f_zkrq;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_ld_ickxj> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_ld_ickxj where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_ld_ickxj");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_ld_ickxj> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_ld_ickxj t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_ld_ickxj> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_ld_ickxj>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
