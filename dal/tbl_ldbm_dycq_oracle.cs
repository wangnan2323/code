...
namespace sara.dd.ldsw.dal
{
    ...
    /// 数据访问类tbl_ldbm_dycq 
    /// </summary>
    public class tbl_ldbm_dycq : sara.dd.ldsw.idal.Itbl_ldbm_dycq
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_ldbm_dycq model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            {
	            strSql1.Append("f_ms,");
	            strSql2.Append("'" + (model.f_ms) + "',");
	            strSql3.Append(":f_ms,");
	            parameter = new OracleParameter(":f_ms", OracleType.VarChar);
	            parameter.Value = model.f_ms;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_ldbm_dycq(");
            ...
            strSql_use.Append("insert into tbl_ldbm_dycq(");
            ...
            else
            {
	            ...
	            {
	                string updateSqlString = " update tbl_ldbm_dycq set " + string.Join(" , ", paraStrList.ToArray()) + " where sys_id = '" + sid + "' ";
	                if (pList.Count > 0)
	                {
	                    if (t == null)
	                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_ldbm_dycq> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_ldbm_dycq model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_ldbm_dycq model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_ldbm_dycq set ");
            strSql_use.Append("update tbl_ldbm_dycq set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.f_mc != null&& columsList.Contains("f_mc"))
            {
	            ...
	            if (model.f_ms != null&& columsList.Contains("f_ms"))
            {
                strSql.Append("f_ms='" + (model.f_ms) + "',");
                strSql_use.Append("f_ms=:f_ms,");
                parameter = new OracleParameter(":f_ms", OracleType.VarChar);
                parameter.Value = model.f_ms;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_ldbm_dycq> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_ldbm_dycq where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_ldbm_dycq");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_ldbm_dycq> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_ldbm_dycq t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_ldbm_dycq> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_ldbm_dycq>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_ldbm_dycq')";
            sqlString += " where f_tablename  = 'tbl_ldbm_dycq'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_ldbm_dycq'";
