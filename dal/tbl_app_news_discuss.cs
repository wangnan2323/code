...
{
    /// <summary>
    /// 数据访问类tbl_app_news_discuss 
    /// </summary>
    public class tbl_app_news_discuss : sara.dd.ldsw.idal.Itbl_app_news_discuss
    {
        ...
        /// <returns></returns>
        public string Add(sara.dd.ldsw.model.tbl_app_news_discuss model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (model.f_discusscontent != null)
            {
	            strSql1.Append("f_discusscontent,");
	            strSql2.Append("'" + (model.f_discusscontent) + "',");
	            strSql3.Append(":f_discusscontent,");
	            parameter = new OracleParameter(":f_discusscontent", OracleType.VarChar);
	            parameter.Value = model.f_discusscontent;
	            parameterList.Add(parameter);
            }
            
            if (model.f_nodeid != null)
            {
	            strSql1.Append("f_nodeid,");
	            strSql2.Append("'" + (model.f_nodeid) + "',");
	            strSql3.Append(":f_nodeid,");
	            parameter = new OracleParameter(":f_nodeid", OracleType.VarChar);
	            parameter.Value = model.f_nodeid;
	            parameterList.Add(parameter);
            }
            ...
            strSql.Append("insert into tbl_app_news_discuss(");
            ...
            strSql_use.Append("insert into tbl_app_news_discuss(");
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string AddList(List<sara.dd.ldsw.model.tbl_app_news_discuss> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            try
            {
               if (t == null)
                ...
                foreach (sara.dd.ldsw.model.tbl_app_news_discuss model in modelList)
                {
                   if (t == null)
                    {
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string Update(sara.dd.ldsw.model.tbl_app_news_discuss model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql_use = new StringBuilder();
            strSql.Append("update tbl_app_news_discuss set ");
            strSql_use.Append("update tbl_app_news_discuss set ");
            if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
	            ...
	            if (model.fk_tbl_app_news_sys_id != null&& columsList.Contains("fk_tbl_app_news_sys_id"))
            {
	            ...
	            if (model.f_discusscontent != null&& columsList.Contains("f_discusscontent"))
            {
                strSql.Append("f_discusscontent='" + (model.f_discusscontent) + "',");
                strSql_use.Append("f_discusscontent=:f_discusscontent,");
                parameter = new OracleParameter(":f_discusscontent", OracleType.VarChar);
                parameter.Value = model.f_discusscontent;
                parameterList.Add(parameter);
            }
            
	            if (model.f_nodeid != null&& columsList.Contains("f_nodeid"))
            {
                strSql.Append("f_nodeid='" + (model.f_nodeid) + "',");
                strSql_use.Append("f_nodeid=:f_nodeid,");
                parameter = new OracleParameter(":f_nodeid", OracleType.VarChar);
                parameter.Value = model.f_nodeid;
                parameterList.Add(parameter);
            }
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        public string UpdateList(List<sara.dd.ldsw.model.tbl_app_news_discuss> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            int column = 0;
            try
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete tbl_app_news_discuss where  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(*) from tbl_app_news_discuss");
            if (whereString.Trim() != "")
            {
                strSql.Append(" where " + whereString);
            }
        ...
        /// <returns></returns>
        public List<sara.dd.ldsw.model.tbl_app_news_discuss> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            StringBuilder strSql = new StringBuilder();

            strSql.Append(" select " + columnsString + " from (");
            strSql.Append(" select rownum rn,a.* from (");
            strSql.Append(" select * from tbl_app_news_discuss t where");
            if (whereString.Trim() == "")
            {
                strSql.Append(" 1=1 ");
            }
            ...
            List<sara.dd.ldsw.model.tbl_app_news_discuss> modelList = Eva.Library.Format.FormatEntityTool.FormatDataTableToModelList<sara.dd.ldsw.model.tbl_app_news_discuss>(resultDataTable);
			if (Eva.Library.Configuration.ConfigurationManager.AppSettings["SqlEditMode"].ToString() == "parameter")
            {
            }
            else //如果是sql形式的话，则进行textReturn
        ...
        public string GetMaxId(Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            sqlString += " (select to_number(f_tablesys_id)+1 from tbl_num where f_tablename  = 'tbl_app_news_discuss')";
            sqlString += " where f_tablename  = 'tbl_app_news_discuss'";
            ...
            sqlString = "select f_tablesys_id from tbl_num where f_tablename  = 'tbl_app_news_discuss'";
