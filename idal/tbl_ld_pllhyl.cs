...
{
    /// <summary>
    /// 接口层Itbl_ld_pllhyl 的摘要说明。
    /// </summary>
    public interface Itbl_ld_pllhyl
    {
        #region  成员方法
        /// <summary>
        /// 重写添加shape
        ...
        /// <returns></returns>
        string Add(sara.dd.ldsw.model.tbl_ld_pllhyl model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        string AddList(List<sara.dd.ldsw.model.tbl_ld_pllhyl> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        string Update(sara.dd.ldsw.model.tbl_ld_pllhyl model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        string UpdateList(List<sara.dd.ldsw.model.tbl_ld_pllhyl> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
        ...
        /// <returns></returns>
        List<sara.dd.ldsw.model.tbl_ld_pllhyl> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
