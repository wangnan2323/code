...
{
    /// <summary>
    /// 接口层Itbl_ldbm_khfz 的摘要说明。
    /// </summary>
    public interface Itbl_ldbm_khfz
    {
        #region  成员方法
        /// <summary>
        /// 重写添加shape
        ...
        /// <returns></returns>
        string Add(sara.dd.ldsw.model.tbl_ldbm_khfz model, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        string AddList(List<sara.dd.ldsw.model.tbl_ldbm_khfz> modelList, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        string Update(sara.dd.ldsw.model.tbl_ldbm_khfz model, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
        ...
        /// <param name="clientInf"></param>
        /// <returns></returns>
        string UpdateList(List<sara.dd.ldsw.model.tbl_ldbm_khfz> modelList, string columns, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
        ...
        /// <returns></returns>
        List<sara.dd.ldsw.model.tbl_ldbm_khfz> GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t);
