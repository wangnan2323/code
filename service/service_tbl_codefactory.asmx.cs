...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_codefactory : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_codefactory _idal_tbl_codefactory = new sara.dd.ldsw.dal.tbl_codefactory();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_codefactory model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_codefactory>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_codefactory.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_codefactory> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_codefactory>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_codefactory.AddList(modellist, null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_codefactory.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                columns = FormatColumns(columns).Replace("^", ",");
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_codefactory.UpdateList(modellist, columns, null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_codefactory.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_codefactory.LogicDelete(delUserId, delUserName, delDate, whereString, null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_codefactory.GetCount(whereString, null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_codefactory.GetDataTableForPC(whereString, orderByString, columnsString, pageSizeString, pageIndexString, null));

                string message = "{\"total\":\"" + _idal_tbl_codefactory.GetCount(whereString, null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_codefactory.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
        ...
        private string FormatColumns(string columns)
        {
            if (columns == "")
            {
                ...
                columns += "^" + "f_singledropdownlist";

                columns += "^" + "f_singledropdownlistid";

                columns += "^" + "f_multidropdownlist";

                columns += "^" + "f_multidropdownlistid";

                columns += "^" + "f_itemlist";

                columns += "^" + "f_itemlistid";

                columns += "^" + "f_toggle";

                columns += "^" + "f_checklist";

                columns += "^" + "f_checklistid";

                columns += "^" + "f_radiolist";

                columns += "^" + "f_radiolistid";
