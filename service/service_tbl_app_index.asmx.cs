...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_app_index : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_app_index _idal_tbl_app_index = new sara.dd.ldsw.dal.tbl_app_index();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_app_index model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_app_index>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_index.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_app_index> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_app_index>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_index.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_index.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_app_index.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_index.Delete(whereString,null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_index.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_index.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_app_index>(_idal_tbl_app_index.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_app_index.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_app_index.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
        ...
        public string GetTags(string clientInf)
        {
            ...
            try
            {
                ...
                string re = _iAccessData.GetSingle("select wm_concat(replace(f_tag,' ',',')) from tbl_app_index ").ToString();
        ...
        public string CheckResource(string sysIdString, string clientInf)
        {
            ...
            try
            {
                ...
                sqlString += " (";
                sqlString += " select f_titleresource from tbl_app_index where sys_id = '" + sysIdString + "'";
                sqlString += " )";
