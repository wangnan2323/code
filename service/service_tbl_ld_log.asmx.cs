...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_ld_log : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_ld_log _idal_tbl_ld_log = new sara.dd.ldsw.dal.tbl_ld_log();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                ...
                sara.dd.ldsw.model.tbl_ld_log model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_ld_log>(json);

                model.sys_creatdate = DateTime.Now;
                model.sys_lasteditdate = DateTime.Now;
                
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_log.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ld_log> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ld_log>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_log.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_log.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_ld_log.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {    
                ...
                columnsString += "f_editcontentid,";
                
                columnsString = columnsString.TrimEnd(',');
                List <sara.dd.ldsw.model.tbl_ld_log> l_tbl_ld_log = _idal_tbl_ld_log.GetList(whereString, "", columnsString, "", "", null);
                foreach (sara.dd.ldsw.model.tbl_ld_log model in l_tbl_ld_log)
                {
                    
                    fileIDs += model.f_editcontentid + ",";
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_log.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_log.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_log.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ld_log>(_idal_tbl_ld_log.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_ld_log.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ld_log.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
        ...
        private string FormatColumns(string columns)
        {
            ...
            {   
				...
				columns += "^" + "f_businesstableprikeyvalue";
                		
				columns += "^" + "f_editusername";
                		
				columns += "^" + "f_edituserloginname";
                		
				columns += "^" + "f_edituserid";
                		
				columns += "^" + "f_edituserip";
                		
				columns += "^" + "f_editusermac";
                		
				columns += "^" + "f_editdatetime";
                		
				columns += "^" + "f_edittype";
                		
				columns += "^" + "f_editsource";
                		
				columns += "^" + "f_editcontent";
                		
				columns += "^" + "f_editcontentid";
