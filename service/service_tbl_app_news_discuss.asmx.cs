...
{
    /// <summary>
    /// Service_tbl_app_news_discuss 的摘要说明
    /// </summary>
    ...
    public class service_tbl_app_news_discuss : System.Web.Services.WebService
    {
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_app_news_discuss model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_app_news_discuss>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_discuss.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_app_news_discuss> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_app_news_discuss>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_discuss.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_discuss.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_app_news_discuss.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {
                //级联删除评论的赞
                sara.dd.ldsw.idal.Itbl_app_news_like idal_tbl_app_news_like = new sara.dd.ldsw.dal.tbl_app_news_like();
                idal_tbl_app_news_like.Delete("fk_tbl_app_news_discuss_sys_id in (select sys_id from tbl_app_news_discuss where "+whereString+")", null);

                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_discuss.Delete(whereString,null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_discuss.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_discuss.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_app_news_discuss>(_idal_tbl_app_news_discuss.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);
