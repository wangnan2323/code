...
{
    /// <summary>
    /// Service_tbl_app_codefactory 的摘要说明
    /// </summary>
    ...
    public class service_tbl_app_codefactory : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_app_codefactory _idal_tbl_app_codefactory = new sara.dd.ldsw.dal.tbl_app_codefactory();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_app_codefactory model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_app_codefactory>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_codefactory.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_app_codefactory> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_app_codefactory>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_codefactory.AddList(modellist, null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_codefactory.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                columns = FormatColumns(columns).Replace("^", ",");
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_codefactory.UpdateList(modellist, columns, null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_codefactory.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_codefactory.LogicDelete(delUserId, delUserName, delDate, whereString, null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_codefactory.GetCount(whereString, null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_app_codefactory>(_idal_tbl_app_codefactory.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString, null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_app_codefactory.GetCount(whereString, null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_app_codefactory.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
        ...
        private string FormatColumns(string columns)
                {
                    ...
                    {   
				        ...
				        columns += "^" + "f_textbutton";
                        		
				        columns += "^" + "f_date";
                        		
				        columns += "^" + "f_time";
                        		
				        columns += "^" + "f_autocomplete";
				        ...
				        columns += "^" + "f_buttonlist_single";
                        		
				        columns += "^" + "f_buttonlist_singleid";
                        		
				        columns += "^" + "f_buttonlist_multi";
                        		
				        columns += "^" + "f_buttonlist_multiid";
                        		
				        columns += "^" + "f_itemlist_single";
                        		
				        columns += "^" + "f_itemlist_singleid";
                        		
				        columns += "^" + "f_itemlist_multi";
                        		
				        columns += "^" + "f_itemlist_multiid";
                        		
				        columns += "^" + "f_poplist_single";
                        		
				        columns += "^" + "f_poplist_singleid";
                        		
				        columns += "^" + "f_poplist_multi";
                        		
				        columns += "^" + "f_poplist_multiid";
