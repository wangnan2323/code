...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_ld_sbbj : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_ld_sbbj _idal_tbl_ld_sbbj = new sara.dd.ldsw.dal.tbl_ld_sbbj();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_ld_sbbj model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_ld_sbbj>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_sbbj.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ld_sbbj> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ld_sbbj>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_sbbj.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_sbbj.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_ld_sbbj.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {    
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_sbbj.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_sbbj.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_sbbj.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ld_sbbj>(_idal_tbl_ld_sbbj.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_ld_sbbj.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ld_sbbj.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
        ...
        /// 
        /// </summary>
        /// <param name="jsontable">报警信息jsondt</param>
        ...
        public string meterAlert(string jsontable)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (dr["f_sbbh"].ToString() != null && dr["f_sbbh"].ToString() != "")
                    {
                        ...
                        if(sbmodellist.Count == 1)
                        {
                            ...
                            model.sys_creatusername = "超级管理员";
                            model.sys_creatdate = currentTime;
                            model.sys_lastedituserid = "74";
                            model.sys_lasteditusername = "超级管理员";
                ...
                if (int.Parse(count) > 0)
                {
                    ...
                    noticemodel.sys_creatusername = "超级管理员";
                    noticemodel.sys_creatdate = currentTime;
                    noticemodel.sys_lastedituserid = "74";
                    noticemodel.sys_lasteditusername = "超级管理员";
