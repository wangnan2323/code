...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_ldbm_sbfz : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_ldbm_sbfz _idal_tbl_ldbm_sbfz = new sara.dd.ldsw.dal.tbl_ldbm_sbfz();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_ldbm_sbfz model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_ldbm_sbfz>(json);
                model.sys_creatdate = DateTime.Now;
                model.sys_lasteditdate = DateTime.Now;
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_sbfz.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ldbm_sbfz> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ldbm_sbfz>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_sbfz.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_sbfz.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_ldbm_sbfz.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {    
                ...
                string sql = "select count(*) from tbl_ld_sbb where f_sbfzid in (select sys_id from tbl_ldbm_sbfz where " + whereString + ")";
////                _iAccessData.ExecuteSql update,insert,delete
//                //_iAccessData.Query,select 
//                DataSet ds = _iAccessData.Query("select * from tbl_ld_sbb");

//                for (int i = 0; i < ds.Tables[0].Rows.Count;i++ )
//                {
//                    ds.Tables[0].Rows[i]["sys_id"].ToString();

//                    DataRow[] drs = ds.Tables[0].Select(" sys_id in  ('1000','1002')");
//                    for (int ii = 0; ii < drs.Length; ii++)
//                    {
//                        drs[ii]["sys_id"].ToString();
//                    }
//                }
...
//                    //不能删除
                ...
                {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_sbfz.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_sbfz.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_sbfz.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ldbm_sbfz>(_idal_tbl_ldbm_sbfz.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_ldbm_sbfz.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ldbm_sbfz.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
