...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_ld_xhhbt : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_ld_xhhbt _idal_tbl_ld_xhhbt = new sara.dd.ldsw.dal.tbl_ld_xhhbt();
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ld_xhhbt> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ld_xhhbt>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_xhhbt.AddList(modellist,null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_ld_xhhbt.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {    
                ...
                List <sara.dd.ldsw.model.tbl_ld_xhhbt> l_tbl_ld_xhhbt = _idal_tbl_ld_xhhbt.GetList(whereString, "", columnsString, "", "", null);
                ...
                string sqlString = "";              
                 ...
                 sqlString = "delete from tbl_ld_xhhbtzb where fk_tbl_ld_xhhbt_sys_id in (select sys_id from tbl_ld_xhhbt where " + whereString + ")";
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_xhhbt.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_xhhbt.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_xhhbt.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ld_xhhbt>(_idal_tbl_ld_xhhbt.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_ld_xhhbt.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ld_xhhbt.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
