...
namespace sara.dd.ldsw.service
{
    ...
    public class service_t_projstate_log : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.It_projstate_log _idal_t_projstate_log = commonclass.dalfactory.Create<sara.dd.ldsw.idal.It_projstate_log>();//new sara.dd.ldsw.dal.t_projstate_log();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.t_projstate_log model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.t_projstate_log>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_t_projstate_log.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.t_projstate_log> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.t_projstate_log>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_t_projstate_log.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_t_projstate_log.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                columns = FormatColumns(columns).Replace("^", ",");
                resultDic["result"] = "true";
                resultDic["message"] = _idal_t_projstate_log.UpdateList(modellist, columns, null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_t_projstate_log.Delete(whereString,null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_t_projstate_log.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_t_projstate_log.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.t_projstate_log>(_idal_t_projstate_log.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_t_projstate_log.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        private string FormatColumns(string columns)
        {
            if (columns == "")
            {
                ...
                columns += "^" + "processsinsid";

                columns += "^" + "processdefid";
