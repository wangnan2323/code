...
{
    /// <summary>
    /// Service_tbl_app_version_color 的摘要说明
    /// </summary>
    ...
    public class service_tbl_app_version_color : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_app_version_color _idal_tbl_app_version_color = new sara.dd.ldsw.dal.tbl_app_version_color();
        private Eva.Library.Data.AccessData.IAccessData _iAccessData;
        public service_tbl_app_version_color()
        {
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_app_version_color model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_app_version_color>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_version_color.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_app_version_color> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_app_version_color>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_version_color.AddList(modellist, null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_version_color.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                columns = FormatColumns(columns).Replace("^", ",");
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_version_color.UpdateList(modellist, columns, null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_version_color.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_version_color.LogicDelete(delUserId, delUserName, delDate, whereString, null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_version_color.GetCount(whereString, null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_app_version_color>(_idal_tbl_app_version_color.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString, null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_app_version_color.GetCount(whereString, null) + "\",\"rows\":" + rows + "}";
        ...
        private string FormatColumns(string columns)
        {
            if (columns == "")
            {
                ...
                columns += "^" + "f_resourcename";

                columns += "^" + "f_resourcekey";

                columns += "^" + "f_resourcevalue";
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string Export(string f_resourcename, string clientInf)
        {
            Dictionary<string, string> resultDic = new Dictionary<string, string>();
            resultDic["result"] = "";
            resultDic["message"] = "";
            string sqlstr = "select f_resourcekey,f_resourcevalue from tbl_app_version_color where f_resourcename='" + f_resourcename + "' order by f_resourcekey";
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    result.Append("<key>" + dt.Rows[i][0].ToString() + "</key>" + System.Environment.NewLine + "<string>" + dt.Rows[i][1].ToString() + "</string>" + System.Environment.NewLine);
                }
                result.Append("</dict>" + System.Environment.NewLine + "</plist>");
                result.Replace('#', '"');

                string downloadPath = Eva.Library.Format.FormatTextTool.GetMapPath((Eva.Library.Configuration.ConfigurationManager.AppSettings["AppResourceRootPath"] + "color/" + f_resourcename + ".plist"), HttpContext.Current.Server);
                sara.dd.ldsw.commonclass.FileOperation.writeFile(downloadPath, result.ToString());

                resultDic["message"] = Eva.Library.Configuration.ConfigurationManager.AppSettings["AppResourceRootPath"] + "color/" + f_resourcename + ".plist";
                resultDic["result"] = "true";
            }
            catch (Exception ex)
            {
