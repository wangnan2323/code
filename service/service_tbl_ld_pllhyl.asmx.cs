...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_ld_pllhyl : System.Web.Services.WebService
    {
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_ld_pllhyl model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_ld_pllhyl>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_pllhyl.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ld_pllhyl> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ld_pllhyl>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_pllhyl.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_pllhyl.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_ld_pllhyl.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {    
                ...
                List <sara.dd.ldsw.model.tbl_ld_pllhyl> l_tbl_ld_pllhyl = _idal_tbl_ld_pllhyl.GetList(whereString, "", columnsString, "", "", null);
                foreach (sara.dd.ldsw.model.tbl_ld_pllhyl model in l_tbl_ld_pllhyl)
                {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_pllhyl.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_pllhyl.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_pllhyl.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ld_pllhyl>(_idal_tbl_ld_pllhyl.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_ld_pllhyl.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ld_pllhyl.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
        ...
        private string FormatColumns(string columns)
        {
            ...
            {   
				...
				columns += "^" + "fk_tbl_ld_pllhlb_sys_id";
