...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_ld_jmb : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_ld_jmb _idal_tbl_ld_jmb = new sara.dd.ldsw.dal.tbl_ld_jmb();
        private sara.dd.ldsw.idal.Itbl_ld_cbiao _idal_tbl_ld_cbiao = new sara.dd.ldsw.dal.tbl_ld_cbiao();
        private sara.dd.ldsw.reportclass.tbl_ld_jmb report = new sara.dd.ldsw.reportclass.tbl_ld_jmb();
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ld_jmb> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ld_jmb>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_jmb.AddList(modellist,null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_ld_jmb.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {    
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_jmb.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_jmb.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_jmb.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ld_jmb>(_idal_tbl_ld_jmb.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_ld_jmb.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ld_jmb.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
