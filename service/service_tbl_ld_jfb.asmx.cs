                    ...
                    case "jfforapp"://app缴费
                        {
                            ...
                            if (model_khb_list.Count > 0)
                            {
                                ...
                                if (flag_cb >= 0 && flag_kh >= 0)
                                {
                                    ...
                                    string wxresult = Eva.Library.WebService.DynamicWebServices.InvokeWebService("http://ewater.actionlive.cn/sara.dd.actionwx/service/service_tbl_wx_khb.asmx", "setWeixinyue", args).ToString();
