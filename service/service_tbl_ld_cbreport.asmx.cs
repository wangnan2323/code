...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_ld_cbreport : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_ld_cbreport _idal_tbl_ld_cbreport = new sara.dd.ldsw.dal.tbl_ld_cbreport();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                ...
                sara.dd.ldsw.model.tbl_ld_cbreport model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_ld_cbreport>(json);
                if (model.f_cb_cbbh == "")
                {
                ...
                {
                    t.ExecuteSql("delete from tbl_ld_cbreport where f_khbhid='" + model.f_khbhid + "' and f_ztid='0'");
                }
                    ...
                    if (model.f_ztid == "1")
                    {
                        ...
                        array.Add(f_sqsl);
                        sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_khb", model_tbl_ld_khb.sys_id.ToString(), "tbl_ld_cbreport_detail", "抄表提交", array, clientInf, t);
                        #endregion
                        #endregion
                        ...
                        list.Add(sb_f_sqsl);
                        sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_sbb", model_tbl_ld_sbb.sys_id.ToString(), "tbl_ld_cbreport_detail", "抄表提交", array, clientInf, t);
                    #endregion
                ...
                if (model.f_ztid == "2")
                {
                    ...
                    array.Add(f_ljqf);
                    sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_khb", model_tbl_ld_khb.sys_id.ToString(), "tbl_ld_cbreport_detail", "APP只抄表", array, clientInf, t);
                    #endregion
                    #endregion
                ...
                resultDic["message"] = _idal_tbl_ld_cbreport.Add(model, t);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ld_cbreport> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ld_cbreport>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_cbreport.AddList(modellist, null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                if (model.f_ztid == "2")
                {
                    ...
                    resultDic["result"] = "true";
                    resultDic["message"] = _idal_tbl_ld_cbreport.Update(model, columns, t);
        ...
        public string Addforapp(string jsoncb,string jsonjf, string clientInf)
        {
            ...
            try
            {
                ...
                sara.dd.ldsw.model.tbl_ld_cbreport model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_ld_cbreport>(jsoncb);
                if (model.f_cb_cbbh == "")
                {
                    model.f_cb_cbbh = sara.dd.ldsw.commonclass.commonclass.getBusinessNum("cb", "", t);
                }
                ...
                if (model.f_ztid == "2")
                {
                    ...
                    cbsysid = _idal_tbl_ld_cbreport.Add(model, t);
                }
                ...
                else if (model.f_ztid == "3")
                {
                    ...
                    sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_khb", model_tbl_ld_khb.sys_id.ToString(), "tbl_ld_cbreport_detail", "APP抄表缴费", array, clientInf, t);
                    #endregion
                    #endregion
                    ...
                    _idal_tbl_ld_cbreport.Update(model,"f_jfbh,f_jfbhid,f_jfsj", t);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                columns = FormatColumns(columns).Replace("^", ",");
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_cbreport.UpdateList(modellist, columns, null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_cbreport.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_cbreport.LogicDelete(delUserId, delUserName, delDate, whereString, null);
        ...
        public string GetCount(string whereString, string cxzxsjString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_cbreport.GetCount(whereString, cxzxsjString, null);
        ...
        public string GetList(string whereString, string cxzxsjString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                //string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ld_cbreport>(_idal_tbl_ld_cbreport.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ld_cbreport.GetDataTableForPC(whereString, cxzxsjString, orderByString, columnsString, pageSizeString, pageIndexString, null));

                string message = "{\"total\":\"" + _idal_tbl_ld_cbreport.GetCount(whereString, cxzxsjString, null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string cxzxsjString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ld_cbreport.GetDataTableForApp(whereString, cxzxsjString, orderByString, columnsString, countString, stepString, null));
        ...
        public string RollBack(string sys_id, string clientInf)
        {
            ...
            try
            {
                ...
                IList< sara.dd.ldsw.model.tbl_ld_cbreport> modelList = _idal_tbl_ld_cbreport.GetList("sys_id='" + sys_id + "'", "", "", "*", "", "", t);
                if(modelList.Count > 0)
                {   //抄表数据的回滚，肯定在运行库中
                    sara.dd.ldsw.model.tbl_ld_cbreport model = modelList[0];
                    ...
                    else
                    {
                        ...
                        _idal_tbl_ld_cbreport.Update(model, "f_ztid,f_zt,f_dyjtsl,f_dyjtsf,f_dejtsl,f_dejtsf,f_dsjtsl,f_dsjtsf", t);
                        ...
                        //上一条抄表记录
                        DataTable dt_sytcbjl = t.Query("select f_sjljsyl,f_qsqpjsl,f_qlqpjsl,f_cbsj, f_bqzm, f_sqzm, f_bqsl, f_sqsl,rownum  from (select f_sjljsyl,f_qsqpjsl,f_qlqpjsl,f_cbsj, f_bqzm, f_sqzm, f_bqsl, f_sqsl from tbl_ld_cbreport where f_khbhid='" + model.f_khbhid + "' and f_ztid <> '0' order by f_cbsj desc) t where rownum =1").Tables[0];
                        ...
                        sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_khb", model_tbl_ld_khb.sys_id.ToString(), "tbl_ld_cbreport_detail", "抄表回滚", array, clientInf, t);
                        #endregion
                        ...
                        sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_sbb", model_tbl_ld_sbb.sys_id.ToString(), "tbl_ld_cbreport_detail", "抄表回滚", array, clientInf, t);
                        #endregion
                        #endregion
                        #region 抄表回滚写日志
                        ...
                        arr.Add(cbiao);
                        sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_cbreport", model.sys_id.ToString(), "tbl_ld_cbreport_detail", "PC端抄表回滚", arr, clientInf, t);
                        #endregion
                        resultDic["result"] = "true";
                        resultDic["message"] = "";
                    }
        ...
        public string RollBackCBForApp(string sys_id, string clientInf)
        {
            ...
            try
            {
                ...
                List<sara.dd.ldsw.model.tbl_ld_cbreport> modelist = _idal_tbl_ld_cbreport.GetList("sys_id='" + sys_id + "'", "", "", "*", "", "", t);
                if(modelist.Count > 0)
                {
                    sara.dd.ldsw.model.tbl_ld_cbreport model = modelist[0];
                    ...
                    else
                    {
                        ...
                        arr.Add(cbiao);
                        sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_cbreport", model.sys_id.ToString(), "tbl_ld_cbreport_detail", "手持机抄表回滚", arr, clientInf, t);
                        #endregion
                        resultDic["result"] = "true";
                        resultDic["message"] = "";
                    }
            ...
            try
            {
                ...
                if(modellist.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        arr.Add(cbiao);
                        sara.dd.ldsw.commonclass.commonclass.addUpdateLog("tbl_ld_cbreport", model.sys_id.ToString(), "tbl_ld_cbreport_detail", "抄表缴费回滚", arr, clientInf, t);
                        #endregion
                        resultDic["result"] = "true";
                        resultDic["message"] = "";
                    }
        ...
        private void CountPJSL(sara.dd.ldsw.model.tbl_ld_cbreport model, ref string f_qsqpjsl, ref string f_qlqpjsl, string bqsl, Eva.Library.Data.AccessDataTrans.IAccessDataTrans t)
        {
            ...
            if (t == null)
            {
                ...
                dt_pjsl = _iAccessData.Query("select f_bqsl,rownum from ( select f_bqsl from tbl_ld_cbreport where f_khbhid='" + model.f_khbhid + "' and f_ztid <> '0' and f_ztid <> '9'  order by f_cbsj desc) t where rownum<6").Tables[0];
            }
            else
            {
                dt_pjsl = t.Query("select f_bqsl,rownum from ( select f_bqsl from tbl_ld_cbreport where f_khbhid='" + model.f_khbhid + "' and f_ztid <> '0' and f_ztid <> '9' order by f_cbsj desc) t where rownum<6").Tables[0];
            }
        ...
        public string Export(string whereString, string cxzxsjString, string column, string orderByString, string columnname, string clientInf)
        {
            ...
            try
            {
                ...
                //sql += " from tbl_ld_cbreport";
                //sql += " where" + whereString + "";
                //DataTable dt = _iAccessData.Query(sql).Tables[0];
                DataTable dt = _idal_tbl_ld_cbreport.GetDataTableForPC(whereString, cxzxsjString, orderByString, column, "", "", null);
        ...
        public string IsCanRollBack(string sys_id, string clientInf)
        {
            ...
            try
            {
                string sql = " select count(*) from tbl_ld_cbreport where sys_id > '" + sys_id + "' and f_khbhid = (select f_khbhid from tbl_ld_cbreport where sys_id = '" + sys_id + "')";
        ...
        public string RollBackSF(string sys_id,string khbhid,string bqje,string jmbhid, string clientInf)
        {
            ...
            try
            {
                ...
                //清除算费数据
                string updatesql = "update tbl_ld_cbreport set F_ZT='已抄表',F_ZTID='1',F_SF='0',F_PWF='0',F_BQJE='0' where SYS_ID='"+sys_id+"'";
                ...
                {
                    //清除抄表表减免数据
                    string updatecbsql = "update tbl_ld_cbreport set F_JMBH='',F_JMBHID='',F_JMJE='0',F_SFJL='' where SYS_ID in(" + jmids + ")";
        ...
        public string SumList(string whereString, string cxzxsjString,  string sumString,  string clientInf)
        {
            ...
            try
            {
                ...
                if (sara.dd.ldsw.commonclass.commonclass.isNeedHis("cBiao", cxzxsjString) == true)
                {
                    ...
                    strSql.Append("  ( ");
                    strSql.Append("  (select * from tbl_ld_cbreport t where ");
                    if (whereString.Trim() == "")
                    {
                        strSql.Append(" 1=1 ");
                    }
                    ...
                    strSql.Append("  (select * from tbl_ld_cbreport_his t where  ");
                    if (whereString.Trim() == "")
                    {
                        strSql.Append(" 1=1 ");
                    }
        ...
        public string historyJTSJ()
        {
            ...
            try
            {
                double count = Eva.Library.Text.NumberTool.Parse(_idal_tbl_ld_cbreport.GetCount("(f_sfjl like '%3.95^%' or f_sfjl like '%5.25^%' or f_sfjl like '%7.05^%') and f_dyjtsl is null and f_dyjtsf is null","false",null));

                double pagecount = Math.Ceiling(count / 5000);

                for(int page = 1; page < pagecount; page++)
                {
                    List<model.tbl_ld_cbreport> cbmodellist = _idal_tbl_ld_cbreport.GetList("(f_sfjl like '%3.95^%' or f_sfjl like '%5.25^%' or f_sfjl like '%7.05^%') and f_dyjtsl is null and f_dyjtsf is null", "false", "", "sys_id,f_sfjl,f_dyjtsl,f_dyjtsf,f_dejtsl,f_dejtsf,f_dsjtsl,f_dsjtsf","5000", page.ToString(), null);

                    for (int i = 0; i < cbmodellist.Count(); i++)
                    {

                        model.tbl_ld_cbreport model = cbmodellist[i];
                        ...
                        _idal_tbl_ld_cbreport.Update(model, "f_dyjtsl,f_dyjtsf,f_dejtsl,f_dejtsf,f_dsjtsl,f_dsjtsf", null);
                    }
                }
