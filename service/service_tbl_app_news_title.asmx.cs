...
{
    /// <summary>
    /// Service_tbl_app_news_title 的摘要说明
    /// </summary>
    ...
    public class service_tbl_app_news_title : System.Web.Services.WebService
    {
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_app_news_title model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_app_news_title>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_title.Add(model, null);
        ...
        public string AddListByTitleResource(string json, string clientInf)
        {
            ...
            try
            {
                ...
                DataSet ds = iAccessData.Query("select * from tbl_file_content where menuid in (select f_titleresource from tbl_app_news where sys_id='" + model.fk_tbl_app_news_sys_id + "')");

                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    model.sys_id = 0;
                    model.f_mediaurl = ds.Tables[0].Rows[i]["FILEUPLOADNAME"].ToString();
                    _idal_tbl_app_news_title.Add(model, null);
                }
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_app_news_title> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_app_news_title>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_title.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_title.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_app_news_title.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_title.Delete(whereString,null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_title.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_app_news_title.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_app_news_title>(_idal_tbl_app_news_title.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_app_news_title.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
