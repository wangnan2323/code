...
namespace sara.dd.ldsw.service
{
    ...
    public class service_tbl_ld_dxcs : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_ld_dxcs _idal_tbl_ld_dxcs = new sara.dd.ldsw.dal.tbl_ld_dxcs();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                sara.dd.ldsw.model.tbl_ld_dxcs model = Eva.Library.Format.FormatEntityTool.FormatJsonToModel<sara.dd.ldsw.model.tbl_ld_dxcs>(json);
                if (model.f_dxfspch == "")
                {
                    model.f_dxfspch = sara.dd.ldsw.commonclass.commonclass.getBusinessNum("dx", "", null);
                }
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_dxcs.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ld_dxcs> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ld_dxcs>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_dxcs.AddList(modellist,null);
        ...
        public string Update(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_dxcs.Update(model, columns, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                 ...
                 columns = FormatColumns(columns).Replace("^", ",");
                 resultDic["result"] = "true";
                 resultDic["message"] = _idal_tbl_ld_dxcs.UpdateList(modellist, columns,null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            {    
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_dxcs.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_dxcs.LogicDelete(delUserId, delUserName, delDate, whereString,null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {               
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ld_dxcs.GetCount(whereString,null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ld_dxcs>(_idal_tbl_ld_dxcs.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString,null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_ld_dxcs.GetCount(whereString,null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ld_dxcs.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
