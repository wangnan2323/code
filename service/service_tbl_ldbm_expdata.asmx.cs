...
{
    /// <summary>
    /// Service_tbl_ldbm_expdata 的摘要说明
    /// </summary>
    ...
    public class service_tbl_ldbm_expdata : System.Web.Services.WebService
    {
        private sara.dd.ldsw.idal.Itbl_ldbm_expdata _idal_tbl_ldbm_expdata = new sara.dd.ldsw.dal.tbl_ldbm_expdata();
        ...
        public string Add(string json, string clientInf)
        {
            ...
            try
            {
                ...
                model.f_zhdcsj = DateTime.Now;
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_expdata.Add(model, null);
        ...
        public string AddList(string json, string clientInf)
        {
            ...
            try
            {
                List<sara.dd.ldsw.model.tbl_ldbm_expdata> modellist = Eva.Library.Format.FormatEntityTool.FormatJsonToModelList<sara.dd.ldsw.model.tbl_ldbm_expdata>(json);
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_expdata.AddList(modellist, null);
        ...
        public string UpdateList(string json, string columns, string clientInf)
        {
            ...
            try
            {
                ...
                columns = FormatColumns(columns).Replace("^", ",");
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_expdata.UpdateList(modellist, columns, null);
        ...
        public string Delete(string whereString, string clientInf)
        {
            ...
            try
            {
                ...
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_expdata.Delete(whereString, null);
        ...
        public string LogicDelete(string delUserId, string delUserName, string delDate, string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_expdata.LogicDelete(delUserId, delUserName, delDate, whereString, null);
        ...
        public string GetCount(string whereString, string clientInf)
        {
            ...
            {
                resultDic["result"] = "true";
                resultDic["message"] = _idal_tbl_ldbm_expdata.GetCount(whereString, null);
        ...
        public string GetList(string whereString, string orderByString, string columnsString, string pageSizeString, string pageIndexString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatModelListToJson<sara.dd.ldsw.model.tbl_ldbm_expdata>(_idal_tbl_ldbm_expdata.GetList(whereString, orderByString, columnsString, pageSizeString, pageIndexString, null), columnsString);

                string message = "{\"total\":\"" + _idal_tbl_ldbm_expdata.GetCount(whereString, null) + "\",\"rows\":" + rows + "}";
        ...
        public string GetListForApp(string whereString, string orderByString, string columnsString, string countString, string stepString, string clientInf)
        {
            ...
            try
            {
                ...
                string rows = Eva.Library.Format.FormatEntityTool.FormatDataTableToJson(_idal_tbl_ldbm_expdata.GetDataTableForApp(whereString, orderByString, columnsString, countString, stepString, null));
        ...
        public string Export(string whereString,  string column, string orderByString, string columnname, string clientInf)
        {
            ...
            try
            {
                ...
                DataTable dt = _idal_tbl_ldbm_expdata.GetDataTableForPC(whereString,  orderByString, column, "", "", null);
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void Change(string khbh, string yhm, string nr,string dz)
        {
            List<sara.dd.ldsw.model.tbl_ldbm_expdata> modellist = _idal_tbl_ldbm_expdata.GetList("f_khbh='" + khbh + "'", "", "*", "", "", null);
            if (modellist.Count > 0)
            {
                sara.dd.ldsw.model.tbl_ldbm_expdata model = modellist[0];
                ...
                _idal_tbl_ldbm_expdata.Update(model, "f_nr,f_gjzd,f_bz", null);
            }
