        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if(xmlstr != null && xmlstr != "")
                {
                    ...
                    {
                        DataTable dt = _iAccessData.Query("SELECT NVL(F_LJQF,0) as f_ljqf,f_yhm,f_hth FROM TBL_LD_KHB WHERE F_KHBH='" + billKey + "'").Tables[0];
                        ...
                        if(ljqf <= 0)
                        {
                            ...
                            errxml += "<ErrorInfo>用户未欠款</ErrorInfo>";
                            errxml += "</Body>";
                            errxml += "</Out>";
                        ...
                        else
                        {
                            ...
                            resultxml += "<payAmount>" + dt.Rows[0]["f_ljqf"] + "</payAmount>";
                            ...
                            resultxml += "<detailFiled5></detailFiled5>";
                            resultxml += "</Frame>";
                            resultxml += "</Body>";
                            resultxml += "</Out>";
            ...
            catch (System.Exception ex)
            {
                ...
                errxml += "</Head>";
                errxml += "<Body>";
                errxml += "<ErrorCode>DEF0003</ErrorCode>";
