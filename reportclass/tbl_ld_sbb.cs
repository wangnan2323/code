...
namespace sara.dd.ldsw.reportclass
{
    public class tbl_ld_sbb
    {
        ...
        private sara.dd.ldsw.model.tbl_ld_sbb _model_tbl_ld_khb = new sara.dd.ldsw.model.tbl_ld_sbb();
        private sara.dd.ldsw.idal.Itbl_ld_sbb _idal_tbl_ld_yhb = commonclass.dalfactory.Create<sara.dd.ldsw.idal.Itbl_ld_sbb>(); //new sara.dd.ldsw.dal.tbl_ld_khb();
        ...
        public string ReportExcel(DataTable dt_data, string column, string columnname)
        {
            ...
            string filename = "水表信息" + Eva.Library.Text.NumberTool.GetNoRepeatNumber() + ".csv";
