...
namespace sara.dd.ldsw.reportclass
{
    public class tbl_ld_ickss
    {
        ...
        private sara.dd.ldsw.model.tbl_ld_ickss _model_tbl_ld_ickss = new sara.dd.ldsw.model.tbl_ld_ickss();
        ...
        public string ReportExcel(DataTable dt_data, string column, string columnname)
        {
            ...
            string filename = "IC卡售水信息" + Eva.Library.Text.NumberTool.GetNoRepeatNumber() + ".csv";
