...
namespace sara.dd.ldsw.commonclass
{
    public class RequestHelper
    {
        ...
        /// </summary>
        public string Version { get; } = "2017-03-21";

        /// <summary>
        /// 阿里云颁发给用户的访问服务所用的密钥ID
        /// </summary>
        public string AccessKeyId { get; set; } = Eva.Library.Configuration.ConfigurationManager.AppSettings["access_key_id"];
        ...
        /// 阿里云颁发给用户的访问服务所用的密钥
        /// </summary>
        private string AccessKeySecret { get; set; } = Eva.Library.Configuration.ConfigurationManager.AppSettings["access_key_secret"];
