...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_ld_ycbglzb 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_ld_ycbglzb
    {
    	public tbl_ld_ycbglzb()
		{}
		#region Model
		...
		private string _fk_tbl_ld_ycbgl_sys_id;
		...
		/// 远传表管理_主键
		/// </summary>
		public string fk_tbl_ld_ycbgl_sys_id
		{
			get{return _fk_tbl_ld_ycbgl_sys_id;}
			set{ _fk_tbl_ld_ycbgl_sys_id=value;}
		}
