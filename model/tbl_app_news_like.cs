...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_app_news_like 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_app_news_like
    {
		...
		private string _fk_t_user_id;
                
		private string _fk_tbl_app_news_sys_id;
                
		private string _fk_tbl_app_news_discuss_sys_id;
                
		private string _f_username;
                
		private string _f_userimg;
                
		private string _f_liketype;
                
		private string _f_liketypeid;
		...
		/// 用户id
		/// </summary>
		public string fk_t_user_id
		{
			get{return _fk_t_user_id;}
			set{ _fk_t_user_id=value;}
		}
                
		/// <summary>
		/// 新闻表id
		/// </summary>
		public string fk_tbl_app_news_sys_id
		{
			get{return _fk_tbl_app_news_sys_id;}
			set{ _fk_tbl_app_news_sys_id=value;}
		}
                
		/// <summary>
		/// 评论表id
		/// </summary>
		public string fk_tbl_app_news_discuss_sys_id
		{
			get{return _fk_tbl_app_news_discuss_sys_id;}
			set{ _fk_tbl_app_news_discuss_sys_id=value;}
		}
		...
		{
			get{return _f_userimg;}
			set{ _f_userimg=value;}
		}
                
		/// <summary>
		/// 赞或踩
		/// </summary>
		public string f_liketype
		{
			get{return _f_liketype;}
			set{ _f_liketype=value;}
		}
                
		/// <summary>
		/// f_liketype
		/// </summary>
		public string f_liketypeid
		{
			get{return _f_liketypeid;}
			set{ _f_liketypeid=value;}
		}
