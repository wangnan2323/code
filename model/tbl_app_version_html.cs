...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_app_version_html 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_app_version_html
    {
		...
		private string _f_htmlname;
                
		private string _f_htmlversion;
                
		private string _f_htmlcontent;
		...
		/// html文件名称
		/// </summary>
		public string f_htmlname
		{
			get{return _f_htmlname;}
			set{ _f_htmlname=value;}
		}
		...
		/// html内容
		/// </summary>
		public string f_htmlcontent
		{
			get{return _f_htmlcontent;}
			set{ _f_htmlcontent=value;}
		}
