...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_ld_jfbimp 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_ld_jfbimp
    {
		...
		private string _f_drpcmc;
                
		private string _f_drfj;
		...
		private string _f_lx;
                
		private string _f_lxid;
		...
		/// 导入批次名称
		/// </summary>
		public string f_drpcmc
		{
			get{return _f_drpcmc;}
			set{ _f_drpcmc=value;}
		}
