...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_app_version 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_app_version
    {
		...
		private string _f_appversion;
                
		private string _f_htmlversion;
                
		private string _f_codeversion;
                
		private string _f_colorversion;
                
		private string _f_comment;
                
		private string _f_status;
                
		private string _f_apptype;
                
		private string _f_apptypeid;
                
		private string _f_appstatus;
                
		private string _f_appstatusid;
		...
		{
			get{return _f_appversion;}
			set{ _f_appversion=value;}
		}
                
		/// <summary>
		/// html版本
		/// </summary>
		public string f_htmlversion
		{
			get{return _f_htmlversion;}
			set{ _f_htmlversion=value;}
		}
                
		/// <summary>
		/// code版本
		/// </summary>
		public string f_codeversion
		{
			get{return _f_codeversion;}
			set{ _f_codeversion=value;}
		}
                
		/// <summary>
		/// color版本
		/// </summary>
		public string f_colorversion
		{
			get{return _f_colorversion;}
			set{ _f_colorversion=value;}
		}
		...
		/// app类型：ios/android
		/// </summary>
		public string f_apptype
		{
			get{return _f_apptype;}
			set{ _f_apptype=value;}
		}
                
		/// <summary>
		/// f_apptype
		/// </summary>
		public string f_apptypeid
		{
			get{return _f_apptypeid;}
			set{ _f_apptypeid=value;}
		}
                
		/// <summary>
		/// app状态：开发，审核，发布，归档
		/// </summary>
		public string f_appstatus
		{
			get{return _f_appstatus;}
			set{ _f_appstatus=value;}
		}
                
		/// <summary>
		/// f_appstatus
		/// </summary>
		public string f_appstatusid
		{
			get{return _f_appstatusid;}
			set{ _f_appstatusid=value;}
		}
