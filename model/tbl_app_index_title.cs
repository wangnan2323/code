...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_app_index_title 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_app_index_title
    {
		...
		private string _fk_tbl_app_index_sys_id;
                
		private string _f_mediaurl;
                
		private string _f_mediadesc;
		...
		/// 新闻表主键id
		/// </summary>
		public string fk_tbl_app_index_sys_id
		{
			get{return _fk_tbl_app_index_sys_id;}
			set{ _fk_tbl_app_index_sys_id=value;}
		}
                
		/// <summary>
		/// 媒体文件路径
		/// </summary>
		public string f_mediaurl
		{
			get{return _f_mediaurl;}
			set{ _f_mediaurl=value;}
		}
                
		/// <summary>
		/// 媒体文件描述文字
		/// </summary>
		public string f_mediadesc
		{
			get{return _f_mediadesc;}
			set{ _f_mediadesc=value;}
		}
