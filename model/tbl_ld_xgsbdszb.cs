...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_ld_xgsbdszb 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_ld_xgsbdszb
    {
		...
		private string _f_ysbds;
                
		private string _f_xsbds;
                
		private string _f_sbbh;
                
		private string _fk_tbl_ld_xgsbds_sys_id;
		...
		/// tbl_ld_xgsbds_主键
		/// </summary>
		public string fk_tbl_ld_xgsbds_sys_id
		{
			get{return _fk_tbl_ld_xgsbds_sys_id;}
			set{ _fk_tbl_ld_xgsbds_sys_id=value;}
		}
