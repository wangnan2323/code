...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_ldbm_jtsj 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_ldbm_jtsj
    {
		...
		private string _f_rk;
                
		private string _f_jtsl;
                
		private string _f_jtsj;
                
		private string _f_pwf;
                
		private DateTime _f_cjrq;
                
		private DateTime _f_jsrq;
                
		private DateTime _f_sxrq;
                
		private DateTime _f_zzrq;
                
		private string _f_zfbl;
		...
		/// 终止日期
		/// </summary>
		public DateTime f_zzrq
		{
			get{return _f_zzrq;}
			set{ _f_zzrq=value;}
		}
                
		public string f_zfbl
		{
			get{return _f_zfbl;}
			set{ _f_zfbl=value;}
		}
