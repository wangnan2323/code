...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_ld_ycbgl 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_ld_ycbgl
    {
    	public tbl_ld_ycbgl()
		{}
		#region Model
		...
		private string _f_cjcbsjzxr;
                
		private DateTime _f_cjcbsj;
		...
		/// 创建抄表数据执行人
		/// </summary>
		public string f_cjcbsjzxr
		{
			get{return _f_cjcbsjzxr;}
			set{ _f_cjcbsjzxr=value;}
		}
                
		/// <summary>
		/// 创建抄表时间
		/// </summary>
		public DateTime f_cjcbsj
		{
			get{return _f_cjcbsj;}
			set{ _f_cjcbsj=value;}
		}
