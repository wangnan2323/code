...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_app_news_discuss 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_app_news_discuss
    {
		...
		private string _f_discusscontent;
                
		private string _f_nodeid;
		...
		/// 评论内容
		/// </summary>
		public string f_discusscontent
		{
			get{return _f_discusscontent;}
			set{ _f_discusscontent=value;}
		}
                
		/// <summary>
		/// nodeid
		/// </summary>
		public string f_nodeid
		{
			get{return _f_nodeid;}
			set{ _f_nodeid=value;}
		}
