...
namespace sara.dd.ldsw.model
{
    [Serializable]
    /// <summary>
    /// 实体类tbl_ld_xhhbtzb 。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    public class tbl_ld_xhhbtzb
    {
		...
		private string _fk_tbl_ld_xhhbt_sys_id;
		...
		/// 销户和报停_主键
		/// </summary>
		public string fk_tbl_ld_xhhbt_sys_id
		{
			get{return _fk_tbl_ld_xhhbt_sys_id;}
			set{ _fk_tbl_ld_xhhbt_sys_id=value;}
		}
