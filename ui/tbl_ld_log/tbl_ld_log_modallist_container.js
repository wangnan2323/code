...
var tbl_ld_log_modallist_container_Obj = ( function ()
{
    'use strict';
    var start = function () { },
    /* 
                    ...
                    success: function ()
                    {
                        ...
                        initParameter( {
                            success: function ()
                            {
                                ...
                                $( '#div_container_tbl_ld_log_modallist' ).load( '../tbl_ld_log/tbl_ld_log_modallist_part.html', null, function ()
                                {
                                    tbl_ld_log_modallist_Obj._pr_listtype = that._pr_listtype;
                                    tbl_ld_log_modallist_Obj.init( {
                                        success: function ()
                                        {
                                            $( '#div_container_tbl_ld_log_modallist' ).css( 'display', '' );
                                            $( '#div_loading_tbl_ld_log_modallist' ).css( 'display', 'none' );
...
{
    tbl_ld_log_modallist_container_Obj.init();
} );
