...
var tbl_ld_khb_list_container_Obj = ( function ()
{
    'use strict';
    var start = function () { },
    /* 
                    ...
                    success: function ()
                    {
                        ...
                        initParameter( {
                            success: function ()
                            {
                                ...
                                $( '#div_container_tbl_ld_khb_list' ).load( '../tbl_ld_khb/tbl_ld_khb_list_part.html', null, function ()
                                {
...
{
    tbl_ld_khb_list_container_Obj.init();
} );
