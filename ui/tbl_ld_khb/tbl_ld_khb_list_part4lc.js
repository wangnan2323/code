                           ...
                           formatter: function (value, row, index)
                           {
                               switch (row.f_ztid)
                               {
                                   ...
                                   case '4':
                                       ...
                                       {
                                           //客户类型
                                           var iskhlx = row.f_value1.split("_");
                                           var khlx;    
                                           ...
                                           if (khlx = that._pr_f_value1 && row.f_value2 == that._pr_f_value2)
                                           {
                                       return {
                                           disabled: false
                                               }
        ...
        */
        bindGrid: function (callBackFunction)
        {
            setTimeout(function ()
            {
                ...
                if (that._pr_where != null && that._pr_where != "")
                {
                    if (whereClause == null || whereClause == "")
                    {
                        whereClause = that._pr_where;
                    }
                    else
                    {
                        whereClause += " and " + that._pr_where;
                    }
                }
