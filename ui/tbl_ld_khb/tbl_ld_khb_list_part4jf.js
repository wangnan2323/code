        ...
        bindGrid: function (callBackFunction)
        {
            setTimeout(function ()
            {
                ...
                if(whereClause == null || whereClause == ""){
                    //whereClause = "f_ztid='0' and ";
                    whereClause = " sysdate>f_zhcbrq";
                }
                else
                {
                    //whereClause += " and f_ztid='0'"
                    whereClause += " and sysdate>f_zhcbrq";
                }
                if (tbl_ld_cbiao_detail_Obj._pr_isadmin != "0")
                {
                    whereClause += " and f_cbbhid in (select sys_id from tbl_ld_cben where f_cbyid='" + basePageObj._userInfoJson.sys_userid + "')";
                }
