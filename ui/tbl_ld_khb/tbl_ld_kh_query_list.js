...
var tbl_ld_kh_query_list_Obj = (function ()
{
    'use strict';
    ...
    var _serviceUrl = '//162.16.166.1/sara.dd.ldsw/service/service_tbl_ld_khb.asmx/',
    _servicecommonUrl = '//162.16.166.1/sara.dd.ldsw/service/service_common.asmx/',
    ...
    */
    initParameter = function (callBackFunction)
    {
        try
        {
            ...
            //    case "1":
            //        $('#btn_command_search_tbl_ld_kh_query_list').html('简单查询');
            //        $('#txt_command_search_tbl_ld_kh_query_list').removeAttr("disabled");

            //        break;
            //    case "2":
            //        $('#btn_command_search_tbl_ld_kh_query_list').html('高级查询');
            //        $('#txt_command_search_tbl_ld_kh_query_list').attr("disabled", true);
            //        break;
            //}
    ...
    */
    setDisable = function (isDisable)
    {
        try
        {
            if (isDisable)
            {
                $('#btn_command_delete_tbl_ld_kh_query_list').addClass('hidden');
                $('#btn_command_new_tbl_ld_kh_query_list').addClass('hidden');
            }
            else
            {
                $('#btn_command_delete_tbl_ld_kh_query_list').removeClass('hidden');
                $('#btn_command_new_tbl_ld_kh_query_list').removeClass('hidden');
            }
        }
        catch (ex)
        {
    ...
    */
    initSearchBaseCode = function (callBackFunction)
    {
      ...
      { "id": "f_bz", "text": "备注" },
      { "id": "f_cbbh", "text": "抄本编号" },
      //{ "id": "f_cbbhid", "text": "抄本编号id" },
      { "id": "f_cbxh", "text": "抄本序号" },
      { "id": "f_cbyxm", "text": "抄表员姓名" },
      //{ "id": "f_cbyid", "text": "抄表员id" },
      { "id": "f_cbzq", "text": "抄表周期" },
      { "id": "f_cbmc", "text": "抄本名称" },
      { "id": "f_yhbh", "text": "用户编号" },
    ...
    */
    gridSelectedChange = function ()
    {
        ...
        {
            $('#btn_command_clearselect_tbl_ld_kh_query_list').addClass('hidden');
        }
        else
        {
            $('#btn_command_clearselect_tbl_ld_kh_query_list').removeClass('hidden');

            var allcount = that._pr_gridselectids.split('^').length;
            var currentcount = $('#table_grid_tbl_ld_kh_query_list').bootstrapTable('getSelections').length;
            $('#btn_command_clearselect_tbl_ld_kh_query_list .cc-badge-p').html(currentcount + '/' + allcount);
    ...
    */
    initGrid = function (callBackFunction)
    {
        try
        {
            ...
            var column = getCookie("tbl_ld_kh_query_list_column");
            ...
            $('#table_grid_tbl_ld_kh_query_list').bootstrapTable({
                cache: false,
                height: gridHeight,
                striped: true,
                pagination: _isPage,
                ...
                onCheckAll: function ()
                {
                    var rows = $('#table_grid_tbl_ld_kh_query_list').bootstrapTable('getSelections');
                ...
                {
                    var rows = $('#table_grid_tbl_ld_kh_query_list').bootstrapTable('getData');
                    $.each(rows, function (i, u)
                    {
                        if (('^' + that._pr_gridselectids + '^').indexOf('^' + rows[i].sys_id + '^') > -1)
                        {
    ...
    */
    initDetailControl = function (callBackFunction)
    {
        try
        {
            ...
            controlObj.singledropdownlistinit('detial_f_fsblx_tbl_ld_kh_query_list', codeservice_sblx);
            //模态窗口
            $('#div_modal_tbl_ld_kh_query_list').modal({
                keyboard: false,
                backdrop: 'static',
                show: false
            });
    ...
    initDetailControlSort = function (callBackFunction)
    {
        try
        {
            ...
            controlObj.singledropdownlistinit('model_dropdown_f_px0_tbl_ld_kh_query_sortlist', codeservice_0814);
            controlObj.singledropdownlistinit('model_dropdown_f_px1_tbl_ld_kh_query_sortlist', codeservice_0814);
            controlObj.singledropdownlistinit('model_dropdown_f_px2_tbl_ld_kh_query_sortlist', codeservice_0814);
            controlObj.singledropdownlistinit('model_dropdown_f_pxfs0_tbl_ld_kh_query_sortlist', codeservice_px);
            controlObj.singledropdownlistinit('model_dropdown_f_pxfs1_tbl_ld_kh_query_sortlist', codeservice_px);
            controlObj.singledropdownlistinit('model_dropdown_f_pxfs2_tbl_ld_kh_query_sortlist', codeservice_px);
            //模态窗口
            $('#div_modal_tbl_ld_kh_query_sortlist').modal({
                keyboard: false,
                backdrop: 'static',
                show: false
            });
    ...
    initDetailControlShowColumn = function (callBackFunction)
    {
        try
        {
            ...
            controlObj.multidropdownlistinit('model_dropdown_f_checklist_tbl_ld_kh_query_showcolumnlist', codeservice_0814, null);
    ...
    var that = {
                                    ...
                                    success: function ()
                                    {
                                        that.bindGrid({
                                            success: function ()
                                            {
                                                ...
                                                _validateMessage = new validateMessage('btn_search_modal_search_tbl_ld_kh_query_list');

                                                _ladda_btn_command_exp = Ladda.create('btn_command_report_tbl_ld_kh_query_list');
                                                _ladda_btn_command_sort = Ladda.create('btn_command_sort_tbl_ld_kh_query_list');
                                                _ladda_btn_command_showcolunm = Ladda.create('btn_command_showcolunm_tbl_ld_kh_query_list');
                                                switch (that._pr_listtype)
                                                {
                                                    case "1":
                                                        setDisable(false);
        ...
        */
        bindGrid: function (callBackFunction)
        {
            setTimeout(function ()
            {
                $('#table_grid_tbl_ld_kh_query_list').bootstrapTable("showLoading");
                ...
                var sort = getCookie('tbl_ld_kh_query_list_sort');
                ...
                doAjaxFunction(_serviceUrl, 'GetList', data, {
                    success: function (result)
                    {
                        ...
                        $('#table_grid_tbl_ld_kh_query_list').bootstrapTable("hideLoading");

                        $('#table_grid_tbl_ld_kh_query_list').bootstrapTable("loadJson", messageJson);
...
*/
        btn_command_report_onclick: function ()
        {
            ...
            var column = getCookie('tbl_ld_kh_query_list_column');
            var columnname = getCookie('tbl_ld_kh_query_list_columnname');
            ...
            if (column != null && columnname != null && column != "" && columnname != "")
            {
                ...
                doAjaxFunction(_serviceUrl, 'Report', data, {
                    success: function (result)
                    {
        ...
        btn_command_sort_onclick: function ()
        {
            ...
            if (sort != null && sort != 'undefined' && sort != "")
            {
                ...
                for (var i = 0; i < arr.length; i++)
                {
                    ...
                    controlObj.singledropdownlistid('model_dropdown_f_px' + i + '_tbl_ld_kh_query_sortlist', px);
                    controlObj.singledropdownlistid('model_dropdown_f_pxfs' + i + '_tbl_ld_kh_query_sortlist', pxfs);
                }
            }
            $('#div_modal_tbl_ld_kh_query_sortlist').modal('show');
        },
        ...
        btn_detail_modal_cancle_onclick: function ()
        {
            ...
            $('#div_modal_tbl_ld_kh_query_sortlist').modal('hide');
        ...
        {
            var sort = "";
            var sypx = controlObj.singledropdownlistid('model_dropdown_f_px0_tbl_ld_kh_query_sortlist');
            var sypxfs = controlObj.singledropdownlistid('model_dropdown_f_pxfs0_tbl_ld_kh_query_sortlist');
            var cypx = controlObj.singledropdownlistid('model_dropdown_f_px1_tbl_ld_kh_query_sortlist');
            var cypxfs = controlObj.singledropdownlistid('model_dropdown_f_pxfs1_tbl_ld_kh_query_sortlist');
            var dspx = controlObj.singledropdownlistid('model_dropdown_f_px2_tbl_ld_kh_query_sortlist');
            var dspxfs = controlObj.singledropdownlistid('model_dropdown_f_pxfs2_tbl_ld_kh_query_sortlist');
            if (sypx != null && sypx != "")
            {
            ...
            sort = sort.trimEnd(',');
            setCookieMinutes("tbl_ld_kh_query_list_sort", sort, 5256000);
            that.bindGrid({
                success: function ()
                {
                    _ladda_btn_command_sort.stop();
        ...
        btn_command_showcolunm_onclick: function ()
        {
            ...
            if (column != null && column != 'undefined' && column != "")
            {
                ...
                controlObj.multidropdownlistid('model_dropdown_f_checklist_tbl_ld_kh_query_showcolumnlist', column);



            }
            $('#div_modal_tbl_ld_kh_query_showcolumnlist').modal('show');
        ...
        btn_showcolumn_modal_cancle_onclick: function ()
        {
            ...
            $('#div_modal_tbl_ld_kh_query_showcolumnlist').modal('hide');
        ...
        btn_showcolumn_modal_save_onclick: function ()
        {
            ...
            var column = controlObj.multidropdownlistid('model_dropdown_f_checklist_tbl_ld_kh_query_showcolumnlist');
            var columnname = controlObj.multidropdownlist('model_dropdown_f_checklist_tbl_ld_kh_query_showcolumnlist');


            setCookieMinutes("tbl_ld_kh_query_list_column", column, 5256000);
            setCookieMinutes("tbl_ld_kh_query_list_columnname", columnname, 5256000);

            $("#table_grid_tbl_ld_kh_query_list").bootstrapTable('destroy');
