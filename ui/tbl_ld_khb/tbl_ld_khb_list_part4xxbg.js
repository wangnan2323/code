    ...
    */
    getSearchModel = function (callBackFunction)
    {
        try
        {
            ...
            tbl_ld_khb_list.f_sbdz = controlObj.text('search_f_sbdz_tbl_ld_khb_list');
    ...
    */
    checkSearchModel = function (callBackFunction)
    {
        try
        {
            ...
            if (tbl_ld_khb_list.f_sbdz.length > 200)
            {
                errorMessageHansMap.put('search_f_sbdz_tbl_ld_khb_list', '长度不能超过<a style="color:red">200</a>个字');
            }
            ...
            $('#table_grid_tbl_ld_khb_list').bootstrapTable({
                ...
                columns: [
                       {
                           ...
                           formatter: function (value, row, index)
                           {
                               ...
                               var bglx = value1.split('_');
                                   //basePageObj._userInfoJson.sys_username,
                               // bglx[0]
                               if (that._pr_bglxid == '4' || that._pr_bglxid == '5')
                               {
                                   return {
                                       disabled: false
                                   }
                               ...
                               else
                               {
                                   ...
                                   {
                                       case '0':
                                           if (row.f_value1 != "" || row.f_value2 != "")
                                           {
                                               if (bglx[0] == tbl_ld_xxbg_detail_Obj._pr_bglx && bglx[1] == basePageObj._userInfoJson.sys_username && row.f_value2 == tbl_ld_xxbg_detail_Obj._pr_sys_id)
                                               {
                                                   return {
                                                       disabled: false
                                                   }
                                       ...
                                       case '4':
                                           if (row.f_value1 != "" || row.f_value2 != "")
                                           {
                                               if (bglx[0] == tbl_ld_xxbg_detail_Obj._pr_bglx && bglx[1] == basePageObj._userInfoJson.sys_username)
                                               {
                                                   return {
                                                       disabled: false
                                                   }
...

                {
                    ...
                    formatter: function (value, row, index)
                    {
                        ...
                        {
                            var bglx = value1.split('_');
                            resultHtml += "<strong>操作类型：</strong>&nbsp;&nbsp;" + bglx[0] + "</br>";
                            resultHtml += "<strong>操作人：</strong>&nbsp;&nbsp;" + bglx[1] + "</br>";
        ...
        */
        bindGrid: function (callBackFunction)
        {
            ...
            setTimeout(function ()
            {
                ...
                if (that._pr_bglxid == '4')
                {
                    if (whereClause != null && whereClause != "")
                    {
                        whereClause += " and f_ztid='9'";
                    }
                    else
                    {
                        whereClause += " f_ztid='9'";
                    }
                }

                if (that._pr_bglxid == '5')
                {
                    if (whereClause != null && whereClause != "")
                    {
