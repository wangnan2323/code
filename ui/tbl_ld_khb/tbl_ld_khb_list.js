        ...
        */
        initGrid = function (callBackFunction)
        {
            try
            {
                ...
                debugger
                var a = commonObj.formatFileSize("120098793"); //114mb
                var b = commonObj.formatNodeId("12345678910", 10);
                var c = commonObj.formatNodeId("12345678910", "abc");
                var d = commonObj.getNoRepeatNumber();
                var e = commonObj.formatFileSize("28994"); //28.3k
                var f = commonObj.formatFileSize("80361964116"); //74.8g
