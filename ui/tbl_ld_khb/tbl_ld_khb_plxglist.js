...
var tbl_ld_khb_plxglist_Obj = (function ()
{
    'use strict';
    ...
    */
    initParameter = function (callBackFunction)
    {
        try
        {
            ...
            //{
            //    case "1":
            //        $('#btn_command_search_tbl_ld_khb_plxglist').html('简单查询');
            //        $('#txt_command_search_tbl_ld_khb_plxglist').removeAttr("disabled");

            //        break;
            //    case "2":
            //        $('#btn_command_search_tbl_ld_khb_plxglist').html('高级查询');
            //        $('#txt_command_search_tbl_ld_khb_plxglist').attr("disabled", true);
            //        break;
            //}
    ...
    */
    setDisable = function (isDisable)
    {
        try
        {
            if (isDisable)
            {
                $('#btn_command_delete_tbl_ld_khb_plxglist').addClass('hidden');
                $('#btn_command_plxg_tbl_ld_khb_plxglist').addClass('hidden');
            }
            else
            {
                $('#btn_command_delete_tbl_ld_khb_plxglist').removeClass('hidden');
                $('#btn_command_plxg_tbl_ld_khb_plxglist').removeClass('hidden');
            }
        }
        catch (ex)
        {
    ...
    */
    transToDetailPage = function (id, pagetype)
    {
        ...
        url += '&fromurl=../tbl_ld_khb/tbl_ld_khb_plxglist.html';
        url += '&fromurlparam={';
        url += '"appcode":"' + that._pr_appcode + '",';
    ...
    */
    gridSelectedChange = function ()
    {
        ...
        {
            $('#btn_command_clearselect_tbl_ld_khb_plxglist').addClass('hidden');
        }
        else
        {
            $('#btn_command_clearselect_tbl_ld_khb_plxglist').removeClass('hidden');

            var allcount = that._pr_gridselectids.split('^').length;
            var currentcount = $('#table_grid_tbl_ld_khb_plxglist').bootstrapTable('getSelections').length;
            $('#btn_command_clearselect_tbl_ld_khb_plxglist .cc-badge-p').html(currentcount + '/' + allcount);
    ...
    */
    initGrid = function (callBackFunction)
    {
        try
        {
            ...
            $('#table_grid_tbl_ld_khb_plxglist').bootstrapTable({
                cache: false,
                height: gridHeight,
                striped: true,
                pagination: _isPage,
                ...
                onCheckAll: function ()
                {
                    var rows = $('#table_grid_tbl_ld_khb_plxglist').bootstrapTable('getSelections');
                ...
                {
                    var rows = $('#table_grid_tbl_ld_khb_plxglist').bootstrapTable('getData');
                    $.each(rows, function (i, u)
                    {
                        if (('^' + that._pr_gridselectids + '^').indexOf('^' + rows[i].sys_id + '^') > -1)
                        {
    ...
    *  参数:callBackFunction
    *  初始化model控件，会用到_baseCodeHashMap
    */
    initDetailControl = function (callBackFunction)
    {
        ...
        try
        {
            ...
            controlObj.toggleinit('detail_dropdown_f_sfjlbjf_tbl_ld_khb_plxglist', f_sfjlbjf_onchange);

            controlObj.singledropdownlistinit('detail_dropdown_f_cbbh_tbl_ld_khb_plxglist', codeservice_cben);
            controlObj.singledropdownlistinit('detail_dropdown_f_zt_tbl_ld_khb_plxglist', codeService_0556);

            controlObj.multidropdownlistinit('detail_dropdown_f_khfz_tbl_ld_khb_plxglist', codeservice_khfz);

        
            controlObj.singledropdownlistinit('detail_dropdown_f_yslx_tbl_ld_khb_plxglist', codeservice_0555);




            //模态窗口
            $('#div_detail_modal_tbl_ld_khb_plxglist').modal({
                keyboard: false,
                backdrop: 'static',
                show: false
            });
    ...
    var that = {
                                        ...
                                        initGrid({
                                            success: function ()
                                            {
                                                that.bindGrid({
                                                    success: function ()
                                                    {
                                                        _validateMessage = new validateMessage('btn_search_modal_search_tbl_ld_khb_plxglist');

                                                        _ladda_btn_command_plxg = Ladda.create('btn_command_plxg_tbl_ld_khb_plxglist');
                                                        switch (that._pr_listtype)
                                                        {
                                                            case "1":
                                                                setDisable(false);
        ...
        */
        bindGrid: function (callBackFunction)
        {
            setTimeout(function ()
            {
                $('#table_grid_tbl_ld_khb_plxglist').bootstrapTable("showLoading");
                ...
                doAjaxFunction(_serviceUrl, 'GetList', data, {
                    success: function (result)
                    {
                        ...
                        $('#table_grid_tbl_ld_khb_plxglist').bootstrapTable("hideLoading");

                        $('#table_grid_tbl_ld_khb_plxglist').bootstrapTable("loadJson", messageJson);
        ...
        *  新建数据并打开DetailModel
        */
        btn_command_plxg_onclick: function ()
        {

            _ladda_btn_command_plxg.start();
            var allcount = that._pr_gridselectids.split('^').length;

            if (that._pr_gridselectids == '')
            {
                _alertMessage.show('至少选择一条数据!', 'warning', 1000);
                _ladda_btn_command_plxg.stop();
            }
            else
            {

                $('#div_detail_modal_tbl_ld_khb_plxglist').modal('show');
            }
        },
        ...
        */
        ...
        {
            $('#table_grid_tbl_ld_khb_plxglist').bootstrapTable('uncheckAll');
       ...
       */
        btn_detail_modal_save_onclick: function ()
        {
            ...
            model.f_cbbh = controlObj.singledropdownlist('detail_dropdown_f_cbbh_tbl_ld_khb_plxglist');
            model.f_cbbhid = controlObj.singledropdownlistid('detail_dropdown_f_cbbh_tbl_ld_khb_plxglist');

            model.f_khfz = controlObj.multidropdownlist('detail_dropdown_f_khfz_tbl_ld_khb_plxglist');
            model.f_khfzid = controlObj.multidropdownlistid('detail_dropdown_f_khfz_tbl_ld_khb_plxglist');

            model.f_yslx = controlObj.singledropdownlist('detail_dropdown_f_yslx_tbl_ld_khb_plxglist');
            model.f_yslxid = controlObj.singledropdownlistid('detail_dropdown_f_yslx_tbl_ld_khb_plxglist');

            model.f_zt = controlObj.singledropdownlist('detail_dropdown_f_zt_tbl_ld_khb_plxglist');
            model.f_ztid = controlObj.singledropdownlistid('detail_dropdown_f_zt_tbl_ld_khb_plxglist');

            model.f_sfjlbjf = controlObj.toggle('detail_dropdown_f_sfjlbjf_tbl_ld_khb_plxglist');
            ...
            var json = {
                f_cbbh: model.f_cbbh,
                f_cbbhid: model.f_cbbhid,
                f_khfz: model.f_khfz,
                f_khfzid: model.f_khfzid,
                f_yslx: model.f_yslx,
                f_yslxid: model.f_yslxid,
                f_zt: model.f_zt,
                        f_ztid: model.f_ztid
                        //f_sfjlbjf: model.f_sfjlbjf


            }
            var data = {
                sys_ids: that._pr_gridselectids,
                json: JSON.stringify(json),
                clientInf: _clientInf
            };
            doAjaxFunction(_serviceUrl, 'UpdatePLXG', data, {
                    success: function (message) {

                    that.bindGrid({
                            success: function () {

                            _alertMessage.show('操作成功', 'success', 2000);
                            _ladda_btn_command_plxg.stop();
                            $('#div_detail_modal_tbl_ld_khb_plxglist').modal('hide');
                        },
                            fail: function (message) {
                            _blockMessage.show('批量修改成功，刷新页面执行失败<br/>' + message, 'fail');
                            _ladda_btn_command_plxg.stop();
                            $('#div_detail_modal_tbl_ld_khb_plxglist').modal('hide');
                        }
                    });
                        ...
                        _resultMessage.show('批量修改程序异常<br/>' + ex.message, 'fail');
                },
