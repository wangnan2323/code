...
var tbl_ld_cben_treelist_Obj = (function ()
{
    ...
    _ladda_btn_command_save = null,
      _ladda_btn_command_up = null,
    _ladda_btn_command_down = null,
         ...
         try
        {
            switch (that._pr_searchtype)
            {
                case "1":
                    ...
                    {
                        //简单查询
                        $("#txt_command_search_tbl_ld_cben_treelist").val(that._pr_searchcontent.type1);
                    }
                ...
                case "2":
                    ...
                    {
                        //高级查询
                        var tbl_ld_cben_treelist = that._pr_searchcontent.type2;
       ...
       // //;
        try
        {
            switch (that._pr_searchtype)
            {
                ...
                case "1":
                    //简单查询
                    that._pr_searchcontent.type1 = $("#txt_command_search_tbl_ld_cben_treelist").val();
                ...
                case "2":
                    ...
                    that._pr_searchcontent.type2 = tbl_ld_cben_treelist;
                    break;
    ...
    */
    checkSearchModel = function ( callBackFunction )
    {
        ...
        try
        {
            ...
            {			
                errorMessageHansMap.put('search_f_cbyid_tbl_ld_cben_treelist', '长度不能超过<a style="color:red">200</a>个字');
            }		
    ...
    clearSearchModel = function ()
    {
         switch (that._pr_searchtype)
        {
            case "1":
				...
				controlObj.text('search_f_value1_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value1);                          	
					      
								
									that._pr_searchcontent.type2.f_value2 = '';
				controlObj.text('search_f_value2_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value2);                          	
					      
								
									that._pr_searchcontent.type2.f_value3 = '';
				controlObj.text('search_f_value3_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value3);                          	
					      
								
									that._pr_searchcontent.type2.f_value4 = '';
				controlObj.text('search_f_value4_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value4);                          	
					      
								
									that._pr_searchcontent.type2.f_value5 = '';
				controlObj.text('search_f_value5_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value5);                          	
					      
								
									that._pr_searchcontent.type2.f_value6 = '';
				controlObj.text('search_f_value6_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value6);                          	
					      
								
									that._pr_searchcontent.type2.f_value7 = '';
				controlObj.text('search_f_value7_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value7);                          	
					      
								
									that._pr_searchcontent.type2.f_value8 = '';
				controlObj.text('search_f_value8_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value8);                          	
					      
								
									that._pr_searchcontent.type2.f_value9 = '';
				controlObj.text('search_f_value9_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value9);                          	
					      
								
									that._pr_searchcontent.type2.f_value10 = '';
				controlObj.text('search_f_value10_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_value10);                          	
					      
								
									that._pr_searchcontent.type2.f_cbbh = '';
				controlObj.text('search_f_cbbh_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_cbbh);                          	
					      
								
									that._pr_searchcontent.type2.f_cbmc = '';
				controlObj.text('search_f_cbmc_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_cbmc);                          	
					      
								
									that._pr_searchcontent.type2.f_cbzq = '';
				controlObj.text('search_f_cbzq_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_cbzq);                          	
					      
								
									that._pr_searchcontent.type2.f_ksyf = '';
				controlObj.text('search_f_ksyf_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_ksyf);                          	
					      
								
									that._pr_searchcontent.type2.f_cbymc = '';
				controlObj.text('search_f_cbymc_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_cbymc);                          	
					      
								
									that._pr_searchcontent.type2.f_cbyid = '';
				controlObj.text('search_f_cbyid_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_cbyid);                          	
					      
								
									that._pr_searchcontent.type2.f_ztid = '';
				controlObj.multidropdownlistid('search_f_zt_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_ztid);                          	
					      
								
									that._pr_searchcontent.type2.f_bz = '';
				controlObj.text('search_f_bz_tbl_ld_cben_treelist', that._pr_searchcontent.type2.f_bz);                          	
                         ...
                         //内容
                        {
                            resultHtml += "<div class=\"gridcell-divcell gridcell-content\" >";
                             ...
                             //==抄本编号
                             {
                                 ...
                                 if (row.f_ztid == '9') {
                                     resultHtml += "<div><span class=\"gridcell-fieldnamecn\">抄本编号：</span>" + value + "【" + row.f_zt + "】&nbsp;&nbsp;共有【" + row.khcount + "】人</div>";
                                 }
                                 else {
                                     resultHtml += "<div><span class=\"gridcell-fieldnamecn\">抄本编号：</span>" + value + "&nbsp;&nbsp;共有【" + row.khcount + "】人</div>";
                                 }
                            ...
                            //    resultHtml += "<div><span class=\"gridcell-fieldnamecn\">抄表员id：</span>" + value + "</div>"; 
                            //}                       
    ...
    */
    bindGrid = function ( isClearStatus,callBackFunction )
    {
        ...
        {          
            //记录滚动情况
            _gridStatusScrollTop = $( '#table_grid_tbl_ld_cben_treelist' ).parent().scrollTop();
        }
        ...
        setTimeout( function ()
        {
            ...
            doAjaxFunction(_serviceUrl, 'GetList', data, {
                success: function ( result )
                {
                    ...
                    $( '#table_grid_tbl_ld_cben_treelist' ).find( 'tr.success' ).removeClass( 'success' );
                    $( '#table_grid_tbl_ld_cben_treelist' ).find( '#tr_' + _gridStatusSelectid ).addClass( 'success' );
                   

                    //定位
                    $( '#table_grid_tbl_ld_cben_treelist' ).parent().scrollTop( _gridStatusScrollTop );
                    callBackFunction.success();
                },
                fail: function ( message )
                {
    ...
    */
    bindDetailControl = function ( callBackFunction )
    {
        ...
        {   
            ...
            tbl_ld_khb_list_Obj._pr_cbbhid = _gridStatusSelectid;
            
            tbl_ld_khb_list_Obj._pr_gridpageindex = 1;
            tbl_ld_khb_list_Obj.initAndBindGrid({
                success: function () {
                    callBackFunction.success();
                },
                fail: function (message) {
    ...
    */
    ...
    var that = {
                    ...
                    success: function ()
                    {
                        ...
                        initParameter( {
                            success: function ()
                            {
                                ...
                                _ladda_btn_command_delete = Ladda.create( 'btn_command_delete_tbl_ld_cben_treelist' );
                                _ladda_btn_command_save = Ladda.create('btn_command_save_tbl_ld_cben_treelist');
                                _ladda_btn_command_up = Ladda.create('btn_command_up_tbl_ld_cben_treelist');
                                _ladda_btn_command_down = Ladda.create('btn_command_down_tbl_ld_cben_treelist');
                                                            ...
                                                            success: function ()
                                                            {
                                                                ...
                                                                initDetailControl( {
                                                                    success: function ()
                                                                    {
                                                                        ...
                                                                        ////;
                                                                        $('#div_container_tbl_ld_cben_treelist').load('../tbl_ld_khb/tbl_ld_khb_list_part4cben.html', null, function () {
        ...
        */
        ...
        //向上移动
        btn_command_up_onclick: function ()
        {
            _ladda_btn_command_up.start();
            tbl_ld_khb_list_Obj.moveFunction("up", {
                success: function ()
                {
                    tbl_ld_khb_list_Obj.bindGrid();
                    _ladda_btn_command_up.stop();
                }, fail: function (message)
                {
                    _alertMessage.show('操作失败', 'fail');
                    _resultMessage.show(message);
                    _ladda_btn_command_up.stop();
                }
            });
        ...
        //向下移动
        btn_command_down_onclick: function () {
            _ladda_btn_command_down.start();
            tbl_ld_khb_list_Obj.moveFunction("down", {
                success: function () {
            tbl_ld_khb_list_Obj.bindGrid();
                    _ladda_btn_command_down.stop();
                }, fail: function (message) {
                    _alertMessage.show('操作失败', 'fail');
                    _resultMessage.show(message);
                    _ladda_btn_command_down.stop();
