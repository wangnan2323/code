...
var tbl_codefactory_list_Obj = (function ()
{
    ...
    */
    ...
    {
        tbl_codefactory_detail_Obj._pr_sys_id = id;
        tbl_codefactory_detail_Obj.bindPage({
            success: function ()
            {
                $('#div_content_part_tbl_codefactory_list').css('display', 'none');
                $('#div_content_part_tbl_codefactory_detail').css('display', '');
            }
        });
            ...
            try
            {
                ...
                initParameter({
                    success: function ()
                    {
                        ...
                        $('#div_content_part_tbl_codefactory_detail').load('../tbl_codefactory/tbl_codefactory_detail_part.html', null, function ()
                        {

                            tbl_codefactory_detail_Obj._pr_pagetype = that._pr_listtype;
