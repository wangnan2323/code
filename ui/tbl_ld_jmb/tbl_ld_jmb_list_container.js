...
var tbl_ld_jmb_list_container_Obj = ( function ()
{
    'use strict';
    var start = function () { },
    /* 
                    ...
                    success: function ()
                    {
                        ...
                        initParameter( {
                            success: function ()
                            {
                                ...
                                $( '#div_container_tbl_ld_jmb_list' ).load( '../tbl_ld_jmb/tbl_ld_jmb_list_part.html', null, function ()
                                {
                                    tbl_ld_jmb_list_Obj._pr_listtype = that._pr_listtype;
...
{
    tbl_ld_jmb_list_container_Obj.init();
} );
