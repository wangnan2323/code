            ...
            switch (that._pr_searchtype)
            {
                ...
                case "2":
                    if (that._pr_searchcontent.type2 != undefined)
                    {
                        ...
                        controlObj.text('search_f_value2_tbl_ld_jfb_list', tbl_ld_jfb_list.f_value2);
        ...
        try
        {
            ...
            switch (that._pr_searchtype)
            {
                ...
                case "2":
                    ...
                    tbl_ld_jfb_list.f_value1 = controlObj.text('search_f_value1_tbl_ld_jfb_list');
                        ...
                        doAjaxFunction(_serviceUrl, 'IsCanRollBack', data, {
                            success: function (message)
                            {
                                if (message == 'true')
                                {
                                    ...
                                    confirmContent += '<br/>';
                                    confirmContent += '<h5>回滚后，需退还该用户<a style="color:red">' + row.f_cbyslj + '</a>元</h5>';
                                    confirmContent += '</blockquote> ';
                                    _confirmMessage.destory();
...
*/
        sumGrid: function (callBackFunction)
        {
            setTimeout(function ()
            {
                ...
                var sumString = 'f_cbyslj^f_sllj^f_sflj^f_pwflj^f_shss';
                var data = {
                    whereString: _whereClauseString,
                    sumString: sumString,
                    clientInf: _clientInf
