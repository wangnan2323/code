...
var tbl_ld_xhhbtzb_treelist_container_Obj = ( function ()
{
    'use strict';
    var start = function () { },
    /* 
                    ...
                    success: function ()
                    {
                        ...
                        initParameter( {
                            success: function ()
                            {
                                ...
                                {
                                    tbl_ld_xhhbtzb_treelist_Obj._pr_listtype = that._pr_listtype;
...
{
    tbl_ld_xhhbtzb_treelist_container_Obj.init();
} );
