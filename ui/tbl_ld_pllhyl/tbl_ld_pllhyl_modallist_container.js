...
var tbl_ld_pllhyl_modallist_container_Obj = ( function ()
{
    'use strict';
    var start = function () { },
    /* 
                    ...
                    success: function ()
                    {
                        ...
                        initParameter( {
                            success: function ()
                            {
                                ...
                                {
                                    tbl_ld_pllhyl_modallist_Obj._pr_listtype = that._pr_listtype;
...
{
    tbl_ld_pllhyl_modallist_container_Obj.init();
} );
