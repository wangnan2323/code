    ...
    */
    initControl = function (callBackFunction) {
        try {
            ...
            controlObj.fileuploaderinit('detail_f_fj_tbl_ld_sbb_detail', {});
            callBackFunction.success();
        }
        catch (ex) {
    ...
    */
    setDisable = function (isDisable) {
        try {
            ...
            controlObj.textdisable('detail_f_sbbh_tbl_ld_sbb_detail', isDisable);

            controlObj.textdisable('detail_f_ztsbh_tbl_ld_sbb_detail', isDisable);
    ...
    */
    checkModel = function (tbl_ld_sbb_detail, callBackFunction) {
        try {
            ...
            if (tbl_ld_sbb_detail.f_jllx.length < 1) {
    ...
    var that = {
        ...
        */
        btn_command_cancle_onclick: function () {
            tbl_ld_sbb_list_Obj.bindGrid({
                success: function () {
                    $('#div_content_part_tbl_ld_sbb_list').css('display', '');
                    $('#div_content_part_tbl_ld_sbb_detail').css('display', 'none');
                }
            });
        },
