...
var tbl_ld_sbb_treelist_container_Obj = ( function ()
{
    'use strict';
    var start = function () { },
    /* 
    ...
    */
    initParameter = function ( callBackFunction )
    {
        try
        {
            that._pr_sbbh1 = requestQuery('sbbh');
                    ...
                    success: function ()
                    {
                        ...
                        initParameter( {
                            success: function ()
                            {
                                ...
                                $( '#div_container_tbl_ld_sbb_treelist' ).load( '../tbl_ld_sbb/tbl_ld_sbb_treelist_part.html', null, function ()
                                {
                                    tbl_ld_sbb_treelist_Obj._pr_sbbh = that._pr_sbbh1;
                                    tbl_ld_sbb_treelist_Obj._pr_listtype = that._pr_listtype;
                                    tbl_ld_sbb_treelist_Obj.init( {
                                        success: function ()
                                        {
                                            $( '#div_container_tbl_ld_sbb_treelist' ).css( 'display', '' );
                                            $( '#div_loading_tbl_ld_sbb_treelist' ).css( 'display', 'none' );
...
{
    tbl_ld_sbb_treelist_container_Obj.init();
} );
