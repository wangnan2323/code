...
var tbl_ld_sbb_list_Obj = (function () {
    ...
    */
    transToDetailPage = function (id, pagetype) {
        tbl_ld_sbb_detail_Obj._pr_sys_id = id;
        tbl_ld_sbb_detail_Obj.bindPage({
            success: function () {
                $('#div_content_part_tbl_ld_sbb_list').css('display', 'none');
                $('#div_content_part_tbl_ld_sbb_detail').css('display', '');
            }
        });
    },
            ...
            switch (that._pr_searchtype) {
                ...
                case "2":
                    if (that._pr_searchcontent.type2 != undefined) {
                        ...
                        controlObj.text('search_f_qsypjsl_tbl_ld_sbb_list', tbl_ld_sbb_list.f_qsypjsl);

                        controlObj.text('search_f_qlypjsl_tbl_ld_sbb_list', tbl_ld_sbb_list.f_qlypjsl);
        ...
        try {
            switch (that._pr_searchtype) {
                ...
                case "2":
                    ...
                    tbl_ld_sbb_list.f_qsypjsl = controlObj.text('search_f_qsypjsl_tbl_ld_sbb_list');


                    tbl_ld_sbb_list.f_qlypjsl = controlObj.text('search_f_qlypjsl_tbl_ld_sbb_list');
    ...
    */
    checkSearchModel = function (callBackFunction) {
        try {
            ...
            if (tbl_ld_sbb_list.f_qsypjsl.length > 200) {
                errorMessageHansMap.put('search_f_qsypjsl_tbl_ld_sbb_list', '长度不能超过<a style="color:red">200</a>个字');
            }




            if (tbl_ld_sbb_list.f_qlypjsl.length > 200) {
                errorMessageHansMap.put('search_f_qlypjsl_tbl_ld_sbb_list', '长度不能超过<a style="color:red">200</a>个字');
            }
            ...
            if (tbl_ld_sbb_list.f_bz.length > 200) {
    ...
    clearSearchModel = function () {
        ...
        switch (that._pr_searchtype) {
            case "1":
                ...
                that._pr_searchcontent.type2.f_qsypjsl = '';
                controlObj.text('search_f_qsypjsl_tbl_ld_sbb_list', that._pr_searchcontent.type2.f_qsypjsl);


                that._pr_searchcontent.type2.f_qlypjsl = '';
                controlObj.text('search_f_qlypjsl_tbl_ld_sbb_list', that._pr_searchcontent.type2.f_qlypjsl);
                        ...
                        if (vv.length > 0) {
                            for (var i = 0; i < vv.length; i++) {
                                if (vv[i] != '') {
                                    ...
                                    whereClause += " f_qsypjsl like '%" + vv[i] + "%' or ";

                                    whereClause += " f_qlypjsl like '%" + vv[i] + "%' or ";
            ...
            case "2":
                {
                    if (that._pr_searchcontent.type2 != undefined) {
                        ...
                        if (tbl_ld_sbb_list.f_bqsl.length > 0) {
                            whereClause += " f_bqsl like '%" + tbl_ld_sbb_list.f_bqsl + "%' and ";
                        }
                        ...
                        if (tbl_ld_sbb_list.f_qsypjsl.length > 0) {
                            whereClause += " f_qsypjsl like '%" + tbl_ld_sbb_list.f_qsypjsl + "%' and ";
                        }


                        if (tbl_ld_sbb_list.f_qlypjsl.length > 0) {
                            whereClause += " f_qlypjsl like '%" + tbl_ld_sbb_list.f_qlypjsl + "%' and ";
                        }
            ...
            try {
                ...
                initParameter({
                    success: function () {
                        ...
                        $('#div_content_part_tbl_ld_sbb_detail').load('../tbl_ld_sbb/tbl_ld_sbb_detail_part.html', null, function () {

                            tbl_ld_sbb_detail_Obj._pr_pagetype = that._pr_listtype;
