...
var tbl_ld_yhb_list_container_Obj = ( function ()
{
    'use strict';
    var start = function () { },
    /* 
                    ...
                    success: function ()
                    {
                        ...
                        initParameter( {
                            success: function ()
                            {
                                ...
                                $( '#div_container_tbl_ld_yhb_list' ).load( '../tbl_ld_yhb/tbl_ld_yhb_list_part.html', null, function ()
                                {
                                    tbl_ld_yhb_list_Obj._pr_listtype = that._pr_listtype;
                                    tbl_ld_yhb_list_Obj.init( {
                                        success: function ()
                                        {
                                            $( '#div_container_tbl_ld_yhb_list' ).css( 'display', '' );
                                            $( '#div_loading_tbl_ld_yhb_list' ).css( 'display', 'none' );
...
{
    tbl_ld_yhb_list_container_Obj.init();
} );
