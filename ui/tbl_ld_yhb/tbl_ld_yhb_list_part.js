...
var tbl_ld_yhb_list_Obj = (function ()
{
    ...
    */
    ...
    {
        tbl_ld_yhb_detail_Obj._pr_sys_id = id;
        tbl_ld_yhb_detail_Obj.bindPage({
            success: function ()
            {
                $('#div_content_part_tbl_ld_yhb_list').css('display', 'none');
                $('#div_content_part_tbl_ld_yhb_detail').css('display', '');
            }
        });
    },
            ...
            success: function (resultArray)
            {
                try
                {
                    _baseCodeHashMap = new hashMap();
                     var codenull = [];
                    _baseCodeHashMap.put('codeservice_0511', resultArray['0511']);
    ...
    */
    checkSearchModel = function (callBackFunction)
    {
        try
        {
            ...
            if (tbl_ld_yhb_list.f_dyid.length > 200)
            {			
            ...
            if (tbl_ld_yhb_list.f_scid.length > 200)
            {			
            ...
            if (tbl_ld_yhb_list.f_qyid.length > 200)
            {			
            ...
            if (tbl_ld_yhb_list.f_pqid.length > 200)
            {			
    ...
    clearSearchModel = function ()
    {
        ...
        switch (that._pr_searchtype)
        {
            case "1":
				...
				controlObj.multidropdownlistid('search_f_dy_tbl_ld_yhb_list', that._pr_searchcontent.type2.f_dyid);                          	
					      
								
									that._pr_searchcontent.type2.f_scid = '';
				controlObj.multidropdownlistid('search_f_sc_tbl_ld_yhb_list', that._pr_searchcontent.type2.f_scid);                          	
					      
								
									that._pr_searchcontent.type2.f_qyid = '';
				controlObj.multidropdownlistid('search_f_qy_tbl_ld_yhb_list', that._pr_searchcontent.type2.f_qyid);                          	
					      
								
									that._pr_searchcontent.type2.f_pqid = '';
				controlObj.multidropdownlistid('search_f_pq_tbl_ld_yhb_list', that._pr_searchcontent.type2.f_pqid);                          	
            ...
            case "2":
                {
                    if (that._pr_searchcontent.type2 != undefined)
                    {
				        ...
				        //if (tbl_ld_yhb_list.f_tsyx.length > 0)
                        //{
                        //    whereClause += " f_tsyx like '%" + tbl_ld_yhb_list.f_tsyx + "%' and ";
				        //}
            ...
            try
            {
                        ...
                        initParameter({
                            success: function ()
                            {
                                ...
                                $('#div_content_part_tbl_ld_yhb_detail').load('../tbl_ld_yhb/tbl_ld_yhb_detail_part.html', null, function ()
                                {

                                    tbl_ld_yhb_detail_Obj._pr_pagetype = that._pr_listtype;
