...
var tbl_ld_yhb_detail_Obj = (function ()
{
    ...
    */
    initControl = function (callBackFunction)
    {
        try
        {
            ...
            controlObj.fileuploaderinit('detail_f_htfj_tbl_ld_yhb_detail', { "fileUploadExtnames": ";.pdf;.tif;.bmp;.jpg;.jpeg;.gif;.png;" }, f_htfj_onchange);

            controlObj.fileuploaderinit('detail_f_sfzfj_tbl_ld_yhb_detail', { "fileUploadExtnames": ";.pdf;.tif;.bmp;.jpg;.jpeg;.gif;.png;"}, f_sfzfj_onchange);

            controlObj.fileuploaderinit('detail_f_qtfj_tbl_ld_yhb_detail', { }, f_qtfj_onchange);
            ...
            {
                tbl_ld_log_modallist_Obj._pr_tablename = 'tbl_ld_yhb';
    ...
    */
    setDisable = function (isDisable)
    {
        try
        {
            ...
            controlObj.textdisable('detail_f_yhbh_tbl_ld_yhb_detail', true);

            controlObj.textdisable('detail_f_ztyhh_tbl_ld_yhb_detail', true);
    ...
    */
    getModel = function (callBackFunction)
    {
        try
        {
            ...
            tbl_ld_yhb_detail.f_htqdrq = controlObj.datetime('detail_f_htqdrq_tbl_ld_yhb_detail_date', 'detail_f_htqdrq_tbl_ld_yhb_detail_time');
    ...
    */
    checkModel = function (tbl_ld_yhb_detail, callBackFunction)
    {
        try
        {
            ...
            if (tbl_ld_yhb_detail.f_zt.length < 1)
            {
                errorMessageHansMap.put('detail_f_zt_tbl_ld_yhb_detail', '长度不能小于<a style="color:red">1</a>个字');
            }
            if (tbl_ld_yhb_detail.f_tsyx.length > 200)
            {
                errorMessageHansMap.put('detail_f_tsyx_tbl_ld_yhb_detail', '长度不能超过<a style="color:red">200</a>个字');
    ...
    */
    ...
    {
        var d = new Date();
        var columns = 'f_value1^f_value2^f_value3^f_value4^f_value5^f_value6^f_value7^f_value8^f_value9^f_value10^f_yhbh^f_ztyhh^f_yhm^f_jfm^f_yhfz^f_yhfzid^f_dz^f_dh^f_khrq^f_dy^f_dyid^f_sc^f_scid^f_qy^f_qyid^f_pq^f_pqid^f_sfts^f_tsyx^f_tsyxid^f_tsyxzh^f_htbh^f_htfj^f_qtfj^f_sfzh^f_sfzfj^f_sfzzs^f_zt^f_ztid^f_bz^f_khbh^f_wxwybz^f_zfbwybz^f_gdyxwybz^sys_id^sys_lastedituserid^sys_lasteditusername^sys_lasteditdate^f_htqdrq';
        var json = {
        ...
        doAjaxFunction(_serviceUrl, 'Update', data, {
            success: function (message)
            {
                //commonObj.updateLog(_serverModel, tbl_ld_yhb_detail, 'tbl_ld_yhb', that._pr_sys_id, 'tbl_ld_yhb_detail', '用户信息修改程序', 'div_detail_【key】_【tablename】_detail', _clientInf, {
                //    success: function ()
                //    {
                        _serverModel = tbl_ld_yhb_detail;
                //    },
                //    fail: function ()
                //    {
                //        _serverModel = tbl_ld_yhb_detail;
