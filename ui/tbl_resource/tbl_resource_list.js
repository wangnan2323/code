...
var tbl_resource_list_Obj = ( function ()
{
    'use strict';
    ...
    */
    initParameter = function ( callBackFunction )
    {
        try
        {
            ...
            {
                case "1":
                    $( '#btn_command_search_tbl_resource_list' ).html( '简单查询' );
                    $( '#txt_command_search_tbl_resource_list' ).removeAttr( "disabled" );

                    break;
                case "2":
                    $( '#btn_command_search_tbl_resource_list' ).html( '高级查询' );
                    $( '#txt_command_search_tbl_resource_list' ).attr( "disabled", true );
                    break;
            }
    ...
    */
    initGrid = function ( callBackFunction )
    {
        try
        {
            ...
            $( '#table_grid_tbl_resource_list' ).bootstrapTable( {
                cache: false,
                height: gridHeight,
                striped: true,
                pagination: true,
...

			 {
                ...
                {
                    //获取当前grid中全部选中的行
                    var rows = $( '#table_grid_tbl_resource_list' ).bootstrapTable( 'getSelections' );
                ...
                {
                    var rows = $( '#table_grid_tbl_resource_list' ).bootstrapTable( 'getData' );
                    $.each( rows, function ( i, u )
                    {
                        if ( ( '^' + that._pr_gridselectids + '^' ).indexOf( '^' + rows[i].sys_id + '^' ) > -1 )
                        {
    ...
    */
    setDisable = function ( isDisable )
    {
        if ( isDisable )
        {
            $( '#btn_command_new_tbl_resource_list' ).addClass( 'hidden' );
            $( '#btn_command_delete_tbl_resource_list' ).addClass( 'hidden' );
        }
        else
        {

            $( '#btn_command_new_tbl_resource_list' ).removeClass( 'hidden' );
            $( '#btn_command_delete_tbl_resource_list' ).removeClass( 'hidden' );
        }
    },
    ...
    */
    transToDetailPage = function ( id, pagetype )
    {
        ...
        var url = '../tbl_resource/tbl_resource_detail.html';
        url += '?uid=' + basePageObj._userInfoJson.sys_userid;
        url += '&sys_id=' + id;
        url += '&pagetype=' + pagetype;
        url += '&appcode=' + _pr_appcode;
        url += '&fromurl=../tbl_resource/tbl_resource_list.html';
        url += '&fromurlparam={';
        url += '"appcode":"' + _pr_appcode + '",';
    ...
    */
    initSearchControl = function ( callBackFunction )
    {
        try
        {
            ...
            //controlObj.multidropdownlistinit( 'search_dropdown_f_group_tbl_resource_list', resultArray );



            //模态窗口
            $( '#div_search_modal_tbl_resource_list' ).modal( {
                keyboard: false,
                backdrop: 'static',
                show: false
            } );
        ...
        try
        {
            switch ( that._pr_searchtype )
            {
                case "1":
                    ...
                    {
                        //简单查询
                        $( "#txt_command_search_tbl_resource_list" ).val( that._pr_searchcontent.type1 );
                    }
                ...
                case "2":
                    ...
                    {
                        //高级查询
                        var tbl_resource_list = that._pr_searchcontent.type2;


                        controlObj.text( 'search_txt_f_value1_tbl_resource_list', tbl_resource_list.f_value1 );

                        controlObj.text( 'search_txt_f_value2_tbl_resource_list', tbl_resource_list.f_value2 );

                        controlObj.text( 'search_txt_f_value3_tbl_resource_list', tbl_resource_list.f_value3 );

                        controlObj.text( 'search_txt_f_value4_tbl_resource_list', tbl_resource_list.f_value4 );

                        controlObj.text( 'search_txt_f_value5_tbl_resource_list', tbl_resource_list.f_value5 );

                        controlObj.text( 'search_txt_f_value6_tbl_resource_list', tbl_resource_list.f_value6 );

                        controlObj.text( 'search_txt_f_value7_tbl_resource_list', tbl_resource_list.f_value7 );

                        controlObj.text( 'search_txt_f_value8_tbl_resource_list', tbl_resource_list.f_value8 );

                        controlObj.text( 'search_txt_f_value9_tbl_resource_list', tbl_resource_list.f_value9 );

                        controlObj.text( 'search_txt_f_value10_tbl_resource_list', tbl_resource_list.f_value10 );

                        controlObj.text( 'search_txt_f_title_tbl_resource_list', tbl_resource_list.f_title );

                        //controlObj.multidropdownlistid( 'search_dropdown_f_group_tbl_resource_list', tbl_resource_list.f_groupid );
    ...
    getSearchModel = function ( callBackFunction )
    {
        try
        {
            switch ( that._pr_searchtype )
            {
                ...
                case "1":
                    //简单查询
                    that._pr_searchcontent.type1 = $( "#txt_command_search_tbl_resource_list" ).val();

                    break;
                case "2":

                    //高级查询
                    var tbl_resource_list = new Object();



                    tbl_resource_list.f_value1 = controlObj.text( 'search_txt_f_value1_tbl_resource_list' );



                    tbl_resource_list.f_value2 = controlObj.text( 'search_txt_f_value2_tbl_resource_list' );



                    tbl_resource_list.f_value3 = controlObj.text( 'search_txt_f_value3_tbl_resource_list' );



                    tbl_resource_list.f_value4 = controlObj.text( 'search_txt_f_value4_tbl_resource_list' );



                    tbl_resource_list.f_value5 = controlObj.text( 'search_txt_f_value5_tbl_resource_list' );



                    tbl_resource_list.f_value6 = controlObj.text( 'search_txt_f_value6_tbl_resource_list' );



                    tbl_resource_list.f_value7 = controlObj.text( 'search_txt_f_value7_tbl_resource_list' );



                    tbl_resource_list.f_value8 = controlObj.text( 'search_txt_f_value8_tbl_resource_list' );



                    tbl_resource_list.f_value9 = controlObj.text( 'search_txt_f_value9_tbl_resource_list' );



                    tbl_resource_list.f_value10 = controlObj.text( 'search_txt_f_value10_tbl_resource_list' );



                    tbl_resource_list.f_title = controlObj.text( 'search_txt_f_title_tbl_resource_list' );



                    //tbl_resource_list.f_groupid = controlObj.multidropdownlistid( 'search_dropdown_f_group_tbl_resource_list' );


                    that._pr_searchcontent.type2 = tbl_resource_list;
                    break;
    ...
    */
    checkSearchModel = function ( callBackFunction )
    {
        try
        {
            ...
            if ( tbl_resource_list.f_value1.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value1_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value1_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value2.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value2_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value2_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value3.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value3_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value3_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value4.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value4_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value4_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value5.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value5_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value5_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value6.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value6_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value6_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value7.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value7_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value7_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value8.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value8_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value8_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value9.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value9_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value9_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_value10.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_value10_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_value10_tbl_resource_list', 'top' );
            }


            if ( tbl_resource_list.f_title.length > 100 )
            {

                errorMessageHansMap.put( 'search_txt_f_title_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
                errorMessagePlacementHansMap.put( 'search_txt_f_title_tbl_resource_list', 'top' );
            }


            //if ( tbl_resource_list.f_groupid.length > 100 )
            //{
            //    errorMessageHansMap.put( 'search_dropdown_f_group_tbl_resource_list', '长度不能超过<a style="color:red">100</a>' );
            //}
    ...
    clearSearchModel = function ()
    {
        ...
        switch ( that._pr_searchtype )
        {
            case "1":
                ...
                controlObj.text( 'search_txt_f_value1_tbl_resource_list', that._pr_searchcontent.type2.f_value1 );


                that._pr_searchcontent.type2.f_value2 = '';
                controlObj.text( 'search_txt_f_value2_tbl_resource_list', that._pr_searchcontent.type2.f_value2 );


                that._pr_searchcontent.type2.f_value3 = '';
                controlObj.text( 'search_txt_f_value3_tbl_resource_list', that._pr_searchcontent.type2.f_value3 );


                that._pr_searchcontent.type2.f_value4 = '';
                controlObj.text( 'search_txt_f_value4_tbl_resource_list', that._pr_searchcontent.type2.f_value4 );


                that._pr_searchcontent.type2.f_value5 = '';
                controlObj.text( 'search_txt_f_value5_tbl_resource_list', that._pr_searchcontent.type2.f_value5 );


                that._pr_searchcontent.type2.f_value6 = '';
                controlObj.text( 'search_txt_f_value6_tbl_resource_list', that._pr_searchcontent.type2.f_value6 );


                that._pr_searchcontent.type2.f_value7 = '';
                controlObj.text( 'search_txt_f_value7_tbl_resource_list', that._pr_searchcontent.type2.f_value7 );


                that._pr_searchcontent.type2.f_value8 = '';
                controlObj.text( 'search_txt_f_value8_tbl_resource_list', that._pr_searchcontent.type2.f_value8 );


                that._pr_searchcontent.type2.f_value9 = '';
                controlObj.text( 'search_txt_f_value9_tbl_resource_list', that._pr_searchcontent.type2.f_value9 );


                that._pr_searchcontent.type2.f_value10 = '';
                controlObj.text( 'search_txt_f_value10_tbl_resource_list', that._pr_searchcontent.type2.f_value10 );


                that._pr_searchcontent.type2.f_title = '';
                controlObj.text( 'search_txt_f_title_tbl_resource_list', that._pr_searchcontent.type2.f_title );


                //that._pr_searchcontent.type2.f_groupid = '';
                //controlObj.multidropdownlistid( 'search_dropdown_f_group_tbl_resource_list', that._pr_searchcontent.type2.f_groupid );
            ...
            case "2":
                ...
                $( "#txt_command_search_tbl_resource_list" ).val( '' );
                break;
        }
            ...
            case "2":
                {
                    if ( that._pr_searchcontent.type2 != undefined )
                    {
                        ...
                        if ( tbl_resource_list.f_title.length > 0 )
                        {
                            whereClause += " f_title like '%" + tbl_resource_list.f_title + "%' and ";
                        }


                        //if ( tbl_resource_list.f_groupid.length > 0 )
                        //{
                        //    var elementArray = tbl_resource_list.f_groupid.split( ',' );
                        //    whereClause += '(';
    ...
    */
    gridSelectedChange = function ()
    {
        ...
        {
            $( '#btn_command_clearselect_tbl_resource_list' ).addClass( 'hidden' );
        }
        else
        {
            $( '#btn_command_clearselect_tbl_resource_list' ).removeClass( 'hidden' );
            var allcount = that._pr_gridselectids.split( '^' ).length;
            var currentcount = $( '#table_grid_tbl_resource_list' ).bootstrapTable( 'getSelections' ).length;
            $( '#btn_command_clearselect_tbl_resource_list .cc-badge-p' ).html( currentcount + '/' + allcount );
        }
    };
    ...
    var that = {
                                            ...
                                            success: function ()
                                            {
                                                that.bindGrid( {
                                                    success: function ()
                                                    {
                                                        ...
                                                        _validateMessage = new validateMessage( 'btn_search_modal_search_tbl_resource_list' );

                                                        _ladda_btn_command_new = Ladda.create( 'btn_command_new_tbl_resource_list' );
                                                        _ladda_btn_command_delete = Ladda.create( 'btn_command_delete_tbl_resource_list' );
        ...
        */
        bindGrid: function ( callBackFunction )
        {
            setTimeout( function ()
            {
                ...
                var columnsString = 'f_value1^f_value2^f_value3^f_value4^f_value5^f_value6^f_value7^f_value8^f_value9^f_value10^f_title^f_group^sys_id';
                var data = {
                ...
                doAjaxFunction( _serviceUrl, 'GetList', data, {
                    success: function ( result )
                    {
                        ...
                        $( '#table_grid_tbl_resource_list' ).bootstrapTable( "loadJson", messageJson );
        ...
        */
        ...
        {
            $( '#table_grid_tbl_resource_list' ).bootstrapTable( 'uncheckAll' );
            that._pr_gridselectids = '';
            gridSelectedChange();
        },
        ...
        */
        btn_command_search_2_onclick: function ()
        {
            ...
            $( '#btn_command_search_tbl_resource_list' ).html( '高级查询' );
            $( '#txt_command_search_tbl_resource_list' ).attr( 'disabled', 'disabled' );

            $( '#div_search_modal_tbl_resource_list' ).modal( 'show' );
        },
                        ...
                        success: function ()
                        {
                            creatWhereClause( {
                                success: function ()
                                {
                                    ...
                                    $( '#div_search_modal_tbl_resource_list' ).modal( 'hide' )
                                    that._pr_gridpageindex = '1';
                                    that._pr_gridselectids = '';
                                    that.bindGrid();
                                }
