...
var tbl_ld_cbiao_list_Obj = (function ()
{
    ...
    */
    initParameter = function (callBackFunction)
    {
        try
        {
            ...
            var myMonthto = myDate.getMonth() + 1;
            //取本月的最后一天            
            var year = myDate.getFullYear();
            var myMonthne = myDate.getMonth() + 2;
            var new_year = year;  //取当前的年份   
            var new_month = myMonthne++;//取下一个月的第一天，方便计算（最后一天不固定）   
            if (myMonthto > 12)
            {
                new_month -= 12;    //月份减   
                new_year++;      //年份增   
            }
            var new_date = new Date(new_year, myMonthto, 1);        //取当年当月中的第一天
            var last = (new Date(new_date.getTime() - 1000 * 60 * 60 * 24)).getDate();//获取当月最后一天日期   
            //如果是本月的最后一天，那么取上上个月的最后一天
            if (myDate.getDate() == last)
            {
                var new_date_ago = new Date(new_year, myMonth, 1);        //取当年上上月中的第一天
                var last_ago = (new Date(new_date_ago.getTime() - 1000 * 60 * 60 * 24)).getDate();//获取当月最后一天日期   
                _defaultfrom = myDate.getFullYear() + '/' + myMonth + '/' + last_ago + ' 00:00:00';
            }
            else
            {
            ...
            //如果是一月/二月  则从一月一号开始查
            if (myMonthto == 1 || myMonthto == 2)
            {
                _defaultfrom = myDate.getFullYear() + '/' + 1 + '/' + 1 + ' 00:00:00';  //一月一号
            }
            _defaultto = myDate.getFullYear() + '/' + myMonthto + '/' + myDate.getDate() + ' 23:59:59';
            ...
            {
                that._pr_searchtime = { "f_cbsjfrom": _defaultfrom, "f_cbsjto": _defaultto };
            }
            else
            {
    ...
    */
    setDisable = function (isDisable)
    {
        try
        {
            ...
            {
                $('#btn_command_his_tbl_ld_cbiao_list').addClass('hidden');
            }
            else
            {
                $('#btn_command_his_tbl_ld_cbiao_list').removeClass('hidden');
            }
            if (isDisable)
            {
    ...
    */
    transToDetailPage = function (id, pagetype)
    {
        ...
        url += '&fromurl=../tbl_ld_cbiao/tbl_ld_cbiao_list.html';
        url += '&fromurlparam={';
        url += '"appcode":"' + that._pr_appcode + '",';
    ...
    */
    initSearchControl = function (callBackFunction)
    {
        try
        {
            ...
            controlObj.multidropdownlistinit('search_f_zt_tbl_ld_cbiao_list', codeService_0544);

            controlObj.multidropdownlistinit('search_f_ly_tbl_ld_cbiao_list', codeService_0545);

            controlObj.multidropdownlistinit('search_f_cbyname_tbl_ld_cbiao_list', codeService_cby);

            controlObj.singledropdownlistinit('search_f_dy_tbl_ld_cbiao_list', codeService_0512, f_dy_onchange);
            controlObj.singledropdownlistinit('search_f_sc_tbl_ld_cbiao_list', codeService_0513, f_sc_onchange);
    ...
    */
    setSearchModel = function (callBackFunction)
    {
        try
        {
            ...
            if (that._pr_searchtime != undefined && that._pr_searchtime.f_cbsjfrom != undefined && that._pr_searchtime.f_cbsjto != undefined)
            {
                controlObj.datetime('search_f_cbsj_tbl_ld_cbiao_list_datefrom', 'search_f_cbsj_tbl_ld_cbiao_list_timefrom', that._pr_searchtime.f_cbsjfrom);
                controlObj.datetime('search_f_cbsj_tbl_ld_cbiao_list_dateto', 'search_f_cbsj_tbl_ld_cbiao_list_timeto', that._pr_searchtime.f_cbsjto);
                $("#querydatefrom").html(that._pr_searchtime.f_cbsjfrom);
                $("#querydateto").html(that._pr_searchtime.f_cbsjto);
            }
            else
            {
                controlObj.datetime('search_f_cbsj_tbl_ld_cbiao_list_datefrom', 'search_f_cbsj_tbl_ld_cbiao_list_timefrom', _defaultfrom);
                controlObj.datetime('search_f_cbsj_tbl_ld_cbiao_list_dateto', 'search_f_cbsj_tbl_ld_cbiao_list_timeto', _defaultto);
            ...
            switch (that._pr_searchtype)
            {
                ...
                case "2":
                    if (that._pr_searchcontent.type2 != undefined)
                    {
                        ...
                        controlObj.text('search_f_cbbh_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_cbbhid);

                        controlObj.text('search_f_khbh_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_khbh);

                        controlObj.multidropdownlistid('search_f_khfz_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_khfzid);
                        ...
                        controlObj.text('search_f_jmje_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_jmje);
                        controlObj.text('search_f_jmbh_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_jmbh);
                        controlObj.text('search_f_jmbhid_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_jmbhid);
                        controlObj.text('search_f_sfsfts_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_sfsfts);
                        ...
                        controlObj.multidropdownlistid('search_f_cbyname_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_cbyid);
                        ...
                        f_dy_onchange(dy, {
                            ...
                            success: function ()
                            {
                                controlObj.singledropdownlistid('search_f_sc_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_scid);
                                f_sc_onchange(sc, {
                                    success: function ()
                                    {
                                        controlObj.singledropdownlistid('search_f_qy_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_qyid);
                                        f_qy_onchange(qy, {
                                            success: function ()
                                            {
                                                controlObj.singledropdownlistid('search_f_pq_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_pqid);
                                            }
                                        });
                                    }
                        ...
                        controlObj.text('search_f_kj_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_kj);
                        controlObj.text('search_f_kjid_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_kjid);
                        controlObj.text('search_f_ztkhh_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_ztkhh);
                        controlObj.text('search_f_ztsbh_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_ztsbh);
                        controlObj.text('search_f_ztyhh_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_ztyhh);
                        controlObj.text('search_f_rs_tbl_ld_cbiao_list', tbl_ld_cbiao_list.f_rs);
    ...
    */
    getSearchModel = function (callBackFunction)
    {
        try
        {
            ...
            that._pr_searchtime.f_cbsjfrom = controlObj.datetime('search_f_cbsj_tbl_ld_cbiao_list_datefrom', 'search_f_cbsj_tbl_ld_cbiao_list_timefrom'); // datefrom + ' ' + timefrom;
            that._pr_searchtime.f_cbsjto = controlObj.datetime('search_f_cbsj_tbl_ld_cbiao_list_dateto', 'search_f_cbsj_tbl_ld_cbiao_list_timeto'); //dateto + ' ' + timeto;                 
            $("#querydatefrom").html(that._pr_searchtime.f_cbsjfrom);
            $("#querydateto").html(that._pr_searchtime.f_cbsjto);
            switch (that._pr_searchtype)
            {
                ...
                case "2":
                    ...
                    tbl_ld_cbiao_list.f_cbbhid = controlObj.multidropdownlistid('search_f_cbbh_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_cbbh = controlObj.multidropdownlist('search_f_cbbh_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_khfz = controlObj.multidropdownlist('search_f_khfz_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_khfzid = controlObj.multidropdownlistid('search_f_khfz_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_yhfz = controlObj.multidropdownlist('search_f_yhfz_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_yhfzid = controlObj.multidropdownlistid('search_f_yhfz_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_sbfz = controlObj.multidropdownlist('search_f_sbfz_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_sbfzid = controlObj.multidropdownlistid('search_f_sbfz_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_sf = controlObj.text('search_f_sf_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_pwf = controlObj.text('search_f_pwf_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_sjljsyl = controlObj.text('search_f_sjljsyl_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_jmje = controlObj.text('search_f_jmje_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_jmbh = controlObj.text('search_f_jmbh_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_jmbhid = controlObj.text('search_f_jmbhid_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_sfsfts = controlObj.text('search_f_sfsfts_tbl_ld_cbiao_list');
                    ...
                    tbl_ld_cbiao_list.f_cbyid = controlObj.multidropdownlistid('search_f_cbyname_tbl_ld_cbiao_list');
                    ...
                    tbl_ld_cbiao_list.f_dy = controlObj.singledropdownlist('search_f_dy_tbl_ld_cbiao_list');


                    tbl_ld_cbiao_list.f_dyid = controlObj.singledropdownlistid('search_f_dy_tbl_ld_cbiao_list');


                    tbl_ld_cbiao_list.f_sc = controlObj.singledropdownlist('search_f_sc_tbl_ld_cbiao_list');


                    tbl_ld_cbiao_list.f_scid = controlObj.singledropdownlistid('search_f_sc_tbl_ld_cbiao_list');


                    tbl_ld_cbiao_list.f_qy = controlObj.singledropdownlist('search_f_qy_tbl_ld_cbiao_list');


                    tbl_ld_cbiao_list.f_qyid = controlObj.singledropdownlistid('search_f_qy_tbl_ld_cbiao_list');


                    tbl_ld_cbiao_list.f_pq = controlObj.singledropdownlist('search_f_pq_tbl_ld_cbiao_list');


                    tbl_ld_cbiao_list.f_pqid = controlObj.singledropdownlistid('search_f_pq_tbl_ld_cbiao_list');
                    ...
                    tbl_ld_cbiao_list.f_kj = controlObj.text('search_f_kj_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_kjid = controlObj.text('search_f_kjid_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_ztkhh = controlObj.text('search_f_ztkhh_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_ztsbh = controlObj.text('search_f_ztsbh_tbl_ld_cbiao_list');
                    tbl_ld_cbiao_list.f_ztyhh = controlObj.text('search_f_ztyhh_tbl_ld_cbiao_list');
    ...
    checkSearchModel = function (callBackFunction)
    {
        try
        {
            if (that._pr_searchtype == '2')
            {
                ...
                if (tbl_ld_cbiao_list.f_sbbh.length > 200)
                {
                    errorMessageHansMap.put('search_f_sbbh_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                ...
                if (tbl_ld_cbiao_list.f_khfz.length > 200)
                {
                    errorMessageHansMap.put('search_f_khfz_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }

                if (tbl_ld_cbiao_list.f_yhfz.length > 200)
                {
                    errorMessageHansMap.put('search_f_yhfz_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }

                if (tbl_ld_cbiao_list.f_sbfz.length > 200)
                {
                    errorMessageHansMap.put('search_f_sbfz_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }

                if (tbl_ld_cbiao_list.f_sf.length > 200)
                {
                    errorMessageHansMap.put('search_f_sf_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_pwf.length > 200)
                {
                    errorMessageHansMap.put('search_f_pwf_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }

                if (tbl_ld_cbiao_list.f_sjljsyl.length > 200)
                {
                    errorMessageHansMap.put('search_f_sjljsyl_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_jmje.length > 200)
                {
                    errorMessageHansMap.put('search_f_jmje_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_jmbh.length > 200)
                {
                    errorMessageHansMap.put('search_f_jmbh_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_jmbhid.length > 200)
                {
                    errorMessageHansMap.put('search_f_jmbhid_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_sfsfts.length > 200)
                {
                    errorMessageHansMap.put('search_f_sfsfts_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                ...
                if (tbl_ld_cbiao_list.f_cbyid.length > 200)
                {
                ...
                if (tbl_ld_cbiao_list.f_kj.length > 200)
                {
                    errorMessageHansMap.put('search_f_kj_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_kjid.length > 200)
                {
                    errorMessageHansMap.put('search_f_kjid_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_ztkhh.length > 200)
                {
                    errorMessageHansMap.put('search_f_ztkhh_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_ztsbh.length > 200)
                {
                    errorMessageHansMap.put('search_f_ztsbh_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_ztyhh.length > 200)
                {
                    errorMessageHansMap.put('search_f_ztyhh_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                if (tbl_ld_cbiao_list.f_rs.length > 200)
                {
                    errorMessageHansMap.put('search_f_rs_tbl_ld_cbiao_list', '长度不能超过<a style="color:red">200</a>个字');
                }
                ...
                if (tbl_ld_cbiao_list.f_cbgxid.length == 0
               && tbl_ld_cbiao_list.f_cbsl.length == 0)
                {

                }
                else if (
                     tbl_ld_cbiao_list.f_cbgxid.length != 0
                    && tbl_ld_cbiao_list.f_cbsl.length != 0)
                {
                    if (!/^[0-9]+\.?[0-9]*$/.test(tbl_ld_cbiao_list.f_cbsl))
                    {
                        errorMessageHansMap.put('search_f_cbsl_tbl_ld_cbiao_list', '必须填写数字');
                    }
                }
                else
                {
                    ...
                    if (tbl_ld_cbiao_list.f_cbgxid.length == 0 )
                    {
                        errorMessageHansMap.put('search_f_cbgx_tbl_ld_cbiao_list', '不能为空');
                    }
                    if (tbl_ld_cbiao_list.f_cbsl.length == 0)
                    {
                        errorMessageHansMap.put('search_f_cbsl_tbl_ld_cbiao_list', '不能为空');
                    }
    ...
    clearSearchModel = function ()
    {
        ...
        switch (that._pr_searchtype)
        {
            case "1":
                ...
                controlObj.multidropdownlistid('search_f_cbbh_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_cbbhid);
                ...
                controlObj.multidropdownlistid('search_f_khfz_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_khfzid);
                that._pr_searchcontent.type2.f_yhfzid = '';
                controlObj.multidropdownlistid('search_f_yhfz_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_yhfzid);
                that._pr_searchcontent.type2.f_sbfzid = '';
                controlObj.multidropdownlistid('search_f_sbfz_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_sbfzid);
                that._pr_searchcontent.type2.f_sf = '';
                controlObj.text('search_f_sf_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_sf);
                that._pr_searchcontent.type2.f_pwf = '';
                controlObj.text('search_f_pwf_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_pwf);
                that._pr_searchcontent.type2.f_sjljsyl = '';
                controlObj.text('search_f_sjljsyl_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_sjljsyl);
                that._pr_searchcontent.type2.f_jmje = '';
                controlObj.text('search_f_jmje_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_jmje);
                that._pr_searchcontent.type2.f_jmbh = '';
                controlObj.text('search_f_jmbh_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_jmbh);
                that._pr_searchcontent.type2.f_jmbhid = '';
                controlObj.text('search_f_jmbhid_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_jmbhid);
                that._pr_searchcontent.type2.f_sfsfts = '';
                controlObj.text('search_f_sfsfts_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_sfsfts);
                ...
                controlObj.multidropdownlistid('search_f_cbyname_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_cbyid);
                ...
                controlObj.singledropdownlistid('search_f_dy_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_dyid);
                ...
                controlObj.singledropdownlistid('search_f_sc_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_scid);




                that._pr_searchcontent.type2.f_qyid = '';
                controlObj.singledropdownlistid('search_f_qy_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_qyid);


                that._pr_searchcontent.type2.f_pqid = '';
                controlObj.singledropdownlistid('search_f_pq_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_pqid);
                ...
                controlObj.text('search_f_kj_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_kj);
                that._pr_searchcontent.type2.f_kjid = '';
                controlObj.text('search_f_kjid_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_kjid);
                that._pr_searchcontent.type2.f_ztkhh = '';
                controlObj.text('search_f_ztkhh_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_ztkhh);
                that._pr_searchcontent.type2.f_ztsbh = '';
                controlObj.text('search_f_ztsbh_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_ztsbh);
                that._pr_searchcontent.type2.f_ztyhh = '';
                controlObj.text('search_f_ztyhh_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_ztyhh);
                that._pr_searchcontent.type2.f_rs = '';
                controlObj.text('search_f_rs_tbl_ld_cbiao_list', that._pr_searchcontent.type2.f_rs);
      ...
      f_dy_onchange = function (e, callbackfunction)
      {
          ...
          if (e.added != undefined)
          {
              ...
              getArea(nodeid, {
                  ...
                  {
                      controlObj.singledropdownlistinit('search_f_sc_tbl_ld_cbiao_list', jsonArray, f_sc_onchange);
                      controlObj.singledropdownlistid('search_f_sc_tbl_ld_cbiao_list', '-1');
                      // controlObj.singledropdownlist('search_f_sc_tbl_ld_cbiao_list', '');
                      ...
                      {
                          controlObj.singledropdownlistinit('search_f_qy_tbl_ld_cbiao_list', _baseCodeHashMap.get('codeservice_0514'), f_qy_onchange);
                          controlObj.singledropdownlistid('search_f_qy_tbl_ld_cbiao_list', '-1');
                          // controlObj.singledropdownlist('search_f_qy_tbl_ld_cbiao_list', '');
                          controlObj.singledropdownlistinit('search_f_pq_tbl_ld_cbiao_list', _baseCodeHashMap.get('codeservice_0515'), f_pq_onchange);
                          controlObj.singledropdownlistid('search_f_pq_tbl_ld_cbiao_list', '-1');
                          //controlObj.singledropdownlist('search_f_pq_tbl_ld_cbiao_list', '');
                      }
                  }
              })
          }
          ...
          {
              controlObj.singledropdownlistinit('search_f_sc_tbl_ld_cbiao_list', _baseCodeHashMap.get('codeservice_0513'), f_sc_onchange);
              controlObj.singledropdownlistid('search_f_sc_tbl_ld_cbiao_list', '-1');
              //controlObj.singledropdownlist('search_f_sc_tbl_ld_cbiao_list', '');
              controlObj.singledropdownlistinit('search_f_qy_tbl_ld_cbiao_list', _baseCodeHashMap.get('codeservice_0514'), f_qy_onchange);
              controlObj.singledropdownlistid('search_f_qy_tbl_ld_cbiao_list', '-1');
      ...
      f_sc_onchange = function (e, callbackfunction)
      {
          ...
          if (e.added != undefined)
          {
              ...
              getArea(nodeid, {
                  success: function (jsonArray)
                  {
                      controlObj.singledropdownlistinit('search_f_qy_tbl_ld_cbiao_list', jsonArray, f_qy_onchange);
                      controlObj.singledropdownlistid('search_f_qy_tbl_ld_cbiao_list', '-1');
                      //controlObj.singledropdownlist('search_f_qy_tbl_ld_cbiao_list', '');
                      if (callbackfunction != undefined)
                      {
      ...
      f_qy_onchange = function (e, callbackfunction)
      {
          ...
          if (e.added != undefined)
          {
              ...
              getArea(nodeid, {
                  success: function (jsonArray)
                  {
                      controlObj.singledropdownlistinit('search_f_pq_tbl_ld_cbiao_list', jsonArray, f_pq_onchange);
                      controlObj.singledropdownlistid('search_f_pq_tbl_ld_cbiao_list', '-1');
                      //ontrolObj.singledropdownlist('search_f_pq_tbl_ld_cbiao_list', '');
                      if (callbackfunction != undefined)
                      {
                          callbackfunction.success();
                      }
    ...
    */
    creatWhereClause = function (callBackFunction)
    {
        ...
        if (that._pr_searchtime != undefined && that._pr_searchtime.f_cbsjfrom != undefined && that._pr_searchtime.f_cbsjto != undefined)
        {
            whereClause += " f_cbsj >= to_date('" + that._pr_searchtime.f_cbsjfrom + "','yyyy-MM-dd hh24:mi:ss') and ";
            whereClause += "  f_cbsj <= to_date('" + that._pr_searchtime.f_cbsjto + "','yyyy-MM-dd hh24:mi:ss') and ";
        }
        else
        {
            whereClause += " f_cbsj >= to_date('" + _defaultfrom + "','yyyy-MM-dd hh24:mi:ss') and ";
            whereClause += " f_cbsj <= to_date('" + _defaultto + "','yyyy-MM-dd hh24:mi:ss')  and ";
        }
        switch (that._pr_searchtype)
        {
            case "1":
            ...
            case "2":
                {
                    if (that._pr_searchcontent.type2 != undefined)
                    {
                        ...
                        {
                            var elementArray = tbl_ld_cbiao_list.f_khfzid.split(',');
                            whereClause += '(';
                        ...
                        if (tbl_ld_cbiao_list.f_yhfzid.length > 0)
                        {
                            var elementArray = tbl_ld_cbiao_list.f_yhfzid.split(',');
                            var aaa = '';
                            $.each(elementArray, function (i, u)
                            {
                                if (i == 0)
                        ...
                        if (tbl_ld_cbiao_list.f_cbyid.length > 0)
                        {
                            var elementArray = tbl_ld_cbiao_list.f_cbyid.split(',');
                            whereClause += '(';
                            $.each(elementArray, function (i, u)
                            {
                                if (i == 0)
                        ...
                        {
                            whereClause += " f_dyid = '" + tbl_ld_cbiao_list.f_dyid + "' and ";
                        }
                        ...
                        {
                            whereClause += " f_scid = '" + tbl_ld_cbiao_list.f_scid + "' and ";
                        }
                        ...
                        {
                            whereClause += " f_qyid = '" + tbl_ld_cbiao_list.f_qyid + "' and ";
                        }
                        ...
                        {
                            whereClause += " f_pqid = '" + tbl_ld_cbiao_list.f_pqid + "' and ";
                        }
                        ...
                        if (tbl_ld_cbiao_list.f_kj.length > 0)
                        {
                            whereClause += " f_kj like '%" + tbl_ld_cbiao_list.f_kj + "%' and ";
                        }
                        if (tbl_ld_cbiao_list.f_kjid.length > 0)
                        {
                            whereClause += " f_kjid like '%" + tbl_ld_cbiao_list.f_kjid + "%' and ";
                        }
                        if (tbl_ld_cbiao_list.f_ztkhh.length > 0)
                        {
                            whereClause += " f_ztkhh like '%" + tbl_ld_cbiao_list.f_ztkhh + "%' and ";
                        }
                        if (tbl_ld_cbiao_list.f_ztsbh.length > 0)
                        {
                            whereClause += " f_ztsbh like '%" + tbl_ld_cbiao_list.f_ztsbh + "%' and ";
                        }
                        if (tbl_ld_cbiao_list.f_ztyhh.length > 0)
                        {
                            whereClause += " f_ztyhh like '%" + tbl_ld_cbiao_list.f_ztyhh + "%' and ";
                        }
                        if (tbl_ld_cbiao_list.f_rs.length > 0)
                        {
                            whereClause += " f_rs like '%" + tbl_ld_cbiao_list.f_rs + "%' and ";
                        }
                        if (tbl_ld_cbiao_list.f_cbgxid.length != 0 && tbl_ld_cbiao_list.f_cbsl.length != 0)
                        {
                            whereClause += " f_bqsl  ";
                            switch (tbl_ld_cbiao_list.f_cbgxid)
                            {
                                case "1":
                                    whereClause += ">";
                                    break;
    ...
    */
                                ...
                                case "2":
                                    {
                                        ...
                                        {
                                            return [
                                              '<a class="rollback ml10" href="javascript:void(0)" title="算费回滚">',
                        ...
                        doAjaxFunction(_serviceUrl, 'IsCanRollBack', data, {
                            success: function (message)
                            {
                                if (message == 'true')
                                {
                                    ...
                                    confirmContent += '<h3>将当前选中的数据<a style="color:red">' + row.f_yhm + '</a>此用户进行<a style="color:red">算费回滚操作</a></h3>';
                                    confirmContent += '<br/>';
                                    ...
                                    _confirmMessage.show('回滚确认？', confirmContent,
                                    {
                                        ...
                                        confirm: function ()
                                        {
                                            ...
                                            doAjaxFunction(_serviceUrl, 'RollBackSF', data, {
                                ...
                                else
                                {
                                    ...
                                    _alertMessage.show('只能回滚客户的最后一条算费记录', 'fail');
                                }
                            },
                            fail: function (message)
                            {
    ...
    initDetailControlShowColumn = function (callBackFunction)
    {
        try
        {
            ...
            controlObj.multidropdownlistinit('model_dropdown_f_checklist_tbl_ld_cbiao_query_showcolumnlist', codeservice_cbiao, null);
            //controlObj.checklistinit('model_dropdown_f_checklist_tbl_ld_kh_query_showcolumnlist', codeservice_0814, null, { width: '120' });
            //模态窗口
            $('#div_modal_tbl_ld_cbiao_query_showcolumnlist').modal({
                keyboard: false,
                backdrop: 'static',
                show: false
            });
                                            ...
                                            success: function ()
                                            {
                                                that.bindGrid({
                                                    success: function ()
                                                    {
                                                        ...
                                                        _validateMessage_searchtime = new validateMessage('btn_modal_searchtime_tbl_ld_cbiao_list');
                                                        ...
                                                        _ladda_btn_command_exp = Ladda.create('btn_command_report_tbl_ld_cbiao_list');
                                                        _ladda_btn_command_his = Ladda.create('btn_command_his_tbl_ld_cbiao_list');
                                                        _ladda_btn_command_showcolunm = Ladda.create('btn_command_showcolunm_tbl_ld_cbiao_query_list');
                                                        switch (that._pr_listtype)
                                                        {
                                                            case "1":
                                                                setDisable(false);
                                                        ...
                                                        if (that._pr_isadmin == '1')
                                                        {
                                                            $('#dd_search_f_cbyname_tbl_ld_cbiao_list').addClass("hidden");
                                                        }
...
*/
        ...
        */
        ...
        btn_command_report_onclick: function ()
        {
            ...
            var column = getCookie('tbl_ld_cbiao_query_list_column');
            var columnname = getCookie('tbl_ld_cbiao_query_list_columnname');
            var where = '';
        ...
        btn_command_showcolunm_onclick: function ()
        {
            ...
            if (column != null && column != 'undefined' && column != "")
            {
                ...
                controlObj.multidropdownlistid('model_dropdown_f_checklist_tbl_ld_cbiao_query_showcolumnlist', column);
            }
            $('#div_modal_tbl_ld_cbiao_query_showcolumnlist').modal('show');
        },
        //列显示取消按钮
        btn_showcolumn_modal_cancle_onclick: function ()
        {
            $('#div_modal_tbl_ld_cbiao_query_showcolumnlist').modal('hide');
        ...
        btn_showcolumn_modal_save_onclick: function ()
        {
            ...
            var column = controlObj.multidropdownlistid('model_dropdown_f_checklist_tbl_ld_cbiao_query_showcolumnlist');
            var columnname = controlObj.multidropdownlist('model_dropdown_f_checklist_tbl_ld_cbiao_query_showcolumnlist');
            setCookieMinutes("tbl_ld_cbiao_query_list_column", column, 5256000);
            setCookieMinutes("tbl_ld_cbiao_query_list_columnname", columnname, 5256000);
        ...
        {
            $('#div_modal_tbl_ld_cbiao_list').modal('show');
        },
                    ...
                    checkSearchModel({
                        success: function ()
                        {
                            creatWhereClause({
                                success: function ()
                                {
                                    $('#div_modal_tbl_ld_cbiao_list').modal('hide');
                                    that.bindGrid();
                                }
                            });
                        },
